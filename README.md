...
<dependencies>
    <dependency>
        ...
        <version>2.30.0.RELEASE</version>
    </dependency>
    <dependency>
        <groupId>org.cloudfoundry</groupId>
...
```groovy
dependencies {
    compile 'org.cloudfoundry:cloudfoundry-client-reactor:2.30.0.RELEASE'
    compile 'org.cloudfoundry:cloudfoundry-operations:2.30.0.RELEASE'
