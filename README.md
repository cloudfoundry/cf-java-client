...
```groovy
dependencies {
    compile 'org.cloudfoundry:cloudfoundry-client-reactor:2.0.0.RELEASE'
    compile 'org.cloudfoundry:cloudfoundry-operations:2.0.0.RELEASE'
    compile 'io.projectreactor:reactor-core:3.0.1.BUILD-SNAPSHOT'
    compile 'io.projectreactor.ipc:reactor-netty:0.5.0.RELEASE'
    ...
}
```
