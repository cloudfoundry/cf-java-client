...
public final class DefaultServiceAdminTest extends AbstractOperationsTest {
    ...
    public void updateServiceBroker() {
        requestListServiceBrokers(this.cloudFoundryClient, "test-service-broker-name");
        requestUpdateServiceBroker(this.cloudFoundryClient, "test-service-broker-name", "test-service-broker-url", "test-service-broker-username", "test-service-broker-password","test-service-broker-id");
