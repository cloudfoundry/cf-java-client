...
final class DefaultServicesTest extends AbstractOperationsTest {
    ...
    void bindRouteServiceInstanceAlreadyBound() {
        ...
        requestAssociateUserProvidedServiceInstanceRouteError(
    ...
    @Test
    void bindRouteServiceInstanceDomainNotFound() {
        requestListOrganizationPrivateDomainsEmpty(
                this.cloudFoundryClient, "test-domain-name", TEST_ORGANIZATION_ID);
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage("Domain test-domain-name not found"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    void bindRouteServiceInstancePrivateDomain() {
        ...
        requestListSpaceServiceInstancesUserProvided(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListRoutes(this.cloudFoundryClient, "test-private-domain-id");
        requestAssociateUserProvidedServiceInstanceRoute(
                this.cloudFoundryClient,
                "test-route-id",
                "test-service-instance-id",
                Collections.singletonMap("test-parameter-key", "test-parameter-value"));
    ...
    void bindRouteServiceInstancePrivateDomainWithHostAndPath() {
        ...
        requestListSpaceServiceInstancesUserProvided(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListRoutes(
                this.cloudFoundryClient, "test-private-domain-id", "test-host", "test-path");
        requestAssociateUserProvidedServiceInstanceRoute(
                this.cloudFoundryClient,
                "test-route-id",
                "test-service-instance-id",
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Service instance test-service-instance-name does"
                                                        + " not exist"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void bindRouteServiceInstanceSharedDomain() {
        requestListOrganizationPrivateDomainsEmpty(
                this.cloudFoundryClient, "test-domain-name", TEST_ORGANIZATION_ID);
    ...
    @Test
    void bindServiceInstanceAlreadyBound() {
        requestApplications(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestCreateServiceBindingError(
                this.cloudFoundryClient,
                "test-application-id",
                "test-service-instance-id",
                Collections.singletonMap("test-parameter-key", "test-parameter-value"),
    ...
    @Test
    void bindServiceInstanceNoApplication() {
    ...
    @Test
    void bindServiceInstanceNoServiceInstance() {
        requestApplications(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
    ...
    void createServiceInstance() {
        ...
        requestListSpaceServicePlans(
                this.cloudFoundryClient, "test-service-id", "test-plan", "test-plan-id");
        ...
        requestGetServiceInstance(
                this.cloudFoundryClient, "test-service-instance-id", "successful");
    ...
    void createServiceKey() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance", TEST_SPACE_ID);
    ...
    @Test
    void createServiceKeyNoServiceInstance() {
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-service-instance-does-not-exist", TEST_SPACE_ID);
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "Service instance"
                                                    + " test-service-instance-does-not-exist does"
                                                    + " not exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    @Test
    void deleteServiceInstanceAcceptsIncomplete() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestDeleteServiceInstanceAcceptsIncomplete(
                this.cloudFoundryClient, "test-service-instance-id");
    ...
    @Test
    void deleteServiceInstanceNotFound() {
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-invalid-name", TEST_SPACE_ID);

        this.services
                .deleteInstance(
                        DeleteServiceInstanceRequest.builder().name("test-invalid-name").build())
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Service instance test-invalid-name does not"
                                                        + " exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    void deleteServiceKey() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListSpaceServiceInstanceServiceKeys(
                this.cloudFoundryClient,
                "test-service-instance-id",
                "test-service-key-name",
                "key",
                "val");
    ...
    @Test
    void deleteServiceKeyNoServiceInstance() {
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-service-instance", TEST_SPACE_ID);
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Service instance test-service-instance does not"
                                                        + " exist"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void deleteServiceKeyNoServiceKey() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListSpaceServiceInstanceServiceKeysEmpty(
                this.cloudFoundryClient, "test-service-instance-id", "test-service-key-not-found");
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Service key test-service-key-not-found does not"
                                                        + " exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    @Test
    void getServiceInstanceManaged() {
        requestListSpaceServiceInstancesManaged(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestGetServicePlan(
                this.cloudFoundryClient,
                "test-service-plan-id",
                "test-service-plan",
                "test-service-id");
        requestListSpaceServiceBindings(
                this.cloudFoundryClient, "test-service-instance-id", "test-application-id");
    ...
    @Test
    void getServiceInstanceNoInstances() {
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-invalid-name", TEST_SPACE_ID);
    ...
    @Test
    void getServiceInstanceUserProvided() {
        requestListSpaceServiceInstancesUserProvided(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListSpaceServiceBindings(
                this.cloudFoundryClient, "test-service-instance-id", "test-application-id");
    ...
    @Test
    void listInstancesManagedServices() {
    ...
    @Test
    void listInstancesNoApplications() {
    ...
    @Test
    void listInstancesOneApplication() {
    ...
    @Test
    void listInstancesUserProvidedServices() {
    ...
    @Test
    void listServiceKeys() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestListSpaceServiceInstanceServiceKeys(
                this.cloudFoundryClient, "test-service-instance-id", "key", "val");
    ...
    @Test
    void listServiceKeysNoServiceInstance() {
        requestListSpaceServiceInstancesEmpty(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
    ...
    void listServiceOfferings() {
        requestListSpaceServicesTwo(
                this.cloudFoundryClient, TEST_SPACE_ID, "test-service1", "test-service2");
        requestListSpaceServicePlans(
                this.cloudFoundryClient,
                "test-service1-id",
                "test-service1-plan",
                "test-service1-plan-id");
        requestListSpaceServicePlans(
                this.cloudFoundryClient,
                "test-service2-id",
                "test-service2-plan",
                "test-service2-plan-id");
    ...
    void listServiceOfferingsSingle() {
        ...
        this.services
                .listServiceOfferings(
                        ListServiceOfferingsRequest.builder().serviceName("test-service").build())
                .as(StepVerifier::create)
                .expectNext(
                        ServiceOffering.builder()
    ...
    @Test
    void renameServiceInstance() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestRenameServiceInstance(
                this.cloudFoundryClient,
                "test-service-instance-id",
                "test-service-instance-new-name");
    ...
    void unbindRoute() {
        ...
        requestListSpaceServiceInstancesUserProvided(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestRemoveUserProvidedServiceInstanceRoute(
                this.cloudFoundryClient, "test-route-id", "test-service-instance-id");
        ...
        this.services
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Route test-domain-name does not exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    @Test
    void unbindServiceInstance() {
        requestApplications(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestApplicationsListServiceBindings(
                this.cloudFoundryClient, "test-application-id", "test-service-instance-id");
    ...
    @Test
    void unbindServiceInstanceFailure() {
        requestApplications(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service-instance-name", TEST_SPACE_ID);
        requestApplicationsListServiceBindings(
    ...
    void updateService() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-service-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient,
                "test-service-plan-id",
                "test-service-plan",
    ...
    @Test
    void updateServiceNewPlanDoesNotExist() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-service-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient,
        ...
        this.services
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("New service plan test-plan not found"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void updateServiceNoParameters() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-service-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient,
        ...
        requestGetService(this.cloudFoundryClient, "test-service-id", "test-service");
        requestListSpaceServicePlans(
                this.cloudFoundryClient, "test-service-id", "test-plan", "test-service-plan-id");
        requestUpdateServiceInstance(
                this.cloudFoundryClient,
                null,
                "test-service-instance-id",
    ...
    @Test
    void updateServiceNoPlanExists() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, null);
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Plan does not exist for the test-name service"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void updateServiceNoTags() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-service-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient,
    ...
    @Test
    void updateServiceNotPublic() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient, "test-plan-id", "test-service-plan", "test-service-id");
        requestGetService(this.cloudFoundryClient, "test-service-id", "test-service");
        requestListSpaceServicePlansNotPublic(
                this.cloudFoundryClient, "test-service-id", "test-plan", "test-plan-id");
        requestListSpaceServicePlanVisibilities(
                this.cloudFoundryClient, "test-organization-id", "test-plan-id");
        requestUpdateServiceInstance(
                this.cloudFoundryClient,
                Collections.singletonMap("test-parameter-key", "test-parameter-value"),
                "test-service-instance-id",
    ...
    void updateServiceNotVisible() {
        ...
        requestListSpaceServicePlansNotPublic(
                this.cloudFoundryClient, "test-service-id", "test-plan", "test-plan-id");
        requestListSpaceServicePlanVisibilitiesEmpty(
                this.cloudFoundryClient, "test-organization-id", "test-plan-id");
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Service Plan test-plan is not visible to your"
                                                        + " organization"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void updateServicePlanNotUpdateable() {
        requestListSpaceServiceInstances(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID, "test-service-plan-id");
        requestGetServicePlan(
                this.cloudFoundryClient,
                ...
                "test-service-plan",
                "test-service-id");
        requestGetServiceNotPlanUpdateable(
                this.cloudFoundryClient, "test-service-id", "test-service");
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "Plan for the test-name service cannot be updated"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void updateUserProvidedService() {
        requestListSpaceServiceInstancesUserProvided(
                this.cloudFoundryClient, "test-service", TEST_SPACE_ID);
        requestUpdateUserProvidedServiceInstance(
                this.cloudFoundryClient,
                Collections.singletonMap("test-credential-key", "test-credential-value"),
                "syslog-url",
    ...
    @Test
    void updateUserProvidedServiceNotUserProvided() {
        requestListSpaceServiceInstances(this.cloudFoundryClient, "test-service", TEST_SPACE_ID);
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "User provided service instance test-service does"
                                                        + " not exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    private static void requestApplicationsListServiceBindings(
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListApplicationServiceBindingsResponse.builder())
                                        .resource(
                                                fill(
    ...
    private static void requestAssociateUserProvidedServiceInstanceRoute(
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(AssociateUserProvidedServiceInstanceRouteResponse.builder())
                                        .build()));
    }

    private static void requestAssociateUserProvidedServiceInstanceRouteError(
            CloudFoundryClient cloudFoundryClient,
            String routeId,
            String userProvidedServiceInstanceId,
            Map<String, Object> parameters,
    ...
    private static void requestCreateServiceBinding(
            CloudFoundryClient cloudFoundryClient,
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(CreateServiceBindingResponse.builder(), "service-binding-")
                                        .build()));
    }

    private static void requestCreateServiceBindingError(
            CloudFoundryClient cloudFoundryClient,
            String applicationId,
            String serviceInstanceId,
            Map<String, Object> parameters,
    ...
    private static void requestCreateServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            String planId,
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(CreateServiceInstanceResponse.builder())
                                        .metadata(
                                                fill(Metadata.builder())
                                                        .id(serviceInstanceId)
                                                        .build())
                                        .entity(
                                                fill(ServiceInstanceEntity.builder())
                                                        .lastOperation(
    ...
    private static void requestCreateServiceKey(
            CloudFoundryClient cloudFoundryClient,
            String serviceInstanceId,
            String serviceKey,
            Map<String, Object> parameters) {
        when(cloudFoundryClient
                        .serviceKeys()
                        .create(
                                org.cloudfoundry.client.v2.servicekeys.CreateServiceKeyRequest
                                        .builder()
                                        .name(serviceKey)
                                        .parameters(parameters)
                                        .serviceInstanceId(serviceInstanceId)
                                        .build()))
                .thenReturn(
                        Mono.just(fill(CreateServiceKeyResponse.builder(), "service-key").build()));
    }

    private static void requestCreateUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            String name,
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(CreateUserProvidedServiceInstanceResponse.builder())
                                        .metadata(
                                                fill(Metadata.builder())
                                                        .id(userProvidedServiceInstanceId)
                                                        .build())
                                        .entity(
                                                fill(UserProvidedServiceInstanceEntity.builder())
                                                        .build())
                                        .build()));
    }

    private static void requestDeleteServiceBinding(
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(DeleteServiceBindingResponse.builder())
                                        .entity(fill(JobEntity.builder(), "job-entity-").build())
                                        .build()));
    }

    private static void requestDeleteServiceInstance(
    ...
    private static void requestDeleteServiceInstanceAcceptsIncomplete(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        when(cloudFoundryClient
                        .serviceInstances()
                        .delete(
    ...
    private static void requestDeleteServiceKey(
            CloudFoundryClient cloudFoundryClient, String serviceKeyId) {
        when(cloudFoundryClient
                        .serviceKeys()
                        .delete(
                                org.cloudfoundry.client.v2.servicekeys.DeleteServiceKeyRequest
                                        .builder()
    ...
    private static void requestDeleteUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        when(cloudFoundryClient
                        .userProvidedServiceInstances()
                        .delete(
    ...
    private static void requestGetApplication(
            CloudFoundryClient cloudFoundryClient, String applicationId, String application) {
        when(cloudFoundryClient
                        .applicationsV2()
    ...
    private static void requestGetService(
            CloudFoundryClient cloudFoundryClient, String serviceId, String service) {
        when(cloudFoundryClient
                        .services()
                        .get(GetServiceRequest.builder().serviceId(serviceId).build()))
                .thenReturn(
                        Mono.just(
                                fill(GetServiceResponse.builder())
                                        .metadata(fill(Metadata.builder()).id(serviceId).build())
                                        .entity(
                                                fill(ServiceEntity.builder())
                                                        .extra(
                                                                "{\"displayName\":\"test-value\",\"longDescription\":\"test-value\",\"documentationUrl\":\"test-documentation-url\",\"supportUrl\":\"test-value\"}")
                                                        .label(service)
                                                        .build())
                                        .build()));
    }

    private static void requestGetServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String state) {
        when(cloudFoundryClient
                        .serviceInstances()
                        .get(
                                org.cloudfoundry.client.v2.serviceinstances
                ...
                .thenReturn(
                        Mono.just(
                                fill(GetServiceInstanceResponse.builder())
                                        .metadata(
                                                fill(Metadata.builder())
                                                        .id(serviceInstanceId)
                                                        .build())
    ...
    private static void requestGetServiceInstanceNotExist(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        when(cloudFoundryClient
                        .serviceInstances()
                        .get(
                ...
                .thenReturn(
                        Mono.error(
                                new ClientV2Exception(
                                        404, 404, "test-description", "test-error-code")));
    }

    private static void requestGetServiceNotPlanUpdateable(
            CloudFoundryClient cloudFoundryClient, String serviceId, String service) {
        when(cloudFoundryClient
                        .services()
                        .get(GetServiceRequest.builder().serviceId(serviceId).build()))
    ...
    private static void requestGetServicePlan(
            CloudFoundryClient cloudFoundryClient,
        ...
        when(cloudFoundryClient
                        .servicePlans()
                        .get(GetServicePlanRequest.builder().servicePlanId(servicePlanId).build()))
                .thenReturn(
                        Mono.just(
                                fill(GetServicePlanResponse.builder())
                                        .entity(
    ...
    private static void requestGetSpaceSummaryEmpty(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .getSummary(GetSpaceSummaryRequest.builder().spaceId(spaceId).build()))
                .thenReturn(Mono.just(fill(GetSpaceSummaryResponse.builder()).build()));
    }

    private static void requestGetSpaceSummaryManagedServices(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .getSummary(GetSpaceSummaryRequest.builder().spaceId(spaceId).build()))
                .thenReturn(
                        Mono.just(
                                fill(GetSpaceSummaryResponse.builder())
                                        .id(spaceId)
                                        .application(
                                        ...
                                        .service(
                                                org.cloudfoundry.client.v2.serviceinstances
                                                        ...
                                                        .lastOperation(
                                                                LastOperation.builder()
                                                                        .description(
                                                                                "test-last-operation-description-2")
                                                                        .build())
                                                        .name("test-service-name-2")
                                                        .servicePlan(
                                                                Plan.builder()
                                                                        .id(
                                                                                "test-service-plan-id-2")
                                                                        .name(
                                                                                "test-service-plan-name-2")
                                                                        .service(
                                                                                Service.builder()
                                                                                        .id(
                                                                                                "test-provided-service-id")
                                                                                        .label(
                                                                                                "test-provided-service-label")
                                                                                        .build())
                                                                        .build())
                                                        .build())
                                        .build()));
    ...
    private static void requestGetSpaceSummaryManagedServicesNoApplications(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .getSummary(GetSpaceSummaryRequest.builder().spaceId(spaceId).build()))
                                        ...
                                        .service(
                                                org.cloudfoundry.client.v2.serviceinstances
                                                        ...
                                                        .lastOperation(
                                                                LastOperation.builder()
                                                                        .description(
                                                                                "test-last-operation-description")
                                                                        .build())
                                                        .name("test-service-name")
                                                        .servicePlan(
                                                                Plan.builder()
    ...
    private static void requestGetSpaceSummaryManagedServicesOneApplication(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .getSummary(GetSpaceSummaryRequest.builder().spaceId(spaceId).build()))
                                        ...
                                        .service(
                                                org.cloudfoundry.client.v2.serviceinstances
                                                        ...
                                                        .lastOperation(
                                                                LastOperation.builder()
                                                                        .description(
                                                                                "test-last-operation-description-1")
                                                                        .build())
                                                        .name("test-service-name-1")
                                                        .servicePlan(
                                                                Plan.builder()
                                                                        .id(
                                                                                "test-service-plan-id-1")
                                                                        .name(
                                                                                "test-service-plan-name-1")
                                                                        .service(
                                                                                Service.builder()
                                                                                        .id(
                                                                                                "test-provided-service-id")
    ...
    private static void requestGetSpaceSummaryUserProvidedServices(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .getSummary(GetSpaceSummaryRequest.builder().spaceId(spaceId).build()))
    ...
    private static void requestListOrganizationPrivateDomains(
    ...
    private static void requestListOrganizationPrivateDomainsEmpty(
            CloudFoundryClient cloudFoundryClient, String name, String organizationId) {
        when(cloudFoundryClient
                        .organizations()
                        .listPrivateDomains(
    ...
    private static void requestListRoutes(CloudFoundryClient cloudFoundryClient, String domainId) {
        when(cloudFoundryClient
                        .routes()
                        .list(ListRoutesRequest.builder().domainId(domainId).page(1).build()))
                .thenReturn(
                        Mono.just(
                                fill(ListRoutesResponse.builder())
                                        .resource(
    ...
    private static void requestListRoutesEmpty(
    ...
    private static void requestListSpaceServiceBindings(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String applicationId) {
        when(cloudFoundryClient
                        .serviceBindingsV2()
                        .list(
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListServiceBindingsResponse.builder())
                                        .resource(
                                                fill(
                                                                ServiceBindingResource.builder(),
                                                                "service-binding")
    ...
    private static void requestListSpaceServiceInstanceServiceKeys(
            CloudFoundryClient cloudFoundryClient,
            String serviceInstanceId,
            String serviceKey,
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListServiceInstanceServiceKeysResponse.builder())
                                        .resource(
                                                fill(ServiceKeyResource.builder(), "service-key-")
                                                        .entity(
    ...
    private static void requestListSpaceServiceInstanceServiceKeysEmpty(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String serviceKey) {
        when(cloudFoundryClient
                        .serviceInstances()
                        .listServiceKeys(
                                ListServiceInstanceServiceKeysRequest.builder()
                                        ...
                                        .build()))
                .thenReturn(
                        Mono.just(fill(ListServiceInstanceServiceKeysResponse.builder()).build()));
    }
    ...
    private static void requestListSpaceServiceInstances(
                                ...
                                fill(ListSpaceServiceInstancesResponse.builder())
                                        .resource(
                                                fill(
                                                                ...
                                                                "service-instance-")
                                                        .entity(
                                                                fill(UnionServiceInstanceEntity
                                                                                .builder())
                                                                        .servicePlanId(
                                                                                servicePlanId)
                                                                        .build())
    ...
    private static void requestListSpaceServiceInstancesEmpty(
            CloudFoundryClient cloudFoundryClient, String serviceName, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .listServiceInstances(
                                ListSpaceServiceInstancesRequest.builder()
                                        ...
                                        .spaceId(spaceId)
                                        .build()))
                .thenReturn(Mono.just(fill(ListSpaceServiceInstancesResponse.builder()).build()));
    }
    ...
    private static void requestListSpaceServiceInstancesUserProvided(
            CloudFoundryClient cloudFoundryClient, String serviceName, String spaceId) {
        when(cloudFoundryClient
                        .spaces()
                        .listServiceInstances(
    ...
    private static void requestListSpaceServicePlanVisibilities(
    ...
    private static void requestListSpaceServicePlanVisibilitiesEmpty(
            CloudFoundryClient cloudFoundryClient, String organizationId, String servicePlanId) {
        when(cloudFoundryClient
                        .servicePlanVisibilities()
                        .list(
    ...
    private static void requestListSpaceServicePlans(
                                                ...
                                                ServicePlanResource.builder()
                                                        .metadata(
                                                                fill(Metadata.builder())
                                                                        ...
                                                                        .build())
                                                        .entity(
                                                                fill(ServicePlanEntity.builder())
                                                                        .name(plan)
                                                                        .build())
                                                        .build())
                                        .build()));
    ...
    private static void requestListSpaceServicePlansNotPublic(
            CloudFoundryClient cloudFoundryClient, String serviceId, String plan, String planId) {
        when(cloudFoundryClient
                        .servicePlans()
                        .list(
    ...
    private static void requestListSpaceServices(
            CloudFoundryClient cloudFoundryClient, String spaceId, String serviceLabel) {
        when(cloudFoundryClient
                        .spaces()
                        .listServices(
    ...
    private static void requestListSpaceServicesTwo(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            String serviceLabel1,
    ...
    private static void requestRemoveUserProvidedServiceInstanceRoute(
    ...
    private static void requestRenameServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String newName) {
        when(cloudFoundryClient
                        .serviceInstances()
                        .update(
                                org.cloudfoundry.client.v2.serviceinstances
                                        ...
                                        .serviceInstanceId(serviceInstanceId)
                                        .build()))
                .thenReturn(Mono.just(fill(UpdateServiceInstanceResponse.builder()).build()));
    }

    private static void requestUpdateServiceInstance(
            CloudFoundryClient cloudFoundryClient,
    ...
    private static void requestUpdateUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            Map<String, Object> credentials,
            String syslogDrainUrl,
            List<String> tags,
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(UpdateUserProvidedServiceInstanceResponse.builder()).build()));
    }

    private void requestListSharedDomains(CloudFoundryClient cloudFoundryClient, String name) {
        when(cloudFoundryClient
                        .sharedDomains()
                        .list(ListSharedDomainsRequest.builder().name(name).page(1).build()))
                .thenReturn(
                        Mono.just(
