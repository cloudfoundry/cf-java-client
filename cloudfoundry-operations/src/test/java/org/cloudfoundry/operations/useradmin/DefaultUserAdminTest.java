...
final class DefaultUserAdminTest extends AbstractOperationsTest {
    ...
    private final DefaultUserAdmin userAdmin =
            new DefaultUserAdmin(Mono.just(this.cloudFoundryClient), Mono.just(this.uaaClient));
    ...
    void deleteNoCfUser() {
        ...
        this.userAdmin
                .delete(DeleteUserRequest.builder().username("test-username").build())
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
        ...
        this.userAdmin
                .listOrganizationUsers(
                        ListOrganizationUsersRequest.builder()
                                ...
                                .build())
                .as(StepVerifier::create)
                .expectNext(OrganizationUsers.builder().build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
        ...
        this.userAdmin
                .listSpaceUsers(
                        ListSpaceUsersRequest.builder()
                                ...
                                .build())
                .as(StepVerifier::create)
                .expectNext(SpaceUsers.builder().build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
    ...
    void setOrganizationRole() {
        ...
        requestAssociateOrganizationUserByUsername(
                this.cloudFoundryClient, "test-organization-id", "test-username");
        requestAssociateOrganizationAuditorByUsername(
                this.cloudFoundryClient, "test-organization-id", "test-username");
    ...
    void setSpaceRole() {
        ...
        requestListOrganizationSpaces(
                this.cloudFoundryClient, "test-organization-id", "test-space-name");
        requestAssociateOrganizationUserByUsername(
                this.cloudFoundryClient, "test-organization-id", "test-username");
        requestAssociateSpaceManagerByUsername(
                this.cloudFoundryClient, "test-space-id", "test-username");
    ...
    void setSpaceRoleInvalidSpace() {
        requestGetFeatureFlag(this.cloudFoundryClient, "set_roles_by_username", true);
        requestListOrganizations(this.cloudFoundryClient, "test-organization-name");
        requestListOrganizationSpacesEmpty(
                this.cloudFoundryClient, "test-organization-id", "test-space-name");
    ...
    void unsetOrganizationRole() {
        ...
        requestListOrganizations(this.cloudFoundryClient, "test-organization-name");
        requestRemoveOrganizationManagerByUsername(
                this.cloudFoundryClient, "test-organization-id", "test-username");
    ...
    void unsetSpaceRole() {
        ...
        requestListOrganizationSpaces(
                this.cloudFoundryClient, "test-organization-id", "test-space-name");
        requestRemoveSpaceManagerByUsername(
                this.cloudFoundryClient, "test-space-id", "test-username");
    ...
    private static void requestAssociateOrganizationAuditorByUsername(
    ...
    private static void requestCreateUaaUser(UaaClient uaaClient) {
        when(uaaClient
                ...
                .thenReturn(
                        Mono.just(
                                org.cloudfoundry.uaa.users.CreateUserResponse.builder()
                                        .id("test-user-id")
                                        .active(true)
                                        .meta(
                                                Meta.builder()
    ...
    private static void requestCreateUser(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                org.cloudfoundry.client.v2.users.CreateUserResponse.builder()
                                        .build()));
    }
    ...
    private static void requestDeleteUaaUser(UaaClient uaaClient) {
        when(uaaClient
                ...
                .thenReturn(
                        Mono.just(
                                org.cloudfoundry.uaa.users.DeleteUserResponse.builder()
                                        .id("test-user-id")
                                        .active(true)
                                        .meta(
                                                Meta.builder()
    ...
    private static void requestDeleteUser(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(DeleteUserResponse.builder())
    ...
    private static void requestGetFeatureFlag(
        ...
        when(cloudFoundryClient
                ...
                .thenReturn(Mono.just(GetFeatureFlagResponse.builder().enabled(enabled).build()));
    }
    ...
    private static void requestListOrganizationAuditors(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListOrganizationAuditorsResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
                                                                        .username(
                                                                                "test-auditor-username")
                                                                        .build())
                                                        .build())
                                        .build()));
    }

    private static void requestListOrganizationAuditorsEmpty(
        ...
        when(cloudFoundryClient
                        ...
                        .listAuditors(
                                ListOrganizationAuditorsRequest.builder()
                                        ...
                                        .page(1)
                                        .build()))
                .thenReturn(Mono.just(fill(ListOrganizationAuditorsResponse.builder()).build()));
    }

    private static void requestListOrganizationBillingManagers(
            CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                        .organizations()
                        .listBillingManagers(
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListOrganizationBillingManagersResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
                                                                        .username(
                                                                                "test-billing-manager-username")
                                                                        .build())
                                                        .build())
                                        .build()));
    }

    private static void requestListOrganizationBillingManagersEmpty(
            CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                        .organizations()
                        .listBillingManagers(
                                ListOrganizationBillingManagersRequest.builder()
                                        ...
                                        .build()))
                .thenReturn(
                        Mono.just(fill(ListOrganizationBillingManagersResponse.builder()).build()));
    }
    ...
    private static void requestListOrganizationManagers(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListOrganizationManagersResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
    ...
    private static void requestListOrganizationManagersEmpty(
            CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                        .organizations()
                        .listManagers(
                                ListOrganizationManagersRequest.builder()
                                        ...
                                        .page(1)
                                        .build()))
                .thenReturn(Mono.just(fill(ListOrganizationManagersResponse.builder()).build()));
    }

    private static void requestListOrganizationSpaces(
    ...
    private static void requestListOrganizationSpacesEmpty(
            CloudFoundryClient cloudFoundryClient, String organizationId, String spaceName) {
        when(cloudFoundryClient
                        .organizations()
                        .listSpaces(
    ...
    private static void requestListSpaceAuditors(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListSpaceAuditorsResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
        ...
        when(cloudFoundryClient
                        ...
                        .listAuditors(
                                ListSpaceAuditorsRequest.builder()
                                        ...
                                        .page(1)
                                        .build()))
                .thenReturn(Mono.just(fill(ListSpaceAuditorsResponse.builder()).build()));
    }
    ...
    private static void requestListSpaceDevelopers(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListSpaceDevelopersResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
                                                                        .username(
                                                                                "test-developer-username")
                                                                        .build())
                                                        .build())
                                        .build()));
    }
        ...
        when(cloudFoundryClient
                        ...
                        .listDevelopers(
                                ListSpaceDevelopersRequest.builder()
                                        ...
                                        .page(1)
                                        .build()))
                .thenReturn(Mono.just(fill(ListSpaceDevelopersResponse.builder()).build()));
    }
    ...
    private static void requestListSpaceManagers(CloudFoundryClient cloudFoundryClient) {
        when(cloudFoundryClient
                ...
                .thenReturn(
                        Mono.just(
                                fill(ListSpaceManagersResponse.builder())
                                        .resource(
                                                fill(UserResource.builder())
                                                        .entity(
                                                                fill(UserEntity.builder())
        ...
        when(cloudFoundryClient
                        ...
                        .listManagers(
                                ListSpaceManagersRequest.builder()
                                        ...
                                        .page(1)
                                        .build()))
                .thenReturn(Mono.just(fill(ListSpaceManagersResponse.builder()).build()));
    }
    ...
    private static void requestListUser(UaaClient uaaClient) {
        when(uaaClient
                        .users()
                        .list(
                                org.cloudfoundry.uaa.users.ListUsersRequest.builder()
                                        .filter("userName eq \"test-username\"")
                                        .startIndex(1)
                                        .build()))
                .thenReturn(
                        Mono.just(
                                fill(org.cloudfoundry.uaa.users.ListUsersResponse.builder())
                                        .resource(
                                                User.builder()
                                                        .id("test-user-id")
                                                        .active(true)
    ...
    private static void requestRemoveOrganizationManagerByUsername(
            CloudFoundryClient cloudFoundryClient, String organizationId, String username) {
        when(cloudFoundryClient
                        .organizations()
    ...
    private static void requestRemoveSpaceManagerByUsername(
            CloudFoundryClient cloudFoundryClient, String spaceId, String username) {
        when(cloudFoundryClient
                        .spaces()
                        .removeManagerByUsername(
