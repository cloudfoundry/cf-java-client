...
final class DefaultSpaceAdminTest extends AbstractOperationsTest {
    ...
    private final DefaultSpaceAdmin spaceAdmin =
            new DefaultSpaceAdmin(
                    Mono.just(this.cloudFoundryClient), Mono.just(TEST_ORGANIZATION_ID));
    ...
    void get() {
        ...
        this.spaceAdmin
                ...
                .expectNext(fill(SpaceQuota.builder(), "space-quota-definition-").build())
                .expectComplete()
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "Space Quota test-space-quota-definition-name does"
                                                        + " not exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    private static void requestSpaceQuotaDefinitionsEmpty(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        when(cloudFoundryClient
                        .organizations()
                        .listSpaceQuotaDefinitions(
