...
public class RouteUtilsTest {
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "The route test.test.com did not match any existing"
                                                        + " domains"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    public void partialMatchMiss() {
        List<DomainSummary> availableDomains = new ArrayList<>();
        availableDomains.add(DomainSummary.builder().id("1").name("test.something.com").build());
        availableDomains.add(DomainSummary.builder().id("2").name("something.com").build());
        availableDomains.add(DomainSummary.builder().id("3").name("hing.com").build());
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "The route thing.com did not match any existing"
                                                        + " domains"))
                .verify(Duration.ofSeconds(5));
    }
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "The route est.com did not match any existing"
                                                        + " domains"))
                .verify(Duration.ofSeconds(5));
    }
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "The route miss.com/path did not match any existing"
                                                        + " domains"))
                .verify(Duration.ofSeconds(5));
    }
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage(
                                                "The route miss.com did not match any existing"
                                                        + " domains"))
                .verify(Duration.ofSeconds(5));
    }
