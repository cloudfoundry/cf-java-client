...
public final class DefaultSpaceAdmin implements SpaceAdmin {
    ...
    public DefaultSpaceAdmin(
            Mono<CloudFoundryClient> cloudFoundryClient, Mono<String> organizationId) {
    ...
    private static Mono<SpaceQuotaDefinitionResource> getSpaceQuotaDefinition(
            CloudFoundryClient cloudFoundryClient, String organizationId, String name) {
        return requestSpaceQuotaDefinitions(cloudFoundryClient, organizationId)
                ...
                .onErrorResume(
                        ...
                        t -> ExceptionUtils.illegalArgument("Space Quota %s does not exist", name));
    }
