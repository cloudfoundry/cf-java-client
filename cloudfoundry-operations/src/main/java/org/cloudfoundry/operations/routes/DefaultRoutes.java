...
public final class DefaultRoutes implements Routes {
        ...
        public Mono<Boolean> check(CheckRouteRequest request) {
                return Mono
                                ...
                                .flatMap(function((cloudFoundryClient, domainId) -> requestRouteExists(
                                                cloudFoundryClient, domainId, request.getHost(), request.getPath())))
                ...
                return Mono
                                ...
                                .flatMap(function((cloudFoundryClient, spaceId,
                                                domainId) -> requestCreateRoute(cloudFoundryClient, domainId,
                                                                ...
                                                                request.getRandomPort(), spaceId)
                                                                .map(ResourceUtils::getEntity)
                                                                .flatMap(routeEntity -> Mono
                                                                                .justOrEmpty(routeEntity.getPort()))))
                ...
                return Mono
                                ...
                                .flatMap(function((cloudFoundryClient, domainId) -> Mono.zip(
                                                ...
                                                getRouteId(cloudFoundryClient, request.getHost(), request.getDomain(),
                                                                domainId, request.getPath(), request.getPort()))))
        ...
        public Mono<Void> deleteOrphanedRoutes(DeleteOrphanedRoutesRequest request) {
                return Mono
                                ...
                                .flatMapMany(function((cloudFoundryClient,
                                                spaceId) -> requestSpaceRoutes(cloudFoundryClient, spaceId)
                                                                ...
                                                                .map(routeId -> Tuples.of(cloudFoundryClient,
                                                                                routeId))))
                                .flatMap(function((cloudFoundryClient, routeId) -> getApplications(cloudFoundryClient,
                                                routeId)
                                ...
                                .flatMap(function((cloudFoundryClient, applicationResources, routeId) -> deleteRoute(
                                                cloudFoundryClient, request.getCompletionTimeout(), routeId)))
                                .then()
        ...
        public Flux<Route> list(ListRoutesRequest request) {
                return Mono
                                ...
                                .flatMapMany(function((cloudFoundryClient, domains, spaces) -> getRoutes(
                                                cloudFoundryClient, request, this.organizationId, this.spaceId)
                ...
                return Mono
                                ...
                                .flatMap(function((cloudFoundryClient, organizationId, spaceId) -> Mono.zip(
                                                ...
                                                getOrCreateRoute(cloudFoundryClient, organizationId, spaceId,
                                                                request.getDomain(), request.getHost(),
                                ...
                                .flatMap(function((cloudFoundryClient, routeResource,
                                                applicationId) -> requestAssociateRoute(cloudFoundryClient,
                                                                applicationId, ResourceUtils.getId(routeResource))))
                                ...
                                .flatMap(function((cloudFoundryClient, organizationId, spaceId) -> Mono.zip(
                                                ...
                                                getDomainId(cloudFoundryClient, organizationId, request.getDomain())
                                                                .flatMap(domainId -> getRouteId(cloudFoundryClient,
                                                                                request.getHost(), request.getDomain(),
                                                                                domainId, request.getPath(),
                                                                                request.getPort())))))
        ...
        private static Mono<ApplicationResource> getApplication(CloudFoundryClient cloudFoundryClient,
                ...
                return requestApplications(cloudFoundryClient, application, spaceId)
                                ...
                                .onErrorResume(NoSuchElementException.class, t -> ExceptionUtils
                                                .illegalArgument("Application %s does not exist", application));
        }
        ...
        private static Mono<Resource<?>> getDomain(CloudFoundryClient cloudFoundryClient, String organizationId,
                ...
                return getDomains(cloudFoundryClient, organizationId, domain)
                                .single()
                                .onErrorResume(NoSuchElementException.class, t -> ExceptionUtils
                                                .illegalArgument("Domain %s does not exist", domain));
        }
        ...
        private static Mono<RouteResource> getRoute(CloudFoundryClient cloudFoundryClient, String domainId,
                        String domain, String host, String path, Integer port) {
        ...
        private static Mono<Optional<String>> getServiceName(CloudFoundryClient cloudFoundryClient, RouteEntity route) {
                return Mono.justOrEmpty(route.getServiceInstanceId())
                                .flatMap(serviceInstanceId -> getServiceInstanceName(cloudFoundryClient,
                                                serviceInstanceId, route.getSpaceId()))
        ...
        private static Mono<String> getSpaceId(CloudFoundryClient cloudFoundryClient, String organizationId,
                        String space) {
        ...
        private static Mono<CreateRouteResponse> requestCreateRoute(CloudFoundryClient cloudFoundryClient,
                        String domainId, String host, String path, Integer port, Boolean randomPort, String spaceId) {
        ...
        private static Mono<DeleteRouteResponse> requestDeleteRoute(CloudFoundryClient cloudFoundryClient,
                        String routeId) {
                return cloudFoundryClient.routes()
        ...
        private static Mono<Boolean> requestRouteExists(CloudFoundryClient cloudFoundryClient, String domainId,
