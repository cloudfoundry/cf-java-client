...
public final class DefaultServices implements Services {
    ...
    public Mono<Void> bindRoute(BindRouteServiceInstanceRequest request) {
        return Mono.zip(this.cloudFoundryClient, this.organizationId, this.spaceId)
                ...
                .flatMap(
                        function(
                                (cloudFoundryClient, domainId, spaceId) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                getRouteId(
                                                        cloudFoundryClient,
                ...
                .flatMap(
                        function(
                                (cloudFoundryClient, routeId, userProvidedServiceInstanceId) ->
                                        createRouteBinding(
                                                cloudFoundryClient,
                                                routeId,
    ...
    public Mono<Void> createInstance(CreateServiceInstanceRequest request) {
        return Mono.zip(this.cloudFoundryClient, this.spaceId)
                ...
                .flatMap(
                        function(
                                (cloudFoundryClient, spaceId, serviceId) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                Mono.just(spaceId),
                                                getServicePlanIdByName(
                                                        cloudFoundryClient,
                                                        serviceId,
                                                        request.getPlanName()))))
                .flatMap(
                        function(
                                (cloudFoundryClient, spaceId, planId) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                        ...
                        function(
                                (cloudFoundryClient, resource) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                Mono.just(resource),
                                                getServicePlanEntity(
                                                        cloudFoundryClient,
                                                        ResourceUtils.getEntity(resource)
                                                                .getServicePlanId()))))
                .flatMap(
                        function(
                                (cloudFoundryClient, resource, servicePlanEntity) ->
                                        Mono.zip(
                                                Mono.just(resource),
                                                Mono.just(
                                                        Optional.ofNullable(
    ...
    public Flux<ServiceOffering> listServiceOfferings(ListServiceOfferingsRequest request) {
        return Mono.zip(this.cloudFoundryClient, this.spaceId)
                .flatMapMany(
                        function(
                                (cloudFoundryClient, spaceId) ->
                                        Optional.ofNullable(request.getServiceName())
                                                .map(
                                                        serviceName ->
                                                                getSpaceService(
                                                                                cloudFoundryClient,
    ...
    public Mono<Void> updateInstance(UpdateServiceInstanceRequest request) {
        return Mono.zip(this.cloudFoundryClient, this.organizationId, this.spaceId)
                ...
                .flatMap(
                        function(
                                (cloudFoundryClient, organizationId, serviceInstance) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                Mono.just(ResourceUtils.getId(serviceInstance)),
                                                getOptionalValidatedServicePlanId(
                                                        cloudFoundryClient,
                                                        request.getPlanName(),
                                                        serviceInstance,
                                                        organizationId))))
                .flatMap(
                        function(
                                (cloudFoundryClient, serviceInstanceId, servicePlanId) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                Mono.just(request.getCompletionTimeout()),
    ...
    public Mono<Void> updateUserProvidedInstance(UpdateUserProvidedServiceInstanceRequest request) {
        return Mono.zip(this.cloudFoundryClient, this.spaceId)
                .flatMap(
                        function(
                                (cloudFoundryClient, spaceId) ->
                                        Mono.zip(
                                                Mono.just(cloudFoundryClient),
                                                getSpaceUserProvidedServiceInstanceId(
                                                        cloudFoundryClient,
                                                        request
                ...
                .flatMap(
                        function(
                                (cloudFoundryClient, userProvidedServiceInstanceId) ->
    ...
    private static Mono<Optional<String>> checkVisibility(
        ...
        return requestListServicePlanVisibilities(cloudFoundryClient, organizationId, servicePlanId)
                ...
                .switchIfEmpty(
                        ExceptionUtils.illegalArgument(
                                "Service Plan %s is not visible to your organization",
                                resource.getEntity().getName()))
                .thenReturn(Optional.of(servicePlanId));
    }

    private static Mono<AssociateUserProvidedServiceInstanceRouteResponse> createRouteBinding(
            CloudFoundryClient cloudFoundryClient,
            String routeId,
            String userProvidedServiceInstanceId,
            Map<String, Object> parameters) {
        return requestCreateRouteBinding(
                        cloudFoundryClient, routeId, userProvidedServiceInstanceId, parameters)
                .onErrorResume(
                        ExceptionUtils.statusCode(CF_ROUTE_SERVICE_ALREADY_BOUND),
                        t -> Mono.empty());
    }

    private static Mono<CreateServiceBindingResponse> createServiceBinding(
            CloudFoundryClient cloudFoundryClient,
            String applicationId,
            String serviceInstanceId,
            Map<String, Object> parameters) {
        return requestCreateServiceBinding(
                        cloudFoundryClient, applicationId, serviceInstanceId, parameters)
                .onErrorResume(
                        ExceptionUtils.statusCode(CF_SERVICE_ALREADY_BOUND), t -> Mono.empty());
    }

    private static Mono<AbstractServiceInstanceResource> createServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            String planId,
            CreateServiceInstanceRequest request) {
        return requestCreateServiceInstance(
                        cloudFoundryClient,
                        spaceId,
                        planId,
                        request.getServiceInstanceName(),
    ...
    private static Mono<Void> deleteServiceBinding(
            CloudFoundryClient cloudFoundryClient,
    ...
    private static Mono<Void> deleteServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            Duration completionTimeout,
            UnionServiceInstanceResource serviceInstance) {
        if (isUserProvidedService(serviceInstance)) {
            return requestDeleteUserProvidedServiceInstance(
                    cloudFoundryClient, ResourceUtils.getId(serviceInstance));
        } else {
    ...
    private static Mono<ApplicationResource> getApplication(
        ...
        return requestListApplications(cloudFoundryClient, applicationName, spaceId)
                ...
                .onErrorResume(
                        ...
                        t ->
                                ExceptionUtils.illegalArgument(
                                        "Application %s does not exist", applicationName));
    }
    ...
    private static Mono<List<String>> getBoundApplications(
    ...
    private static Mono<String> getDomainId(
    ...
    private static Mono<Optional<String>> getOptionalValidatedServicePlanId(
            CloudFoundryClient cloudFoundryClient,
            String planName,
            UnionServiceInstanceResource serviceInstance,
            String organizationId) {
        ...
        if (servicePlanId == null || servicePlanId.isEmpty()) {
            return ExceptionUtils.illegalArgument(
                    "Plan does not exist for the %s service",
        ...
        return getServiceId(cloudFoundryClient, servicePlanId)
                ...
                .switchIfEmpty(
                        ExceptionUtils.illegalArgument(
                                "Plan for the %s service cannot be updated",
                                serviceInstance.getEntity().getName()))
                .flatMapMany(
                        response ->
                                requestListServicePlans(
                                        cloudFoundryClient, ResourceUtils.getId(response)))
                .filter(resource -> planName.equals(resource.getEntity().getName()))
                .singleOrEmpty()
                .switchIfEmpty(
                        ExceptionUtils.illegalArgument("New service plan %s not found", planName))
    ...
    private static Mono<RouteResource> getRoute(
            CloudFoundryClient cloudFoundryClient,
            String domain,
            String domainId,
            String host,
    ...
    private static Mono<String> getServiceBindingId(
            CloudFoundryClient cloudFoundryClient,
            String applicationId,
            String serviceInstanceId,
        ...
        return requestListServiceBindings(cloudFoundryClient, applicationId, serviceInstanceId)
                ...
                .switchIfEmpty(
                        ExceptionUtils.illegalState(
                                "Service instance %s is not bound to application",
                                serviceInstanceName))
                .map(ResourceUtils::getId);
    }

    private static Mono<ServiceEntity> getServiceEntity(
            CloudFoundryClient cloudFoundryClient, Optional<String> serviceId) {
    ...
    private static Mono<String> getServiceIdByName(
            CloudFoundryClient cloudFoundryClient, String spaceId, String service) {
        return getSpaceService(cloudFoundryClient, spaceId, service).map(ResourceUtils::getId);
    }

    private static Mono<ServiceKeyResource> getServiceKey(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String serviceKey) {
        return requestListServiceInstanceServiceKeys(
                        cloudFoundryClient, serviceInstanceId, serviceKey)
                .single()
                .onErrorResume(
                        NoSuchElementException.class,
                        t ->
                                ExceptionUtils.illegalArgument(
                                        "Service key %s does not exist", serviceKey));
    }

    private static Mono<ServicePlanEntity> getServicePlanEntity(
            CloudFoundryClient cloudFoundryClient, String servicePlanId) {
        return Mono.justOrEmpty(servicePlanId)
                .flatMap(
                        servicePlanId1 -> requestGetServicePlan(cloudFoundryClient, servicePlanId1))
                .map(ResourceUtils::getEntity)
                .switchIfEmpty(Mono.just(ServicePlanEntity.builder().build()));
    }

    private static Mono<String> getServicePlanIdByName(
            CloudFoundryClient cloudFoundryClient, String serviceId, String plan) {
        return requestListServicePlans(cloudFoundryClient, serviceId)
                ...
                .onErrorResume(
                        ...
                        t ->
                                ExceptionUtils.illegalArgument(
                                        "Service plan %s does not exist", plan));
    }

    private static Mono<List<ServicePlanResource>> getServicePlans(
    ...
    private static Mono<ServiceResource> getSpaceService(
            CloudFoundryClient cloudFoundryClient, String spaceId, String service) {
        return requestListServices(cloudFoundryClient, spaceId, service)
                .single()
                .onErrorResume(
                        NoSuchElementException.class,
                        t -> ExceptionUtils.illegalArgument("Service %s does not exist", service));
    }

    private static Mono<UnionServiceInstanceResource> getSpaceServiceInstance(
        ...
        return requestListServiceInstances(cloudFoundryClient, spaceId, serviceInstanceName)
                ...
                .onErrorResume(
                        ...
                        t ->
                                ExceptionUtils.illegalArgument(
                                        "Service instance %s does not exist", serviceInstanceName));
    }

    private static Mono<String> getSpaceServiceInstanceId(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceName, String spaceId) {
        return getSpaceServiceInstance(cloudFoundryClient, serviceInstanceName, spaceId)
                .map(ResourceUtils::getId);
    }

    private static Mono<UnionServiceInstanceResource> getSpaceUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceName, String spaceId) {
        return requestListServiceInstances(cloudFoundryClient, spaceId, serviceInstanceName)
                ...
                .onErrorResume(
                        ...
                        t ->
                                ExceptionUtils.illegalArgument(
                                        "User provided service instance %s does not exist",
                                        serviceInstanceName));
    }

    private static Mono<String> getSpaceUserProvidedServiceInstanceId(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceName, String spaceId) {
    ...
    private static boolean isUserProvidedService(UnionServiceInstanceResource serviceInstance) {
        return ServiceInstanceType.from(ResourceUtils.getEntity(serviceInstance).getType())
                .equals(ServiceInstanceType.USER_PROVIDED);
    }

    private static Mono<BaseServiceInstanceEntity> renameServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            UnionServiceInstanceResource serviceInstance,
            String newName) {
        if (isUserProvidedService(serviceInstance)) {
            return requestUserProvidedServiceInstanceUpdate(
                            cloudFoundryClient, ResourceUtils.getId(serviceInstance), newName)
                    .map(ResourceUtils::getEntity)
                    .cast(BaseServiceInstanceEntity.class);
        } else {
            return requestServiceInstanceUpdate(
                            cloudFoundryClient, ResourceUtils.getId(serviceInstance), newName)
                    .map(ResourceUtils::getEntity)
                    .cast(BaseServiceInstanceEntity.class);
        }
    ...
    private static Mono<AssociateUserProvidedServiceInstanceRouteResponse>
            requestCreateRouteBinding(
                    CloudFoundryClient cloudFoundryClient,
                    String routeId,
                    String userProvidedServiceInstanceId,
                    Map<String, Object> parameters) {
    ...
    private static Mono<CreateServiceInstanceResponse> requestCreateServiceInstance(
        ...
        return cloudFoundryClient
                .serviceInstances()
                .create(
                        org.cloudfoundry.client.v2.serviceinstances.CreateServiceInstanceRequest
                                .builder()
    ...
    private static Mono<CreateServiceKeyResponse> requestCreateServiceKey(
        ...
        return cloudFoundryClient
                .serviceKeys()
                .create(
                        org.cloudfoundry.client.v2.servicekeys.CreateServiceKeyRequest.builder()
                                .serviceInstanceId(serviceInstanceId)
                                .name(serviceKey)
                                .parameters(parameters)
                                .build());
    ...
    private static Mono<DeleteServiceBindingResponse> requestDeleteServiceBinding(
    ...
    private static Mono<DeleteServiceInstanceResponse> requestDeleteServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        return cloudFoundryClient
                .serviceInstances()
                .delete(
                        org.cloudfoundry.client.v2.serviceinstances.DeleteServiceInstanceRequest
                                .builder()
                                .acceptsIncomplete(true)
                                .serviceInstanceId(serviceInstanceId)
                                .async(true)
    ...
    private static Mono<Void> requestDeleteServiceKey(
            CloudFoundryClient cloudFoundryClient, String serviceKeyId) {
        return cloudFoundryClient
                .serviceKeys()
                .delete(
                        org.cloudfoundry.client.v2.servicekeys.DeleteServiceKeyRequest.builder()
                                .serviceKeyId(serviceKeyId)
                                .build());
    }

    private static Mono<Void> requestDeleteUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        return cloudFoundryClient
                .userProvidedServiceInstances()
                .delete(
    ...
    private static Mono<GetServiceResponse> requestGetService(
            CloudFoundryClient cloudFoundryClient, String serviceId) {
        return cloudFoundryClient
                .services()
    ...
    private static Mono<GetServiceInstanceResponse> requestGetServiceInstance(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        return cloudFoundryClient
                .serviceInstances()
                .get(
                        org.cloudfoundry.client.v2.serviceinstances.GetServiceInstanceRequest
                                .builder()
                                .serviceInstanceId(serviceInstanceId)
                                .build());
    }

    private static Mono<GetServicePlanResponse> requestGetServicePlan(
            CloudFoundryClient cloudFoundryClient, String servicePlanId) {
        return cloudFoundryClient
                .servicePlans()
    ...
    private static Flux<ServiceKeyResource> requestListServiceInstanceServiceKeys(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String serviceKey) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Flux<UnionServiceInstanceResource> requestListServiceInstances(
            CloudFoundryClient cloudFoundryClient, String spaceId, String serviceInstanceName) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
    ...
    private static Flux<ServicePlanVisibilityResource> requestListServicePlanVisibilities(
    ...
    private static Flux<ServiceResource> requestListServices(
            CloudFoundryClient cloudFoundryClient, String spaceId, String serviceName) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
    ...
    private static Flux<PrivateDomainResource> requestPrivateDomain(
            CloudFoundryClient cloudFoundryClient, String domain, String organizationId) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Mono<Void> requestRemoveRoute(
            CloudFoundryClient cloudFoundryClient,
            String routeId,
            String userProvidedServiceInstanceId) {
        return cloudFoundryClient
    ...
    private static Flux<RouteResource> requestRoutes(
            CloudFoundryClient cloudFoundryClient,
            UnaryOperator<ListRoutesRequest.Builder> modifier) {

        ListRoutesRequest.Builder listBuilder = modifier.apply(ListRoutesRequest.builder());

        return PaginationUtils.requestClientV2Resources(
                page -> cloudFoundryClient.routes().list(listBuilder.page(page).build()));
    }
    ...
    private static Mono<UpdateServiceInstanceResponse> requestServiceInstanceUpdate(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId, String newName) {
        return cloudFoundryClient
                .serviceInstances()
                .update(
                        org.cloudfoundry.client.v2.serviceinstances.UpdateServiceInstanceRequest
                                .builder()
                                .name(newName)
                                .serviceInstanceId(serviceInstanceId)
                                .build());
    ...
    private static Flux<SharedDomainResource> requestSharedDomain(
            CloudFoundryClient cloudFoundryClient, String domain) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Mono<UpdateServiceInstanceResponse> requestUpdateServiceInstance(
            CloudFoundryClient cloudFoundryClient,
    ...
    private static Mono<UpdateUserProvidedServiceInstanceResponse>
            requestUserProvidedServiceInstanceUpdate(
                    CloudFoundryClient cloudFoundryClient,
                    String serviceInstanceId,
                    String newName) {
        return cloudFoundryClient
    ...
    private static ServiceInstance toServiceInstance(
            UnionServiceInstanceResource resource,
        ...
        Optional<String> documentationUrl =
                Optional.ofNullable(getExtraValue(extra, "documentationUrl"));
        UnionServiceInstanceEntity serviceInstanceEntity = resource.getEntity();
        LastOperation lastOperation =
                Optional.ofNullable(serviceInstanceEntity.getLastOperation())
                        .orElse(LastOperation.builder().build());
    ...
    private static Flux<ServiceInstanceSummary> toServiceInstanceSummary(
            GetSpaceSummaryResponse response) {
                ...
                .forEach(
                        application ->
                                application
                                        ...
                                        .forEach(
                                                serviceName -> {
                                                    if (!applicationBindings.containsKey(
                                                            serviceName)) {
                                                        applicationBindings.put(
                ...
                .map(
                        service ->
                                ServiceInstanceSummary.builder()
                                        ...
                                        .id(service.getId())
                                        .lastOperation(
                                                service.getLastOperation() == null
                                                        ? null
                                                        : service.getLastOperation()
                                                                .getDescription())
                                        .maintenanceInfo(service.getMaintenanceInfo())
                                        .name(service.getName())
                                        .plan(
                                                service.getServicePlan() == null
                                                        ? null
                                                        : service.getServicePlan().getName())
                                        .service(
                                                service.getServicePlan() == null
                                                        ? null
                                                        : service.getServicePlan()
                                                                .getService()
                                                                .getLabel())
                                        .type(
                                                service.getServicePlan() == null
    ...
    private static ServiceOffering toServiceOffering(
            ServiceResource resource, List<ServicePlanResource> servicePlans) {
    ...
    private static Mono<Void> waitForInstanceAction(
            CloudFoundryClient cloudFoundryClient,
            Duration completionTimeout,
            AbstractServiceInstanceResource serviceInstance) {
        return LastOperationUtils.waitForCompletion(
                completionTimeout,
                () ->
                        requestGetServiceInstance(
