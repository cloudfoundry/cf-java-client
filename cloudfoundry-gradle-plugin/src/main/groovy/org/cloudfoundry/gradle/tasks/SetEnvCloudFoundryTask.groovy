...
/**
 * A basic task which can be used to add an environment variable to an application on CloudFoundry platform.
 */
class SetEnvCloudFoundryTask extends AbstractEnvCloudFoundryTask {
    SetEnvCloudFoundryTask() {
        super()
        description = 'Sets environment variables to an application'
    }
