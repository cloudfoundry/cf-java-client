...
public class Login extends AbstractCloudFoundryMojo {
	...
	protected void doExecute() throws MojoExecutionException {
		...
		try {
			...
			throw new MojoExecutionException("Error writing to token file: mvn-cf.xml", e);
		}
	}

	protected void setClient(CloudFoundryClient client) {
		this.client = client;
	}
	...
	protected FileWriter createFileWriter() throws MojoExecutionException {
		...
		try {
			fileWriter = new FileWriter(System.getProperty("user.home") + "/.mvn-cf.xml");
		} catch (IOException e) {
