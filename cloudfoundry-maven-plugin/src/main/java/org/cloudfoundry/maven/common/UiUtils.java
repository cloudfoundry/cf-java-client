...
public final class UiUtils {
     ...
     *
     * <ul> <li>Names of the Applications</li> <li>Number of Instances</li> <li>Current State (Health)</li> <li>Used
     * Memory</li> <li>The comma-separated list of Uris</li> <li>The comma-separated list of Services</li> <ul>
     */
    ...
    /**
     * Renders the help text. If the callers is logged in successfully the full information is rendered if not only
     * basic Cloud Foundry information is rendered and returned as String.
     *
     ...
     */
    public static String renderCloudInfoFormattedAsString(CloudInfo cloudInfo, String target, String org, String
            space) {
     ...
     * @return The rendered table representation as String
     */
    public static String renderServiceDataAsTable(List<CloudService> services, Map<String, List<String>>
            servicesToApps) {
    ...
    /**
     * Renders a sorted textual representation of the list of provided {@link CloudFoundryClient, @link
    ...
    public static String renderServiceOfferingDataAsTable(List<CloudServiceOffering> serviceOfferings) {
        ...
        for (CloudServiceOffering serviceOffering : serviceOfferings) {
            ...
            tableRow.addValue(COLUMN_2, CloudServicePlanNames.toString().substring(1, CloudServicePlanNames.toString
                    ().length() - 1));
    ...
    public static String renderTextTable(Table table) {
        ...
        for (TableRow row : table.getRows()) {
            for (Entry<Integer, TableHeader> entry : table.getHeaders().entrySet()) {
                textTable.append(padding + CommonUtils.padRight(row.getValue(entry.getKey()), entry.getValue()
                        .getWidth()));
            }
            textTable.append("\n");
        }
