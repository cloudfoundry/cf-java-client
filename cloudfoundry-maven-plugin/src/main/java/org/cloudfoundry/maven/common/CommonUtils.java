...
/**
 * Contains common non-ui related helper methods for the Cloud Foundry Maven Plugin.
 *
...
public final class CommonUtils {
    ...
    /**
     * Simple method to replace characters in a String with Stars to mask the password.
     *
