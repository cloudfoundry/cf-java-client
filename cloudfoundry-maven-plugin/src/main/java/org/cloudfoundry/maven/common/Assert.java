...
public final class Assert {
     ...
     */
    public static void configurationNotNull(Object object, String objectName,
                                            SystemProperties property, String additionalDescription) throws
    ...
    /**
     * Assert that an object is not <code>null</code> . <pre class="code">Assert.notNull(clazz, "The class must not be
     * null");</pre>
     *
