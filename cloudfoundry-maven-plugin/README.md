...
**Show usage information**
    ...
    System Services: mysql, postgresql, redis, mongodb, vblob, rabbitmq, mongolab
...
## Deploying a Web Application Application
...
* Added **Framework** configuration parameter (-Dcf.framework) which allows to set the framework for the application. I defaults to *spring*.
