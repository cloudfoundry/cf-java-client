...
public final class AssociateSpaceAuditorResponseTest {

    @Test
    public void test() {
        AssociateSpaceAuditorResponse.SpaceEntity entity = new AssociateSpaceAuditorResponse.SpaceEntity()
                .allowSsh(true)
        ...
        AssociateSpaceAuditorResponse response = new AssociateSpaceAuditorResponse()
                .withEntity(entity);
