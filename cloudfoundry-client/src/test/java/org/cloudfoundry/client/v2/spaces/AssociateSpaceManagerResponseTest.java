...
public final class AssociateSpaceManagerResponseTest {

    @Test
    public void test() {
        AssociateSpaceManagerResponse.SpaceEntity entity = new AssociateSpaceManagerResponse.SpaceEntity()
                .allowSsh(true)
        ...
        AssociateSpaceManagerResponse response = new AssociateSpaceManagerResponse()
                .withEntity(entity);
