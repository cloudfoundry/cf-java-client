...
public final class AssociateSpaceDeveloperResponseTest {

    @Test
    public void test() {
        AssociateSpaceDeveloperResponse.SpaceEntity entity = new AssociateSpaceDeveloperResponse.SpaceEntity()
                .allowSsh(true)
        ...
        AssociateSpaceDeveloperResponse response = new AssociateSpaceDeveloperResponse()
                .withEntity(entity);
