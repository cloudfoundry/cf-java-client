...
import static org.cloudfoundry.v3.client.LinkMatcher.linkMatches;
...
public final class CreateApplicationResponseTest {
    ...
    public void test() {
        ...
        assertThat(response.getLink("test-rel-1"), linkMatches(new Link().withHref("test-href-1")));
        assertThat(response.getLink("test-rel-2"), linkMatches(new Link().withHref("test-href-2")));
