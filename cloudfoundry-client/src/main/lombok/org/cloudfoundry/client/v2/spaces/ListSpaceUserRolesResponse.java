...
public final class ListSpaceUserRolesResponse extends PaginatedResponse<UserRoleResource> {

    @Builder
    ListSpaceUserRolesResponse(@JsonProperty("next_url") String nextUrl,
                               @JsonProperty("prev_url") String previousUrl,
                               @JsonProperty("resources") @Singular List<UserRoleResource> resources,
