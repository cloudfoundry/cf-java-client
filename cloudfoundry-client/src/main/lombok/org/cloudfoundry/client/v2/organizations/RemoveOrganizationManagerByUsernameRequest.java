 ...
 */
@Data
public final class RemoveOrganizationManagerByUsernameRequest implements Validatable {
    ...
    @Builder
    RemoveOrganizationManagerByUsernameRequest(String organizationId, String username) {
