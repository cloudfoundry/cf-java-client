...
public final class ListSpaceDevelopersRequest extends PaginatedRequest implements Validatable {
    ...
    @Builder
    ListSpaceDevelopersRequest(OrderDirection orderDirection, Integer page, Integer resultsPerPage,
