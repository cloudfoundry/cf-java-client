 ...
 */
@Data
public final class AssociateOrganizationUserByUsernameRequest implements Validatable {
    ...
    @Builder
    AssociateOrganizationUserByUsernameRequest(String organizationId, String username) {
