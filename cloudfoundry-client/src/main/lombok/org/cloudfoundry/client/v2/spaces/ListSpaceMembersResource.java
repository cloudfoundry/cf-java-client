...
public final class ListSpaceMembersResource extends Resource<ListSpaceMembersResource
        .ListSpaceMembersResourceEntity> {

    @Builder
    ListSpaceMembersResource(@JsonProperty("entity") ListSpaceMembersResourceEntity entity,
                             @JsonProperty("metadata") Metadata metadata) {
        super(entity, metadata);
    }

    @Data
    public static final class ListSpaceMembersResourceEntity {
        ...
        @Builder
        ListSpaceMembersResourceEntity(@JsonProperty("admin") boolean admin,
