...
public class RestageApplicationResponseEntity extends AbstractApplicationEntity {
    ...
    @Builder
    RestageApplicationResponseEntity(@JsonProperty("buildpack") String buildpack,
