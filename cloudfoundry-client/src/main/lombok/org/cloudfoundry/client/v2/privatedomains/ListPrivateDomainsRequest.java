...
/**
 * The request payload for the List all Private Domains operation
 */
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public final class ListPrivateDomainsRequest extends PaginatedRequest implements Validatable {
