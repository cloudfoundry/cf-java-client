 ...
 */
@Data
public final class RemoveOrganizationUserByUsernameRequest implements Validatable {
    ...
    @Builder
    RemoveOrganizationUserByUsernameRequest(String organizationId, String username) {
