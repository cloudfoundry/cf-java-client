...
public abstract class AuditorResource extends Resource<AuditorResource.AuditorEntity> {

    protected AuditorResource(@JsonProperty("entity") AuditorEntity entity,
    ...
    public static final class AuditorEntity {
        ...
        @Builder
        AuditorEntity(@JsonProperty("app_events_url") String applicationEventsUrl,
