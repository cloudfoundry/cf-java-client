...
public final class GetTokenByClientCredentialsResponse extends AbstractToken {

    @Builder
    GetTokenByClientCredentialsResponse(@JsonProperty("access_token") String accessToken,
