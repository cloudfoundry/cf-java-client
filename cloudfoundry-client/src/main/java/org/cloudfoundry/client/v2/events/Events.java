...
public interface Events {
     ...
     */
    String APP_CRASH = "app.crash";

    /**
     * {@code audit.app.create} event type
     */
    String AUDIT_APP_CREATE = "audit.app.create";

    /**
     * {@code audit.app.delete-request} event type
     */
    String AUDIT_APP_DELETE_REQUEST = "audit.app.delete-request";

    /**
     * {@code audit.app.ssh-authorized} event type
     */
    String AUDIT_APP_SSH_AUTHORIZED = "audit.app.ssh-authorized";

    /**
     * {@code audit.app.ssh-unauthorized} event type
     */
    String AUDIT_APP_SSH_UNAUTHORIZED = "audit.app.ssh-unauthorized";

    /**
     * {@code audit.app.start} event type
     */
    String AUDIT_APP_START = "audit.app.start";

    /**
     * {@code audit.app.stop} event type
     */
    String AUDIT_APP_STOP = "audit.app.stop";
     ...
     */
    String AUDIT_SERVICE_BINDING_DELETE = "audit.service_binding.delete";

    /**
     * {@code audit.service_broker.create} event type
     */
    String AUDIT_SERVICE_BROKER_CREATE = "audit.service_broker.create";

    /**
     * {@code audit.service_broker.delete} event type
     */
    String AUDIT_SERVICE_BROKER_DELETE = "audit.service_broker.delete";
     ...
     */
    String AUDIT_SERVICE_INSTANCE_CREATE = "audit.service_instance.create";

    /**
     * {@code audit.service_instance.delete} event type
     */
    String AUDIT_SERVICE_INSTANCE_DELETE = "audit.service_instance.delete";

    /**
     * {@code audit.service_instance.update} event type
     */
    String AUDIT_SERVICE_INSTANCE_UPDATE = "audit.service_instance.update";

    /**
     * {@code audit.service_key.create} event type
     */
    String AUDIT_SERVICE_KEY_CREATE = "audit.service_key.create";

    /**
     * {@code audit.service_key.delete} event type
     */
    String AUDIT_SERVICE_KEY_DELETE = "audit.service_key.delete";

    /**
     * {@code audit.service_plan.create} event type
     */
    String AUDIT_SERVICE_PLAN_CREATE = "audit.service_plan.create";

    /**
     * {@code audit.service_plan.delete} event type
     */
    String AUDIT_SERVICE_PLAN_DELETE = "audit.service_plan.delete";

    /**
     * {@code audit.service_plan.update} event type
     */
    String AUDIT_SERVICE_PLAN_UPDATE = "audit.service_plan.update";

    /**
     * {@code audit.service_plan_visibility.create} event type
     */
    String AUDIT_SERVICE_PLAN_VISIBILITY_CREATE = "audit.service_plan_visibility.create";

    /**
     * {@code audit.service_plan_visibility.delete} event type
     */
    String AUDIT_SERVICE_PLAN_VISIBILITY_DELETE = "audit.service_plan_visibility.delete";
     ...
     */
    String AUDIT_SPACE_DELETE_REQUEST = "audit.space.delete-request";

    /**
     * {@code audit.space.update} event type
     */
    String AUDIT_SPACE_UPDATE = "audit.space.update";

    /**
     * {@code audit.user_provided_service_instance.create} event type
     */
    String AUDIT_USER_PROVIDED_SERVICE_INSTANCE_CREATE = "audit.user_provided_service_instance.create";

    /**
     * {@code audit.user_provided_service_instance.delete} event type
     */
    String AUDIT_USER_PROVIDED_SERVICE_INSTANCE_DELETE = "audit.user_provided_service_instance.delete";
