...
/**
 * The request payload for the List all Spaces for the Space Quota Definition operation
 */
@Value.Immutable
abstract class _ListSpaceQuotaDefinitionSpacesRequest extends PaginatedRequest {
