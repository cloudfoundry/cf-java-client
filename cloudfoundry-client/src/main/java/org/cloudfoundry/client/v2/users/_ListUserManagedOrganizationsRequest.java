...
/**
 * The request payload for the List all Managed Organizations for the User operation
 */
@Value.Immutable
abstract class _ListUserManagedOrganizationsRequest extends PaginatedRequest {
