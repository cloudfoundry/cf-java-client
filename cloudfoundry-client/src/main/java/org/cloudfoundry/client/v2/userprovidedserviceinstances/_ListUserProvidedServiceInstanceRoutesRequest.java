...
/**
 * The request payload for the List all Routes for the User Provided Service Instance operation
 */
@Value.Immutable
abstract class _ListUserProvidedServiceInstanceRoutesRequest extends PaginatedRequest {
