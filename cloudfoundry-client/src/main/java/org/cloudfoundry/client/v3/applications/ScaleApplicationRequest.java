...
public final class ScaleApplicationRequest implements Validatable {
     ...
     * @return {@code this}
     */
    public ScaleApplicationRequest withDiskInMb(Integer diskInMb) {
     ...
     * @return {@code this}
     */
    public ScaleApplicationRequest withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return {@code this}
     */
    public ScaleApplicationRequest withInstances(Integer instances) {
     ...
     * @return {@code this}
     */
    public ScaleApplicationRequest withMemoryInMb(Integer memoryInMb) {
     ...
     * @return {@code this}
     */
    public ScaleApplicationRequest withType(String type) {
        this.type = type;
        return this;
    }
