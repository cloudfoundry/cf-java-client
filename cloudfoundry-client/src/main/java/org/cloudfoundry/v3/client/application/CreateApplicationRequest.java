...
import org.cloudfoundry.v3.client.Validatable;
...
/**
 * The request payload for the Create Application operation.  The {@code name} and {@code spaceId} must be set for a
 * request to be valid.
 *
