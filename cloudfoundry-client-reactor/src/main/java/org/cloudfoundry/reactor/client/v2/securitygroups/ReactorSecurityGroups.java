...
public class ReactorSecurityGroups extends AbstractClientV2Operations implements SecurityGroups {
    ...
    public Mono<AssociateSecurityGroupSpaceResponse> associateSpace(AssociateSecurityGroupSpaceRequest request) {
        return put(request, AssociateSecurityGroupSpaceResponse.class,
            builder -> builder.pathSegment("security_groups", request.getSecurityGroupId(), "spaces", request.getSpaceId()))
            .checkpoint();
    }

    @Override
    public Mono<CreateSecurityGroupResponse> create(CreateSecurityGroupRequest request) {
        return post(request, CreateSecurityGroupResponse.class, builder -> builder.pathSegment("security_groups")).checkpoint();
    }

    @Override
    public Mono<DeleteSecurityGroupResponse> delete(DeleteSecurityGroupRequest request) {
        return delete(request, DeleteSecurityGroupResponse.class,
            builder -> builder.pathSegment("security_groups", request.getSecurityGroupId())).checkpoint();
    }
    ...
    public Mono<ListSecurityGroupsResponse> list(ListSecurityGroupsRequest request) {
        return get(request, ListSecurityGroupsResponse.class, builder -> builder.pathSegment("security_groups")).checkpoint();
    }

    @Override
    public Mono<ListSecurityGroupRunningDefaultsResponse> listRunningDefaults(ListSecurityGroupRunningDefaultsRequest request) {
        return get(request, ListSecurityGroupRunningDefaultsResponse.class,
            builder -> builder.pathSegment("config", "running_security_groups")).checkpoint();
    }

    @Override
    public Mono<ListSecurityGroupSpacesResponse> listSpaces(ListSecurityGroupSpacesRequest request) {
        return get(request, ListSecurityGroupSpacesResponse.class,
            builder -> builder.pathSegment("security_groups", request.getSecurityGroupId(), "spaces")).checkpoint();
    }

    @Override
    public Mono<ListSecurityGroupStagingDefaultsResponse> listStagingDefaults(ListSecurityGroupStagingDefaultsRequest request) {
        return get(request, ListSecurityGroupStagingDefaultsResponse.class,
            builder -> builder.pathSegment("config", "staging_security_groups")).checkpoint();
    }

    @Override
    public Mono<Void> removeRunningDefault(RemoveSecurityGroupRunningDefaultRequest request) {
        return delete(request, Void.class,
            builder -> builder.pathSegment("config", "running_security_groups", request.getSecurityGroupId())).checkpoint();
    }

    @Override
    public Mono<Void> removeSpace(RemoveSecurityGroupSpaceRequest request) {
        return delete(request, Void.class, builder -> builder.pathSegment("security_groups", request.getSecurityGroupId(), "spaces",
    ...
    public Mono<Void> removeStagingDefault(RemoveSecurityGroupStagingDefaultRequest request) {
        return delete(request, Void.class,
            builder -> builder.pathSegment("config", "staging_security_groups", request.getSecurityGroupId())).checkpoint();
    }
    ...
    public Mono<UpdateSecurityGroupResponse> update(UpdateSecurityGroupRequest request) {
        return put(request, UpdateSecurityGroupResponse.class,
            builder -> builder.pathSegment("security_groups", request.getSecurityGroupId())).checkpoint();
    }
