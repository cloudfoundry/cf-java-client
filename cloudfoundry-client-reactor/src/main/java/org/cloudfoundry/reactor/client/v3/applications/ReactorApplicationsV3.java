...
public final class ReactorApplicationsV3 extends AbstractClientV3Operations implements ApplicationsV3 {
    ...
    public Mono<String> delete(DeleteApplicationRequest request) {
        return delete(request, builder -> builder.pathSegment("apps", request.getApplicationId())).checkpoint();
    }
    ...
    public Mono<GetApplicationCurrentDropletResponse> getCurrentDroplet(GetApplicationCurrentDropletRequest request) {
        return get(request, GetApplicationCurrentDropletResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "droplets", "current")).checkpoint();
    }

    @Override
    public Mono<GetApplicationCurrentDropletRelationshipResponse>
    getCurrentDropletRelationship(GetApplicationCurrentDropletRelationshipRequest request) {
        return get(request, GetApplicationCurrentDropletRelationshipResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "relationships", "current_droplet")).checkpoint();
    }
    ...
    public Mono<GetApplicationEnvironmentVariablesResponse> getEnvironmentVariables(GetApplicationEnvironmentVariablesRequest request) {
        return get(request, GetApplicationEnvironmentVariablesResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "environment_variables")).checkpoint();
    }
    ...
    public Mono<GetApplicationProcessResponse> getProcess(GetApplicationProcessRequest request) {
        return get(request, GetApplicationProcessResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "processes", request.getType())).checkpoint();
    }

    @Override
    public Mono<GetApplicationProcessStatisticsResponse> getProcessStatistics(GetApplicationProcessStatisticsRequest request) {
        return get(request, GetApplicationProcessStatisticsResponse.class, builder -> builder.pathSegment("apps",
            request.getApplicationId(),
            "processes", request.getType(),
            "stats")).checkpoint();
    }
    ...
    public Mono<ListApplicationBuildsResponse> listBuilds(ListApplicationBuildsRequest request) {
        return get(request, ListApplicationBuildsResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "builds")).checkpoint();
    }
    ...
    public Mono<ListApplicationDropletsResponse> listDroplets(ListApplicationDropletsRequest request) {
        return get(request, ListApplicationDropletsResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "droplets")).checkpoint();
    }
    ...
    public Mono<ListApplicationPackagesResponse> listPackages(ListApplicationPackagesRequest request) {
        return get(request, ListApplicationPackagesResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "packages")).checkpoint();
    }
    ...
    public Mono<ListApplicationProcessesResponse> listProcesses(ListApplicationProcessesRequest request) {
        return get(request, ListApplicationProcessesResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "processes")).checkpoint();
    }

    @Override
    public Mono<ListApplicationTasksResponse> listTasks(ListApplicationTasksRequest request) {
        return get(request, ListApplicationTasksResponse.class,
    ...
    public Mono<ScaleApplicationResponse> scale(ScaleApplicationRequest request) {
        return put(request, ScaleApplicationResponse.class, builder -> builder.pathSegment("apps", request.getApplicationId(), "processes",
            request.getType(), "actions", "scale"))
            .checkpoint();
    }

    @Override
    public Mono<SetApplicationCurrentDropletResponse> setCurrentDroplet(SetApplicationCurrentDropletRequest request) {
        return patch(request, SetApplicationCurrentDropletResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "relationships", "current_droplet")).checkpoint();
    }

    @Override
    public Mono<StartApplicationResponse> start(StartApplicationRequest request) {
        return post(request, StartApplicationResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "actions", "start")).checkpoint();
    }

    @Override
    public Mono<StopApplicationResponse> stop(StopApplicationRequest request) {
        return post(request, StopApplicationResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "actions", "stop")).checkpoint();
    }

    @Override
    public Mono<Void> terminateInstance(TerminateApplicationInstanceRequest request) {
        return delete(request, Void.class, builder -> builder.pathSegment("apps", request.getApplicationId(), "processes",
            request.getType(), "instances", request.getIndex())).checkpoint();
    }
    ...
    @Override
    public Mono<UpdateApplicationEnvironmentVariablesResponse>
    updateEnvironmentVariables(UpdateApplicationEnvironmentVariablesRequest request) {
        return patch(request, UpdateApplicationEnvironmentVariablesResponse.class,
            builder -> builder.pathSegment("apps", request.getApplicationId(), "environment_variables")).checkpoint();
    }
