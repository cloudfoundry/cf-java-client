 ...
 */
public final class ReactorSpaceQuotaDefinitions extends AbstractClientV2Operations
        implements SpaceQuotaDefinitions {
     ...
     */
    public ReactorSpaceQuotaDefinitions(
    ...
    @Override
    public Mono<AssociateSpaceQuotaDefinitionResponse> associateSpace(
            AssociateSpaceQuotaDefinitionRequest request) {
        return put(
                        request,
                        AssociateSpaceQuotaDefinitionResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "space_quota_definitions",
                                        request.getSpaceQuotaDefinitionId(),
                                        "spaces",
                                        request.getSpaceId()))
                .checkpoint();
    }
    ...
    public Mono<CreateSpaceQuotaDefinitionResponse> create(
        ...
        return post(
                        ...
                        builder -> builder.pathSegment("space_quota_definitions"))
                .checkpoint();
    }

    @Override
    public Mono<DeleteSpaceQuotaDefinitionResponse> delete(
            DeleteSpaceQuotaDefinitionRequest request) {
        return delete(
                        request,
                        DeleteSpaceQuotaDefinitionResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "space_quota_definitions",
                                        request.getSpaceQuotaDefinitionId()))
    ...
    @Override
    public Mono<ListSpaceQuotaDefinitionSpacesResponse> listSpaces(
            ListSpaceQuotaDefinitionSpacesRequest request) {
        return get(
                        request,
                        ListSpaceQuotaDefinitionSpacesResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "space_quota_definitions",
                                        request.getSpaceQuotaDefinitionId(),
