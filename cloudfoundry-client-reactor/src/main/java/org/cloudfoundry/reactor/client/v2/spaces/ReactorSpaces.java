...
public final class ReactorSpaces extends AbstractClientV2Operations implements Spaces {
    ...
    @Override
    public Mono<AssociateSpaceAuditorResponse> associateAuditor(
            AssociateSpaceAuditorRequest request) {
        return put(
                        request,
                        AssociateSpaceAuditorResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces",
                                        request.getSpaceId(),
    ...
    @Override
    public Mono<AssociateSpaceAuditorByUsernameResponse> associateAuditorByUsername(
            AssociateSpaceAuditorByUsernameRequest request) {
        return put(
                        request,
                        AssociateSpaceAuditorByUsernameResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "auditors"))
                .checkpoint();
    }

    @Override
    public Mono<AssociateSpaceDeveloperResponse> associateDeveloper(
            AssociateSpaceDeveloperRequest request) {
        return put(
                        request,
                        AssociateSpaceDeveloperResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces",
                                        request.getSpaceId(),
    ...
    @Override
    public Mono<AssociateSpaceDeveloperByUsernameResponse> associateDeveloperByUsername(
            AssociateSpaceDeveloperByUsernameRequest request) {
        return put(
                        request,
                        AssociateSpaceDeveloperByUsernameResponse.class,
                        builder ->
                                builder.pathSegment("spaces", request.getSpaceId(), "developers"))
                .checkpoint();
    }

    @Override
    public Mono<AssociateSpaceManagerResponse> associateManager(
            AssociateSpaceManagerRequest request) {
        return put(
                        request,
                        AssociateSpaceManagerResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces",
                                        request.getSpaceId(),
    ...
    @Override
    public Mono<AssociateSpaceManagerByUsernameResponse> associateManagerByUsername(
            AssociateSpaceManagerByUsernameRequest request) {
        return put(
                        request,
                        AssociateSpaceManagerByUsernameResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "managers"))
                .checkpoint();
    }

    @Override
    public Mono<AssociateSpaceSecurityGroupResponse> associateSecurityGroup(
            AssociateSpaceSecurityGroupRequest request) {
        return put(
                        request,
                        AssociateSpaceSecurityGroupResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces",
                                        request.getSpaceId(),
    ...
    public Mono<GetSpaceSummaryResponse> getSummary(GetSpaceSummaryRequest request) {
        return get(
                        request,
                        GetSpaceSummaryResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "summary"))
                .checkpoint();
    }
    ...
    @Override
    public Mono<ListSpaceApplicationsResponse> listApplications(
            ListSpaceApplicationsRequest request) {
        return get(
                        request,
                        ListSpaceApplicationsResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "apps"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceAuditorsResponse> listAuditors(ListSpaceAuditorsRequest request) {
        return get(
                        request,
                        ListSpaceAuditorsResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "auditors"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceDevelopersResponse> listDevelopers(ListSpaceDevelopersRequest request) {
        return get(
                        request,
                        ListSpaceDevelopersResponse.class,
                        builder ->
                                builder.pathSegment("spaces", request.getSpaceId(), "developers"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceDomainsResponse> listDomains(ListSpaceDomainsRequest request) {
        return get(
                        request,
                        ListSpaceDomainsResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "domains"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceEventsResponse> listEvents(ListSpaceEventsRequest request) {
        return get(
                        request,
                        ListSpaceEventsResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "events"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceManagersResponse> listManagers(ListSpaceManagersRequest request) {
        return get(
                        request,
                        ListSpaceManagersResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "managers"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceRoutesResponse> listRoutes(ListSpaceRoutesRequest request) {
        return get(
                        request,
                        ListSpaceRoutesResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "routes"))
                .checkpoint();
    }

    @Override
    public Mono<ListSpaceSecurityGroupsResponse> listSecurityGroups(
            ListSpaceSecurityGroupsRequest request) {
        return get(
                        request,
                        ListSpaceSecurityGroupsResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces", request.getSpaceId(), "security_groups"))
                .checkpoint();
    }

    @Override
    public Mono<ListSpaceServiceInstancesResponse> listServiceInstances(
            ListSpaceServiceInstancesRequest request) {
        return get(
                        request,
                        ListSpaceServiceInstancesResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "spaces", request.getSpaceId(), "service_instances"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceServicesResponse> listServices(ListSpaceServicesRequest request) {
        return get(
                        request,
                        ListSpaceServicesResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "services"))
                .checkpoint();
    }
    ...
    public Mono<ListSpaceUserRolesResponse> listUserRoles(ListSpaceUserRolesRequest request) {
        return get(
                        request,
                        ListSpaceUserRolesResponse.class,
                        builder ->
                                builder.pathSegment("spaces", request.getSpaceId(), "user_roles"))
                .checkpoint();
    }
    ...
    @Override
    public Mono<RemoveSpaceAuditorByUsernameResponse> removeAuditorByUsername(
            RemoveSpaceAuditorByUsernameRequest request) {
        return delete(
                        request,
                        RemoveSpaceAuditorByUsernameResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "auditors"))
                .checkpoint();
    }
    ...
    @Override
    public Mono<RemoveSpaceDeveloperByUsernameResponse> removeDeveloperByUsername(
            RemoveSpaceDeveloperByUsernameRequest request) {
        return delete(
                        request,
                        RemoveSpaceDeveloperByUsernameResponse.class,
                        builder ->
                                builder.pathSegment("spaces", request.getSpaceId(), "developers"))
                .checkpoint();
    }
    ...
    @Override
    public Mono<RemoveSpaceManagerByUsernameResponse> removeManagerByUsername(
            RemoveSpaceManagerByUsernameRequest request) {
        return delete(
                        request,
                        RemoveSpaceManagerByUsernameResponse.class,
                        builder -> builder.pathSegment("spaces", request.getSpaceId(), "managers"))
                .checkpoint();
    }
