...
public final class ReactorTokens extends AbstractUaaOperations implements Tokens {
    ...
    public Mono<CheckTokenResponse> check(CheckTokenRequest request) {
        return post(
                        ...
                        builder -> builder.pathSegment("check_token"),
                        outbound -> {},
                        outbound -> {
                            String encoded =
                                    Base64.getEncoder()
    ...
    @Override
    public Mono<GetTokenByAuthorizationCodeResponse> getByAuthorizationCode(
            GetTokenByAuthorizationCodeRequest request) {
        return post(
                        request,
                        GetTokenByAuthorizationCodeResponse.class,
                        builder ->
                                builder.pathSegment("oauth", "token")
    ...
    @Override
    public Mono<GetTokenByClientCredentialsResponse> getByClientCredentials(
            GetTokenByClientCredentialsRequest request) {
        return post(
                        request,
                        GetTokenByClientCredentialsResponse.class,
                        builder ->
                                builder.pathSegment("oauth", "token")
    ...
    @Override
    public Mono<GetTokenByOneTimePasscodeResponse> getByOneTimePasscode(
            GetTokenByOneTimePasscodeRequest request) {
        return post(
                        request,
                        GetTokenByOneTimePasscodeResponse.class,
                        builder ->
                                builder.pathSegment("oauth", "token")
    ...
    public Mono<GetTokenByOpenIdResponse> getByOpenId(GetTokenByOpenIdRequest request) {
        return post(
                        request,
                        GetTokenByOpenIdResponse.class,
                        builder ->
                                builder.pathSegment("oauth", "token")
                                        .queryParam("grant_type", AUTHORIZATION_CODE)
    ...
    public Mono<GetTokenByPasswordResponse> getByPassword(GetTokenByPasswordRequest request) {
        return post(
                        request,
                        GetTokenByPasswordResponse.class,
                        builder ->
                                builder.pathSegment("oauth", "token")
                                        .queryParam("grant_type", PASSWORD)
                                        .queryParam("response_type", ResponseType.TOKEN),
    ...
    public Mono<ListTokenKeysResponse> listKeys(ListTokenKeysRequest request) {
        return get(
                        request,
                        ListTokenKeysResponse.class,
                        builder -> builder.pathSegment("token_keys"))
                .checkpoint();
    }
