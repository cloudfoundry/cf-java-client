...
public final class ReactorClients extends AbstractUaaOperations implements Clients {
    ...
    public Mono<BatchChangeSecretResponse> batchChangeSecret(BatchChangeSecretRequest request) {
        return post(
                        request,
                        BatchChangeSecretResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "tx", "secret"))
                .checkpoint();
    }
    ...
    public Mono<BatchCreateClientsResponse> batchCreate(BatchCreateClientsRequest request) {
        return post(
                        request,
                        BatchCreateClientsResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "tx"))
                .checkpoint();
    }
    ...
    public Mono<BatchDeleteClientsResponse> batchDelete(BatchDeleteClientsRequest request) {
        return post(
                        request,
                        BatchDeleteClientsResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "tx", "delete"))
                .checkpoint();
    }
    ...
    public Mono<BatchUpdateClientsResponse> batchUpdate(BatchUpdateClientsRequest request) {
        return put(
                        request,
                        BatchUpdateClientsResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "tx"))
                .checkpoint();
    }
    ...
    public Mono<ChangeSecretResponse> changeSecret(ChangeSecretRequest request) {
        return put(
                        request,
                        ChangeSecretResponse.class,
                        builder ->
                                builder.pathSegment(
                                        "oauth", "clients", request.getClientId(), "secret"))
                .checkpoint();
    }
    ...
    public Mono<CreateClientResponse> create(CreateClientRequest request) {
        return post(
                        ...
                        builder -> builder.pathSegment("oauth", "clients"))
                .checkpoint();
    }
    ...
    public Mono<DeleteClientResponse> delete(DeleteClientRequest request) {
        return delete(
                        request,
                        DeleteClientResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", request.getClientId()))
                .checkpoint();
    }
    ...
    public Mono<GetMetadataResponse> getMetadata(GetMetadataRequest request) {
        return get(
                        ...
                        builder ->
                                builder.pathSegment(
                                        "oauth", "clients", request.getClientId(), "meta"))
                .checkpoint();
    }
    ...
    public Mono<ListMetadatasResponse> listMetadatas(ListMetadatasRequest request) {
        return get(
                        request,
                        ListMetadatasResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "meta"))
                .checkpoint();
    }
    ...
    public Mono<MixedActionsResponse> mixedActions(MixedActionsRequest request) {
        return post(
                        request,
                        MixedActionsResponse.class,
                        builder -> builder.pathSegment("oauth", "clients", "tx", "modify"))
                .checkpoint();
    }
