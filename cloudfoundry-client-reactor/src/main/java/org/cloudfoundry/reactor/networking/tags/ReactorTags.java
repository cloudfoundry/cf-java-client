...
package org.cloudfoundry.reactor.networking.tags;

import org.cloudfoundry.networking.tags.ListTagsRequest;
import org.cloudfoundry.networking.tags.ListTagsResponse;
...
public class ReactorTags extends AbstractNetworkingOperations implements Tags {
    ...
    public Mono<ListTagsResponse> list(ListTagsRequest request) {
        return get(ListTagsResponse.class, builder -> builder.pathSegment("v1", "external", "tags"))
            .checkpoint();
    }
}
