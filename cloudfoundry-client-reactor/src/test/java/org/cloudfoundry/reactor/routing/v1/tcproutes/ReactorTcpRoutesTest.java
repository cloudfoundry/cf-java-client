...
final class ReactorTcpRoutesTest extends AbstractRoutingApiTest {
    ...
    private final ReactorTcpRoutes tcpRoutes =
            new ReactorTcpRoutes(
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .build())
                        .response(TestResponse.builder().status(OK).build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/routing/v1/tcproutes/POST_delete_request.json")
                                        .build())
                        .response(TestResponse.builder().status(OK).build())
                        .build());
    ...
    void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/v1/tcp_routes").build())
                        .response(
        ...
        this.tcpRoutes
                .list(ListTcpRoutesRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        TcpRoute.builder()
                                                ...
                                                .modificationTag(
                                                        ModificationTag.builder()
                                                                .modificationTagId(
                                                                        "cbdhb4e3-141d-4259-b0ac-99140e8998l0")
                                                                .index(10)
                                                                .build())
                                                .port(5200)
                                                .routerGroupId("xyz789")
