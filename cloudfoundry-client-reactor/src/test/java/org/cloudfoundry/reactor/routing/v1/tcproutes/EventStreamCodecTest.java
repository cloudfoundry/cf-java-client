                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/all-data.txt")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/colon-spacing.txt")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/random-colons.txt")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/three-lines.txt")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/with-comment.txt")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "org/cloudfoundry/reactor/routing/v1/tcproutes/with-event-types.txt")
                                        .build())
                        .build());
