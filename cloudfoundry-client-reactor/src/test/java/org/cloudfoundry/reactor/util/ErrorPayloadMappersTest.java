...
public final class ErrorPayloadMappersTest {
        ...
        when(this.inbound.receive())
                .thenReturn(
                        ByteBufFlux.fromPath(
                                new ClassPathResource("fixtures/invalid_error_response.json")
                                        .getFile()
                                        .toPath()));
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .containsExactly(
                                                BAD_REQUEST.code(), "Invalid Error Response"))
    ...
    public void clientV2ClientError() throws IOException {
        ...
        when(this.inbound.receive())
                .thenReturn(
                        ByteBufFlux.fromPath(
                                new ClassPathResource("fixtures/client/v2/error_response.json")
                                        .getFile()
                                        .toPath()));
        when(this.response.status()).thenReturn(BAD_REQUEST);
        HttpClientResponseWithConnection responseWithConnection =
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "CF-UnprocessableEntity(10008): The request is"
                                                    + " semantically invalid: space_guid and name"
                                                    + " unique")
                                        .extracting(
                                        ...
                                        .containsExactly(
                                                BAD_REQUEST.code(),
                                                10008,
                                                "The request is semantically invalid: space_guid"
                                                        + " and name unique",
    ...
    public void clientV3ClientError() throws IOException {
        ...
        when(this.inbound.receive())
                .thenReturn(
                        ByteBufFlux.fromPath(
                                new ClassPathResource("fixtures/client/v3/error_response.json")
                                        .getFile()
                                        .toPath()));
        when(this.response.status()).thenReturn(BAD_REQUEST);
        HttpClientResponseWithConnection responseWithConnection =
                ...
                .consumeErrorWith(
                        t -> {
                            ...
                            assertThat(((ClientV3Exception) t).getErrors())
                                    .flatExtracting(
                                            org.cloudfoundry.client.v3.Error::getCode,
    ...
    public void uaaClientError() throws IOException {
        ...
        when(this.inbound.receive())
                .thenReturn(
                        ByteBufFlux.fromPath(
                                new ClassPathResource("fixtures/uaa/error_response.json")
                                        .getFile()
                                        .toPath()));
        when(this.response.status()).thenReturn(BAD_REQUEST);
        HttpClientResponseWithConnection responseWithConnection =
