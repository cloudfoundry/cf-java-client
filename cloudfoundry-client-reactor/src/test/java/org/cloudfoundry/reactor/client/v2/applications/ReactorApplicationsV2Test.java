...
public final class ReactorApplicationsV2Test extends AbstractClientApiTest {
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path("/apps/test-application-id/routes/test-route-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/PUT_{id}_routes_{route-id}_response.json")
                                        .build())
                        .build());
                        ...
                        AssociateApplicationRouteResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/apps/638e90b6-502f-47a8-a3bf-b18fdf3fb70a")
                                ...
                                .entity(
                                        ApplicationEntity.builder()
                                                ...
                                                .eventsUrl(
                                                        "/v2/apps/638e90b6-502f-47a8-a3bf-b18fdf3fb70a/events")
                                                ...
                                                .production(false)
                                                .routesUrl(
                                                        "/v2/apps/638e90b6-502f-47a8-a3bf-b18fdf3fb70a/routes")
                                                .routeMappingsUrl(
                                                        "/v2/apps/638e90b6-502f-47a8-a3bf-b18fdf3fb70a/route_mappings")
                                                .serviceBindingsUrl(
                                                        "/v2/apps/638e90b6-502f-47a8-a3bf-b18fdf3fb70a/service_bindings")
                                                .spaceId("bc900bc3-df1f-4842-9621-e69b90207ad1")
                                                .spaceUrl(
                                                        "/v2/spaces/bc900bc3-df1f-4842-9621-e69b90207ad1")
                                                .stackId("46576b60-3d3e-42a6-bdb3-171bc2dedfc4")
                                                .stackUrl(
                                                        "/v2/stacks/46576b60-3d3e-42a6-bdb3-171bc2dedfc4")
                                                .state("STOPPED")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path("/apps/test-application-id/copy_bits")
                                        .payload(
                                                "fixtures/client/v2/apps/POST_{id}_copy_bits_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/POST_{id}_copy_bits_response.json")
                                        .build())
                        .build());
                        ...
                        CopyApplicationResponse.builder()
                                ...
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .id("c900719e-c70a-4c75-9e6a-9535f118acc3")
                                                .url(
                                                        "/v2/jobs/c900719e-c70a-4c75-9e6a-9535f118acc3")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                        ...
                        CreateApplicationResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/apps/78d1a119-2ded-405f-8675-421d8dade602")
                                                .build())
                                .entity(
                                        ApplicationEntity.builder()
                                                .console(false)
                                                ...
                                                .environmentJsons(Collections.emptyMap())
                                                .eventsUrl(
                                                        "/v2/apps/78d1a119-2ded-405f-8675-421d8dade602/events")
                                                .healthCheckType("port")
                                                .instances(1)
                                                .memory(1024)
                                                .name("docker_app")
                                                ...
                                                .production(false)
                                                .routesUrl(
                                                        "/v2/apps/78d1a119-2ded-405f-8675-421d8dade602/routes")
                                                .routeMappingsUrl(
                                                        "/v2/apps/78d1a119-2ded-405f-8675-421d8dade602/route_mappings")
                                                .serviceBindingsUrl(
                                                        "/v2/apps/78d1a119-2ded-405f-8675-421d8dade602/service_bindings")
                                                .spaceId("6ef4e580-c189-49c8-959e-4a3d021b3307")
                                                .spaceUrl(
                                                        "/v2/spaces/6ef4e580-c189-49c8-959e-4a3d021b3307")
                                                .stackId("d449ecea-669f-448a-a9e7-ec84d51e2fdb")
                                                .stackUrl(
                                                        "/v2/stacks/d449ecea-669f-448a-a9e7-ec84d51e2fdb")
                                                .state("STOPPED")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/download")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_download_response.bin")
                                        .build())
                        .build());

        this.applications
                .download(
                        DownloadApplicationRequest.builder()
                                .applicationId("test-application-id")
                                .build())
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/droplet/download")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_env_response.json")
                                        .build())
                        .build());
                        ...
                        ApplicationEnvironmentResponse.builder()
                                ...
                                .applicationEnvironmentJson(
                                        ...
                                        FluentMap.builder()
                                                ...
                                                .entry(
                                                        "application_id",
                                                        "96e63272-5da0-44b8-90a9-63d12b2692bb")
                                                .entry(
                                                        "application_version",
                                                        "86cef6fd-fb03-4f02-97ff-cc6b9d80bbf4")
                                                ...
                                                .entry(
                                                        "space_id",
                                                        "147eef57-aadb-43b0-9518-b355ab4db678")
                        ...
                        GetApplicationResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/apps/03f286bb-f17c-42b4-8dcd-b818b0b798af")
                                                .build())
                                .entity(
                                        ApplicationEntity.builder()
                                                .console(false)
                                                ...
                                                .enableSsh(true)
                                                .eventsUrl(
                                                        "/v2/apps/03f286bb-f17c-42b4-8dcd-b818b0b798af/events")
                                                .healthCheckType("port")
                                                .instances(1)
                                                .memory(1024)
                                                .name("name-751")
                                                ...
                                                .production(false)
                                                .routesUrl(
                                                        "/v2/apps/03f286bb-f17c-42b4-8dcd-b818b0b798af/routes")
                                                .routeMappingsUrl(
                                                        "/v2/apps/03f286bb-f17c-42b4-8dcd-b818b0b798af/route_mappings")
                                                .serviceBindingsUrl(
                                                        "/v2/apps/03f286bb-f17c-42b4-8dcd-b818b0b798af/service_bindings")
                                                .spaceId("b10ca4ed-fa71-4597-8567-e7dd1719c0c7")
                                                .spaceUrl(
                                                        "/v2/spaces/b10ca4ed-fa71-4597-8567-e7dd1719c0c7")
                                                .stackId("160fb300-c60e-4682-8527-8500e0318839")
                                                .stackUrl(
                                                        "/v2/stacks/160fb300-c60e-4682-8527-8500e0318839")
                                                .state("STOPPED")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/apps/6fd65993-fbd8-447c-8c04-6e4fe3ac561c/permissions")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_permissions_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/instances")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_instances_response.json")
                                        .build())
                        .build());
    ...
    public void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps?q=name%3Atest-name&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.applications
                .list(ListApplicationsRequest.builder().name("test-name").page(-1).build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .resource(
                                        ApplicationResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "3d294ed0-105c-4ccd-8f79-5605d6b7198c")
                                                                .url(
                                                                        "/v2/apps/3d294ed0-105c-4ccd-8f79-5605d6b7198c")
                                                                .createdAt("2015-07-27T22:43:20Z")
                                                                .updatedAt("2015-07-27T22:43:20Z")
                                                                .build())
                                                .entity(
                                                        ApplicationEntity.builder()
                                                                ...
                                                                .enableSsh(true)
                                                                .eventsUrl(
                                                                        "/v2/apps/3d294ed0-105c-4ccd-8f79-5605d6b7198c/events")
                                                                .healthCheckType("port")
                                                                .instances(1)
                                                                .memory(1024)
                                                                .name("name-761")
                                                                .packageState("PENDING")
                                                                .packageUpdatedAt(
                                                                        "2015-07-27T22:43:20Z")
                                                                .production(false)
                                                                .routesUrl(
                                                                        "/v2/apps/3d294ed0-105c-4ccd-8f79-5605d6b7198c/routes")
                                                                .routeMappingsUrl(
                                                                        "/v2/apps/3d294ed0-105c-4ccd-8f79-5605d6b7198c/route_mappings")
                                                                .serviceBindingsUrl(
                                                                        "/v2/apps/3d294ed0-105c-4ccd-8f79-5605d6b7198c/service_bindings")
                                                                .spaceId(
                                                                        "30d5165d-0bef-4103-97cd-72269b9d7a4c")
                                                                .spaceUrl(
                                                                        "/v2/spaces/30d5165d-0bef-4103-97cd-72269b9d7a4c")
                                                                .stackId(
                                                                        "d3476df6-534d-4140-b85b-401fa4923234")
                                                                .stackUrl(
                                                                        "/v2/stacks/d3476df6-534d-4140-b85b-401fa4923234")
                                                                .state("STOPPED")
                                                                .version(
                                                                        "3ca77d11-93e0-4a60-bab5-30f38b8a8649")
                                                                .build())
                                                .build())
                                .resource(
                                        ApplicationResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "522c5382-29e9-48aa-9db0-9f6cfa643ec1")
                                                                .url(
                                                                        "/v2/apps/522c5382-29e9-48aa-9db0-9f6cfa643ec1")
                                                                .createdAt("2015-07-27T22:43:20Z")
                                                                .updatedAt("2015-07-27T22:43:20Z")
                                                                .build())
                                                .entity(
                                                        ApplicationEntity.builder()
                                                                ...
                                                                .enableSsh(true)
                                                                .eventsUrl(
                                                                        "/v2/apps/522c5382-29e9-48aa-9db0-9f6cfa643ec1/events")
                                                                .healthCheckType("port")
                                                                .instances(1)
                                                                .memory(1024)
                                                                .name("name-766")
                                                                ...
                                                                .production(false)
                                                                .routesUrl(
                                                                        "/v2/apps/522c5382-29e9-48aa-9db0-9f6cfa643ec1/routes")
                                                                .routeMappingsUrl(
                                                                        "/v2/apps/522c5382-29e9-48aa-9db0-9f6cfa643ec1/route_mappings")
                                                                .serviceBindingsUrl(
                                                                        "/v2/apps/522c5382-29e9-48aa-9db0-9f6cfa643ec1/service_bindings")
                                                                .spaceId(
                                                                        "cf929611-97ab-4c42-93e5-9ec26e26f456")
                                                                .spaceUrl(
                                                                        "/v2/spaces/cf929611-97ab-4c42-93e5-9ec26e26f456")
                                                                .stackId(
                                                                        "14b4a0b7-7c7b-4cf2-99f0-cc3ed1473f09")
                                                                .stackUrl(
                                                                        "/v2/stacks/14b4a0b7-7c7b-4cf2-99f0-cc3ed1473f09")
                                                                .state("STOPPED")
                                                                .version(
                                                                        "cddf0ec1-acf6-48e7-831b-884972cb7ac3")
                                                                .build())
                                                .build())
                                .resource(
                                        ApplicationResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf")
                                                                .url(
                                                                        "/v2/apps/ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf")
                                                                .createdAt("2015-07-27T22:43:20Z")
                                                                .updatedAt("2015-07-27T22:43:20Z")
                                                                .build())
                                                .entity(
                                                        ApplicationEntity.builder()
                                                                ...
                                                                .enableSsh(true)
                                                                .eventsUrl(
                                                                        "/v2/apps/ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf/events")
                                                                .healthCheckType("port")
                                                                .instances(1)
                                                                .memory(1024)
                                                                .name("name-771")
                                                                ...
                                                                .production(false)
                                                                .routesUrl(
                                                                        "/v2/apps/ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf/routes")
                                                                .routeMappingsUrl(
                                                                        "/v2/apps/ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf/route_mappings")
                                                                .serviceBindingsUrl(
                                                                        "/v2/apps/ec31bfbd-ab5c-490d-8e83-3c1ea5d1bedf/service_bindings")
                                                                .spaceId(
                                                                        "e438b2bf-17d6-4265-8813-18e0ab95c029")
                                                                .spaceUrl(
                                                                        "/v2/spaces/e438b2bf-17d6-4265-8813-18e0ab95c029")
                                                                .stackId(
                                                                        "8d42ba27-60df-420e-9208-535e753b706a")
                                                                .stackUrl(
                                                                        "/v2/stacks/8d42ba27-60df-420e-9208-535e753b706a")
                                                                .state("STOPPED")
                                                                .version(
                                                                        "8e74d312-1bc9-4953-b4fe-d2613ea4972a")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/routes?page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_routes_response.json")
                                        .build())
                        .build());
                                ...
                                .resource(
                                        RouteResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "893e7d4e-2038-4253-8dd6-1e056d5b24b3")
                                                                .url(
                                                                        "/v2/routes/893e7d4e-2038-4253-8dd6-1e056d5b24b3")
                                                ...
                                                .entity(
                                                        RouteEntity.builder()
                                                                ...
                                                                .path("")
                                                                .domainId(
                                                                        "b7174cc3-c108-40a6-bc21-87da4475b759")
                                                                .spaceId(
                                                                        "ccba126a-e222-4845-82fd-5b84a805158a")
                                                                .port(0)
                                                                .domainUrl(
                                                                        "/v2/domains/b7174cc3-c108-40a6-bc21-87da4475b759")
                                                                .spaceUrl(
                                                                        "/v2/spaces/ccba126a-e222-4845-82fd-5b84a805158a")
                                                                .applicationsUrl(
                                                                        "/v2/routes/893e7d4e-2038-4253-8dd6-1e056d5b24b3/apps")
                                                                .routeMappingsUrl(
                                                                        "/v2/routes/893e7d4e-2038-4253-8dd6-1e056d5b24b3/route_mappings")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/apps/test-application-id/service_bindings?q=service_instance_guid%3Atest-instance-id&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_service_bindings_response.json")
                                        .build())
                        .build());
                                        ...
                                        ServiceBindingResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:20Z")
                                                                .id(
                                                                        "42eda707-fe4d-4eed-9b39-7cb5e665c226")
                                                                .url(
                                                                        "/v2/service_bindings/42eda707-fe4d-4eed-9b39-7cb5e665c226")
                                                                .build())
                                                .entity(
                                                        ServiceBindingEntity.builder()
                                                                .applicationId(
                                                                        "26ddc1de-3eeb-424b-82f3-f7f30a38b610")
                                                                .bindingOptions(
                                                                        Collections.emptyMap())
                                                                .serviceInstanceId(
                                                                        "650d0eb7-3b83-414a-82a0-d503d1c8eb5f")
                                                                .credential(
                                                                        "creds-key-356",
                                                                        "creds-val-356")
                                                                .gatewayName("")
                                                                .applicationUrl(
                                                                        "/v2/apps/26ddc1de-3eeb-424b-82f3-f7f30a38b610")
                                                                .serviceInstanceUrl(
                                                                        "/v2/service_instances/650d0eb7-3b83-414a-82a0-d503d1c8eb5f")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/apps/test-application-id/service_bindings/test-service-binding-id")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path("/apps/test-application-id/restage")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/POST_{id}_restage_response.json")
                                        .build())
                        .build());
                        ...
                        RestageApplicationResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/apps/2c6b3d3c-47bb-4060-be49-a56496ab57d4")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/stats")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_stats_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/apps/test-application-id/summary")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/apps/GET_{id}_summary_response.json")
                                        .build())
                        .build());
                                ...
                                .route(
                                        Route.builder()
                                                ...
                                                .domain(
                                                        Domain.builder()
                                                                .id(
                                                                        "ebddac49-b094-4ce7-8c9b-0e00b4bc7525")
                                ...
                                .service(
                                        ServiceInstance.builder()
                                                ...
                                                .servicePlan(
                                                        builder()
                                                                .id(
                                                                        "6dce1c90-929b-466c-98d1-1b856dc6e221")
                                                                .name("name-1139")
                                                                .service(
                                                                        Service.builder()
                                                                                .id(
                                                                                        "994dae37-1a53-4959-aaa6-ba85e77d35e6")
                                                                                .label("label-46")
                                                                                .build())
                                                                .build())
                                                .build())
                                .availableDomain(
                                        Domain.builder()
                                                ...
                                                .owningOrganizationId(
                                                        "48e781a9-3ccd-469c-a5cc-91bc86722924")
                                                .build())
                                .availableDomain(
                                        Domain.builder()
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/apps/test-application-id/instances/0")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());
                                ...
                                .entity(
                                        ApplicationEntity.builder()
                                                ...
                                                .dockerCredentials(
                                                        DockerCredentials.builder().build())
                                                .spaceUrl(
                                                        "/v2/spaces/701aebe5-92fd-44cf-a7e6-bc54685c32ea")
                                                .stackUrl(
                                                        "/v2/stacks/2cdc06a4-cb6e-4191-9ce8-b6bca4a16aaf")
                                                .eventsUrl(
                                                        "/v2/apps/0c71909b-3d44-49c3-b65d-13894d70972c/events")
                                                .serviceBindingsUrl(
                                                        "/v2/apps/0c71909b-3d44-49c3-b65d-13894d70972c/service_bindings")
                                                .routesUrl(
                                                        "/v2/apps/0c71909b-3d44-49c3-b65d-13894d70972c/routes")
                                                .routeMappingsUrl(
                                                        "/v2/apps/0c71909b-3d44-49c3-b65d-13894d70972c/route_mappings")
                                                .build())
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/apps/0c71909b-3d44-49c3-b65d-13894d70972c")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path("/apps/test-application-id/bits")
                                        .contents(
                                                consumer(
                                                        (headers, body) -> {
                                                            String boundary =
                        ...
                        UploadApplicationResponse.builder()
                                ...
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .id("eff6a47e-67a1-4e3b-99a5-4f9bcab7620a")
                                                .url(
                                                        "/v2/jobs/eff6a47e-67a1-4e3b-99a5-4f9bcab7620a")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path("/apps/test-application-id/droplet/upload")
                                        .contents(
                                                consumer(
                                                        (headers, body) -> {
                                                            String boundary =
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/apps/PUT_{id}_droplet_upload_response.json")
                                        .build())
                        .build());
        ...
        this.applications
                .uploadDroplet(
                        UploadApplicationDropletRequest.builder()
                                .droplet(
                                        new ClassPathResource(
                                                        "fixtures/client/v2/apps/test-droplet.tgz")
                                                .getFile()
                                                .toPath())
                                .applicationId("test-application-id")
                                .build())
                .as(StepVerifier::create)
                .expectNext(
                        UploadApplicationDropletResponse.builder()
                                .entity(
                                        JobEntity.builder()
