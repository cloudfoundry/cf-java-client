                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/service_plans/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_plans/GET_{id}_response.json")
                                        .build())
                        .build());

        this.servicePlans
                .get(GetServicePlanRequest.builder().servicePlanId("test-service-plan-id").build())
                .as(StepVerifier::create)
                .expectNext(
                        GetServicePlanResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/service_plans/f6ceb8a2-e6fc-43d5-a11b-7ced9e1b47c7")
                                                .build())
                                .entity(
                                        ServicePlanEntity.builder()
                                                ...
                                                .schemas(
                                                        Schemas.builder()
                                                                ...
                                                                .build())
                                                .serviceUrl(
                                                        "/v2/services/8ac39757-0f9d-4295-9b6f-e626f7ee3cd4")
                                                .serviceInstancesUrl(
                                                        "/v2/service_plans/f6ceb8a2-e6fc-43d5-a11b-7ced9e1b47c7/service_instances")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/service_plans?q=service_guid%3Atest-service-id&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_plans/GET_response.json")
                                        .build())
                        .build());
                                        ...
                                        ServicePlanResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:16Z")
                                                                .id(
                                                                        "956cb355-3acc-4ced-8161-a57b9b5c7943")
                                                                .url(
                                                                        "/v2/service_plans/956cb355-3acc-4ced-8161-a57b9b5c7943")
                                                                .build())
                                                .entity(
                                                        ServicePlanEntity.builder()
                                                                .name("name-464")
                                                                ...
                                                                .description("desc-54")
                                                                .serviceId(
                                                                        "83dc64ef-eb0a-454c-b3d9-c554921f3bd2")
                                                                .uniqueId(
                                                                        "49aee95b-2108-4bbb-9769-c6197f308acf")
                                                                .publiclyVisible(true)
                                                                .active(true)
                                                                .serviceUrl(
                                                                        "/v2/services/83dc64ef-eb0a-454c-b3d9-c554921f3bd2")
                                                                .serviceInstancesUrl(
                                                                        "/v2/service_plans/956cb355-3acc-4ced-8161-a57b9b5c7943/service_instances")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/service_plans/test-service-plan-id/service_instances?q=space_guid%3Atest-space-id&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_plans/GET_{id}_service_instances_response.json")
                                        .build())
                        .build());
                                        ...
                                        ServiceInstanceResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:16Z")
                                                                .id(
                                                                        "b95c56b9-f81b-4d34-9a00-a1a1ddba5f2f")
                                                                .url(
                                                                        "/v2/service_instances/b95c56b9-f81b-4d34-9a00-a1a1ddba5f2f")
                                                                .build())
                                                .entity(
                                                        ServiceInstanceEntity.builder()
                                                                ...
                                                                .credential(
                                                                        ...
                                                                        "creds-val-268")
                                                                .servicePlanId(
                                                                        "bb29926c-7482-4ae5-803c-ec99e95aa278")
                                                                .spaceId(
                                                                        "cf5812f5-bf43-40cc-88d4-d50b76d7797d")
                                                                .type("managed_service_instance")
                                                                .tags(Collections.emptyList())
                                                                .spaceUrl(
                                                                        "/v2/spaces/cf5812f5-bf43-40cc-88d4-d50b76d7797d")
                                                                .servicePlanUrl(
                                                                        "/v2/service_plans/bb29926c-7482-4ae5-803c-ec99e95aa278")
                                                                .serviceBindingsUrl(
                                                                        "/v2/service_instances/b95c56b9-f81b-4d34-9a00-a1a1ddba5f2f/service_bindings")
                                                                .serviceKeysUrl(
                                                                        "/v2/service_instances/b95c56b9-f81b-4d34-9a00-a1a1ddba5f2f/service_keys")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/service_plans/test-service-plan-id")
                                        .payload(
                                                "fixtures/client/v2/service_plans/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/service_plans/PUT_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        UpdateServicePlanResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/service_plans/195f6bd5-0aa4-4a97-9c8d-5410e5e6d4b6")
                                ...
                                .entity(
                                        ServicePlanEntity.builder()
                                                ...
                                                .active(true)
                                                .serviceUrl(
                                                        "/v2/services/42bea093-8fe5-491a-8a34-b1943dc3709a")
                                                .serviceInstancesUrl(
                                                        "/v2/service_plans/195f6bd5-0aa4-4a97-9c8d-5410e5e6d4b6/service_instances")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
