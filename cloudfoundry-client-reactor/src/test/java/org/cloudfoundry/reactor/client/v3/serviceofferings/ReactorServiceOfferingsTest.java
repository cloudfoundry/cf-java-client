...
final class ReactorServiceOfferingsTest extends AbstractClientApiTest {
    ...
    void delete() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(DELETE).path("/service_offerings/test-service-offering-id")
                .build())
    ...
    void get() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(GET).path("/service_offerings/test-service-offering-id")
                .build())
            .response(TestResponse.builder()
                .status(OK)
                .payload("fixtures/client/v3/serviceofferings/GET_{id}_response.json")
                .build())
            .build());
    ...
    void list() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(GET).path("/service_offerings")
                .build())
            .response(TestResponse.builder()
                .status(OK)
                .payload("fixtures/client/v3/serviceofferings/GET_response.json")
                .build())
            .build());
    ...
    void update() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(PATCH).path("/service_offerings/test-service-offering-id")
                .payload("fixtures/client/v3/serviceofferings/PATCH_{id}_request.json")
                .build())
            .response(TestResponse.builder()
                .status(CREATED)
                .payload("fixtures/client/v3/serviceofferings/PATCH_{id}_response.json")
                .build())
            .build());
