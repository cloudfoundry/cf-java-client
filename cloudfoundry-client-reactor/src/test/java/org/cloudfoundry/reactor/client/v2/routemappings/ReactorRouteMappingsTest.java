...
final class ReactorRouteMappingsTest extends AbstractClientApiTest {

    private final ReactorRouteMappings routeMappings =
            new ReactorRouteMappings(
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/route_mappings/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreateRouteMappingResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/route_mappings/ca9cdd28-53c4-4b8e-a7e0-1838f69b8f91")
                                                .build())
                                .entity(
                                        RouteMappingEntity.builder()
                                                .applicationId(
                                                        "d232b485-b035-4d65-9f77-6b867d859de5")
                                                .applicationPort(8888)
                                                .routeId("c041e8a3-64d0-4beb-bac8-1900e3aedd07")
                                                .applicationUrl(
                                                        "/v2/apps/d232b485-b035-4d65-9f77-6b867d859de5")
                                                .routeUrl(
                                                        "/v2/routes/c041e8a3-64d0-4beb-bac8-1900e3aedd07")
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/route_mappings/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/route_mappings/GET_{id}_response.json")
                                        .build())
                        .build());

        this.routeMappings
                .get(GetRouteMappingRequest.builder().routeMappingId("route-mapping-id").build())
                .as(StepVerifier::create)
                .expectNext(
                        GetRouteMappingResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/route_mappings/304bead7-ad5a-4f6e-a093-f2a85d30c54a")
                                                .build())
                                .entity(
                                        RouteMappingEntity.builder()
                                                .applicationId(
                                                        "65489f49-f437-431a-8f58-c118ce08d83a")
                                                .applicationPort(8888)
                                                .applicationUrl(
                                                        "/v2/apps/65489f49-f437-431a-8f58-c118ce08d83a")
                                                .routeId("c7ce0cac-f1d6-405c-83fd-c2d75513eb23")
                                                .routeUrl(
                                                        "/v2/routes/c7ce0cac-f1d6-405c-83fd-c2d75513eb23")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/route_mappings/GET_response.json")
                                        .build())
                        .build());

        this.routeMappings
                .list(ListRouteMappingsRequest.builder().page(-1).build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        RouteMappingResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2016-04-06T00:17:40Z")
                                                                .id(
                                                                        "50dedf28-08db-4cdd-9903-0d74f3b8708d")
                                                                .url(
                                                                        "/v2/route_mappings/50dedf28-08db-4cdd-9903-0d74f3b8708d")
                                                                .build())
                                                .entity(
                                                        RouteMappingEntity.builder()
                                                                .applicationId(
                                                                        "fbfe5df8-5391-4e75-966b-69fe34b7ee5d")
                                                                .applicationPort(8888)
                                                                .routeId(
                                                                        "b683ae9e-0a54-4445-a2ea-5d78d9f89266")
                                                                .applicationUrl(
                                                                        "/v2/apps/fbfe5df8-5391-4e75-966b-69fe34b7ee5d")
                                                                .routeUrl(
                                                                        "/v2/routes/b683ae9e-0a54-4445-a2ea-5d78d9f89266")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
