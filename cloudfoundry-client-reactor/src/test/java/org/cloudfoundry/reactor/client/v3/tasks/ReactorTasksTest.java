...
final class ReactorTasksTest extends AbstractClientApiTest {

    private final ReactorTasks tasks =
            new ReactorTasks(CONNECTION_CONTEXT, this.root, TOKEN_PROVIDER, Collections.emptyMap());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v3/tasks/PUT_{id}_cancel_response.json")
                                        .build())
                        .build());

        this.tasks
                .cancel(CancelTaskRequest.builder().taskId("test-id").build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/client/v3/tasks/POST_apps_{id}_tasks_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v3/tasks/POST_apps_{id}_tasks_response.json")
                                        .build())
                        .build());
    ...
    void get() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/tasks/test-id").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.tasks
                .get(GetTaskRequest.builder().taskId("test-id").build())
                .as(StepVerifier::create)
                .expectNext(
    ...
    void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/tasks").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.tasks
                .list(ListTasksRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/tasks?page=1&per_page=2")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/tasks?page=2&per_page=2")
                                                                .build())
                                                .next(
                                                        Link.builder()
                                                                .href(
