                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/POST_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/service_plan_visibilities/test-service-plan-visibility-id")
                                        .build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/service_plan_visibilities/test-service-plan-visibility-id?async=true")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/GET_{id}_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/service_plan_visibilities?q=organization_guid%3Atest-organization-id&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/GET_response.json")
                                        .build())
                        .build());
                        ...
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path(
                                                "/service_plan_visibilities/test-service-plan-visibility-id")
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/service_plan_visibilities/PUT_{id}_response.json")
                                        .build())
                        .build());
