...
final class ReactorPackagesTest extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/client/v3/packages/POST_source_guid={id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v3/packages/POST_source_guid={id}_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        CopyPackageResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/packages/44f7c078-0934-470f-9883-4fcddc5b8f13")
                                                .build())
                                .link(
                                        "upload",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/packages/44f7c078-0934-470f-9883-4fcddc5b8f13/upload")
                                                .method("POST")
                                                .build())
                                .link(
                                        "download",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/packages/44f7c078-0934-470f-9883-4fcddc5b8f13/download")
                                                .method("GET")
                                                .build())
                                .link(
                                        "app",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/apps/1d3bf0ec-5806-43c4-b64e-8364dba1086a")
                                                .build())
                                .build())
                .expectComplete()
    ...
    void delete() {
        ...
        this.packages
                .delete(DeletePackageRequest.builder().packageId("test-package-id").build())
                .as(StepVerifier::create)
                .expectNext("[guid]")
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/packages/GET_{id}_download_response.bin")
                                        .build())
                        .build());

        this.packages
                .download(DownloadPackageRequest.builder().packageId("test-package-id").build())
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/packages/GET_{id}_response.json")
                                        .build())
                        .build());

        this.packages
                .get(GetPackageRequest.builder().packageId("test-package-id").build())
                .as(StepVerifier::create)
                .expectNext(
    ...
    void list() {
        ...
        this.packages
                .list(ListPackagesRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages?types=bits%2Cdocker&page=1&per_page=2")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages?types=bits%2Cdocker&page=2&per_page=2")
                                                                .build())
                                                .build())
                                .resource(
                                        PackageResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/a57fd932-85db-483a-a27e-b00efbb3b0a4")
                                                                .build())
                                                .link(
                                                        "upload",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/a57fd932-85db-483a-a27e-b00efbb3b0a4/upload")
                                                                .method("POST")
                                                                .build())
                                                .link(
                                                        "download",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/a57fd932-85db-483a-a27e-b00efbb3b0a4/download")
                                                                .method("GET")
                                                                .build())
                                                .link(
                                                        "app",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/apps/fa3558ce-1c4d-46fc-9776-54b9c8021745")
                                                                .build())
                                                .build())
                                .resource(
                                        PackageResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/8f1f294d-cef8-4c11-9f0b-3bcdc0bd2691")
                                                                .build())
                                                .link(
                                                        "app",
                                                        Link.builder()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/packages/GET_{id}_droplets_response.json")
                                        .build())
                        .build());
                                ...
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/7b34f1cf-7e73-428a-bb5a-8a17a8058396/droplets?page=1&per_page=50")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                ...
                                .resource(
                                        DropletResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/droplets/585bc3c1-3743-497d-88b0-403ad6b56d17")
                                                                .build())
                                                .link(
                                                        "package",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/packages/8222f76a-9e09-4360-b3aa-1ed329945e93")
                                                                .build())
                                                .link(
                                                        "app",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/apps/7b34f1cf-7e73-428a-bb5a-8a17a8058397")
                                                                .build())
                                                .link(
                                                        "assign_current_droplet",
                                                        Link.builder()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v3/packages/POST_{id}_upload_response.json")
                                        .build())
                        .build());
                        ...
                        UploadPackageRequest.builder()
                                .bits(
                                        new ClassPathResource(
                                                        "fixtures/client/v3/packages/test-package.zip")
                                                .getFile()
                                                .toPath())
