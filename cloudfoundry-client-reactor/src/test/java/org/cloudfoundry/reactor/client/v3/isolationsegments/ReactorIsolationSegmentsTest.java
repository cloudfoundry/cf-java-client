...
public class ReactorIsolationSegmentsTest extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/isolation_segments/test-isolation-segment-id/relationships/organizations")
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/POST_{id}_relationships_organizations_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/POST_{id}_relationships_organizations_response.json")
                                        .build())
                        .build());
        ...
        this.isolationSegments
                .addOrganizationEntitlement(
                        AddIsolationSegmentOrganizationEntitlementRequest.builder()
                                ...
                                .data(Relationship.builder().id("org-guid-1").build())
                                .data(Relationship.builder().id("org-guid-2").build())
                                .build())
                ...
                .expectNext(
                        AddIsolationSegmentOrganizationEntitlementResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/bdeg4371-cbd3-4155-b156-dc0c2a431b4c/relationships/organizations")
                                                .build())
                                .link(
                                        "related",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/bdeg4371-cbd3-4155-b156-dc0c2a431b4c/organizations")
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/POST_response.json")
                                        .build())
                        .build());

        this.isolationSegments
                .create(CreateIsolationSegmentRequest.builder().name("my_segment").build())
                .as(StepVerifier::create)
                .expectNext(
                        CreateIsolationSegmentResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/b19f6525-cbd3-4155-b156-dc0c2a431b4c")
                                                .build())
                                .link(
                                        "organizations",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/b19f6525-cbd3-4155-b156-dc0c2a431b4c/organizations")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/GET_{id}_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/GET_response.json")
                                        .build())
                        .build());

        this.isolationSegments
                .list(ListIsolationSegmentsRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments?page=1&per_page=5")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments?page=3&per_page=5")
                                                                .build())
                                                .next(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments?page=2&per_page=5")
                                                                .build())
                                                .build())
                                .resource(
                                ...
                                .resource(
                                        IsolationSegmentResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/68d54d31-9b3a-463b-ba94-e8e4c32edbac")
                                                                .build())
                                                .link(
                                                        "organizations",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/68d54d31-9b3a-463b-ba94-e8e4c32edbac/organizations")
                                                                .build())
                                                .build())
                                .resource(
                                        IsolationSegmentResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/ecdc67c3-a71e-43ff-bddf-048930b8cd03")
                                                                .build())
                                                .link(
                                                        "organizations",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/ecdc67c3-a71e-43ff-bddf-048930b8cd03/organizations")
                                                                .build())
                                                .build())
                                .resource(
                                        IsolationSegmentResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/424c89e4-4353-46b7-9bf4-f90bd9bacac0")
                                                                .build())
                                                .link(
                                                        "organizations",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/424c89e4-4353-46b7-9bf4-f90bd9bacac0/organizations")
                                                                .build())
                                                .build())
                                .resource(
                                        IsolationSegmentResource.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/0a79fcec-a648-4eb8-a6c3-2b5be39047c7")
                                                                .build())
                                                .link(
                                                        "organizations",
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/0a79fcec-a648-4eb8-a6c3-2b5be39047c7/organizations")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
    ...
    public void listEntitledOrganizations() {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/isolation_segments/test-isolation-segment-id/organizations")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/GET_{id}_organizations_response.json")
                                        .build())
                        .build());
        ...
        this.isolationSegments
                ...
                .as(StepVerifier::create)
                .expectNext(
                        ListIsolationSegmentEntitledOrganizationsResponse.builder()
                                .pagination(
                                        Pagination.builder()
                                                .totalResults(2)
                                                .totalPages(1)
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/isolation_segments/933b4c58-120b-499a-b85d-4b6fc9e2903b/organizations?page=1&per_page=50")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/GET_{id}_relationships_organizations_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/isolation_segments/test-isolation-segment-id/relationships/spaces")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/GET_{id}_relationships_spaces_response.json")
                                        .build())
                        .build());

        this.isolationSegments
                .listSpacesRelationship(
                        ListIsolationSegmentSpacesRelationshipRequest.builder()
                                .isolationSegmentId("test-isolation-segment-id")
                                .build())
                .as(StepVerifier::create)
                .expectNext(
                        ListIsolationSegmentSpacesRelationshipResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/bdeg4371-cbd3-4155-b156-dc0c2a431b4c/relationships/spaces")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/isolation_segments/test-isolation-segment-id/relationships/organizations/test-organization-id")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/isolation_segments/test-isolation-segment-id")
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/isolation_segments/PATCH_{id}_response.json")
                                        .build())
                        .build());
