                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/GET_running_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/GET_staging_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/config/environment_variable_groups/running")
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_running_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_running_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/config/environment_variable_groups/running")
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_running_request_empty.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_running_response_empty.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/config/environment_variable_groups/staging")
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_staging_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_staging_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/config/environment_variable_groups/staging")
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_staging_request_empty.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/environment_variable_groups/PUT_staging_response_empty.json")
                                        .build())
                        .build());
