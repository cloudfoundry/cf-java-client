...
class ReactorOrganizationsV3Test extends AbstractClientApiTest {
    ...
    private final ReactorOrganizationsV3 organizations =
            new ReactorOrganizationsV3(
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PATCH)
                                        .path(
                                                "/organizations/test-organization-id/relationships/default_isolation_segment")
                                        .payload(
                                                "fixtures/client/v3/organizations/PATCH_{id}_relationships_default_isolation_segment_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/PATCH_{id}_relationships_default_isolation_segment_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        AssignOrganizationDefaultIsolationSegmentResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/organizations/d4c91047-7b29-4fda-b7f9-04033e5c9c9f/relationships/default_isolation_segment")
                                                .build())
                                .link(
                                        "related",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/isolation_segments/9d8e007c-ce52-4ea7-8a57-f2825d2c6b39")
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/POST_response.json")
                                        .build())
                        .build());

        this.organizations
                .create(CreateOrganizationRequest.builder().name("my-organization").build())
                .as(StepVerifier::create)
                .expectNext(
                        CreateOrganizationResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/organizations/24637893-3b77-489d-bb79-8466f0d88b52")
                                                .build())
                                .metadata(
                                        Metadata.builder()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_{id}_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/organizations/test-organization-id/domains/default")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_{id}_domains_default_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_{id}_relationships_default_isolation_segment_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/organizations/test-organization-id/usage_summary")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_{id}_usage_summary_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        GetOrganizationUsageSummaryResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/organizations/d4c91047-7b29-4fda-b7f9-04033e5c9c9f/usage_summary")
                                                .build())
                                .link(
                                        "organization",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/organizations/d4c91047-7b29-4fda-b7f9-04033e5c9c9f")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    ...
    void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/organizations").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/organizations/test-organization-id/domains")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/GET_{id}_domains_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/organizations/test-organization-id")
                                        .payload(
                                                "fixtures/client/v3/organizations/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/organizations/PATCH_{id}_response.json")
                                        .build())
                        .build());
