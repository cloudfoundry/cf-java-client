...
final class ReactorServicePlansTest extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/service_plans/GET_{id}_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        GetServicePlanResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/service_plans/bf7eb420-11e5-11ea-b7db-4b5d5e7976a9")
                                                .build())
                                .link(
                                        "service_offering",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/service_offerings/13c60e38-11e7-11ea-9106-33ee3c5bd4d7")
                                                .build())
                                .link(
                                        "visibility",
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/service_plans/bf7eb420-11e5-11ea-b7db-4b5d5e7976a9/visibility")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    ...
    void list() {
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/service_plans").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/service_plans/GET_response.json")
                                        .build())
                        .build());
                        ...
                        ListServicePlansResponse.builder()
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/service_plans?page=1&per_page=2")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/service_plans?page=2&per_page=2")
                                                                .build())
                                                .next(
                                                        Link.builder()
                                                                .href(
                                ...
                                .resource(
                                        ServicePlanResource.builder()
                                                ...
                                                .maintenanceInfo(MaintenanceInfo.builder().build())
                                                .brokerCatalog(
                                                        BrokerCatalog.builder()
                                                                .brokerCatalogId(
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/service_plans/20e6cd62-12bb-11ea-90d1-7bfec2c75bcd")
                                                                .build())
                                                .link(
                                                        "service_offering",
                                                        Link.builder()
                                                ...
                                                .link(
                                                        ...
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/service_plans/20e6cd62-12bb-11ea-90d1-7bfec2c75bcd/visibility")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/service_plans/test-service-plan-id")
                                        .payload(
                                                "fixtures/client/v3/service_plans/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v3/service_plans/PATCH_{id}_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/service_plans/bf7eb420-11e5-11ea-b7db-4b5d5e7976a9/visibility")
                                        .payload(
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/service_plans/POST_{id}_response_update_plan.json")
                                        .build())
                        .build());
