                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/spaces/1305ec2b-a31c-4d2e-adc8-d9b764237e96")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/security_groups/PUT_{id}_spaces_{space-id}_response.json")
                                        .build())
                        .build());
                        ...
                        AssociateSecurityGroupSpaceResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159")
                                                .build())
                                .entity(
                                        SecurityGroupEntity.builder()
                                                ...
                                                .spacesUrl(
                                                        "/v2/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/spaces")
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/security_groups/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreateSecurityGroupResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/security_groups/966e7ac0-1c1a-4ca9-8a5f-77c96576beb7")
                                                .build())
                                .entity(
                                        SecurityGroupEntity.builder()
                                                .name("my_super_sec_group")
                                                ...
                                                .stagingDefault(false)
                                                .spacesUrl(
                                                        "/v2/security_groups/966e7ac0-1c1a-4ca9-8a5f-77c96576beb7/spaces")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/security_groups/test-id")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());

        this.securityGroups
                .delete(DeleteSecurityGroupRequest.builder().securityGroupId("test-id").build())
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/security_groups/test-id?async=true")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/security_groups/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                        ...
                        DeleteSecurityGroupResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/jobs/260ba675-47b6-4094-be7a-349d58e3d36a")
                                                .build())
                                .entity(
                                        JobEntity.builder()
                                                .id("260ba675-47b6-4094-be7a-349d58e3d36a")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/config/running_security_groups/test-id")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());

        this.securityGroups
                .removeRunningDefault(
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/config/staging_security_groups/test-id")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());

        this.securityGroups
                .removeStagingDefault(
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/security_groups/GET_{id}_response.json")
                                        .build())
                        .build());
                                ...
                                .entity(
                                        SecurityGroupEntity.builder()
                                                ...
                                                .spacesUrl(
                                                        "/v2/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/spaces")
                                                .stagingSpacesUrl(
                                                        "/v2/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/staging_spaces")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/security_groups/GET_security_groups_response.json")
                                        .build())
                        .build());
                                ...
                                .resource(
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "1452e164-0c3e-4a6c-b3c3-c40ad9fd0159")
                                                                .url(
                                                                        "/v2/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159")
                                                                .createdAt("2016-06-08T16:41:21Z")
                                                                .build())
                                ...
                                .resource(
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "61a3df25-f372-4554-9b77-811aaa5374c1")
                                                                .url(
                                                                        "/v2/security_groups/61a3df25-f372-4554-9b77-811aaa5374c1")
                                                                .createdAt("2016-06-08T16:41:21Z")
                                                                .build())
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                ...
                                                                .stagingDefault(false)
                                                                .spacesUrl(
                                                                        "/v2/security_groups/61a3df25-f372-4554-9b77-811aaa5374c1/spaces")
                                                                .build())
                                                .build())
                                .resource(
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "26bdad19-b077-4542-aac0-f7e4c53c344d")
                                                                .url(
                                                                        "/v2/security_groups/26bdad19-b077-4542-aac0-f7e4c53c344d")
                                                ...
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                ...
                                                                .stagingDefault(false)
                                                                .spacesUrl(
                                                                        "/v2/security_groups/26bdad19-b077-4542-aac0-f7e4c53c344d/spaces")
                                                                .build())
                                                .build())
                                .resource(
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "0a2b8908-66f5-4bef-80f3-ca21ed86fbb3")
                                                                .url(
                                                                        "/v2/security_groups/0a2b8908-66f5-4bef-80f3-ca21ed86fbb3")
                                                                .createdAt("2016-06-08T16:41:22Z")
                                                                .build())
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                ...
                                                                .stagingDefault(false)
                                                                .spacesUrl(
                                                                        "/v2/security_groups/0a2b8908-66f5-4bef-80f3-ca21ed86fbb3/spaces")
                                                                .build())
                                                .build())
                                .resource(
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "f5b93b76-cd25-4fed-bed6-0d9d0acff542")
                                                                .url(
                                                                        "/v2/security_groups/f5b93b76-cd25-4fed-bed6-0d9d0acff542")
                                                                .createdAt("2016-06-08T16:41:22Z")
                                                                .build())
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                ...
                                                                .stagingDefault(false)
                                                                .spacesUrl(
                                                                        "/v2/security_groups/f5b93b76-cd25-4fed-bed6-0d9d0acff542/spaces")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/config/running_security_groups")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/config/GET_running_security_groups_response.json")
                                        .build())
                        .build());

        this.securityGroups
                .listRunningDefaults(ListSecurityGroupRunningDefaultsRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                ...
                                                                .id(
                                                                        "1f2f24f8-f68c-4a3b-b51a-8134fe2626d8")
                                                                .url(
                                                                        "/v2/config/running_security_groups/1f2f24f8-f68c-4a3b-b51a-8134fe2626d8")
                                                                .build())
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                .name("name-114")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/spaces?space_guid=09a060b2-f97a-4a57-b7d2-35e06ad71050")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/config/GET_{id}_spaces_response.json")
                                        .build())
                        .build());
                                        ...
                                        SpaceResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2016-06-08T16:41:21Z")
                                                                .id(
                                                                        "3435dd59-f289-4191-83e6-6201d6fb6a22")
                                                                .updatedAt("2016-06-08T16:41:26Z")
                                                                .url(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22")
                                                                .build())
                                                .entity(
                                                        SpaceEntity.builder()
                                                                .allowSsh(true)
                                                                .applicationEventsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/app_events")
                                                                .applicationsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/apps")
                                                                .auditorsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/auditors")
                                                                .developersUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/developers")
                                                                .domainsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/domains")
                                                                .eventsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/events")
                                                                .managersUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/managers")
                                                                .name("name-40")
                                                                .organizationId(
                                                                        "1d1dd3f4-36bd-4380-8d01-3c7a934a9281")
                                                                .organizationUrl(
                                                                        "/v2/organizations/1d1dd3f4-36bd-4380-8d01-3c7a934a9281")
                                                                .routesUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/routes")
                                                                .securityGroupsUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/security_groups")
                                                                .serviceInstancesUrl(
                                                                        "/v2/spaces/3435dd59-f289-4191-83e6-6201d6fb6a22/service_instances")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/config/staging_security_groups")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/config/GET_staging_security_groups_response.json")
                                        .build())
                        .build());

        this.securityGroups
                .listStagingDefaults(ListSecurityGroupStagingDefaultsRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        SecurityGroupResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                ...
                                                                .id(
                                                                        "c0bb3afb-ae01-4af0-96cf-a5b0d2dca894")
                                                                .url(
                                                                        "/v2/config/staging_security_groups/c0bb3afb-ae01-4af0-96cf-a5b0d2dca894")
                                                                .build())
                                                .entity(
                                                        SecurityGroupEntity.builder()
                                                                .name("name-570")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159/spaces/ca8f04d1-bc2b-40ef-975e-fda2cc785c2a")
                                        .build())
                        .response(TestResponse.builder().status(NO_CONTENT).build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/config/running_security_groups/test-security-group-default-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/config/PUT_{id}_running_security_groups_response.json")
                                        .build())
                        .build());

        this.securityGroups
                .setRunningDefault(
                        SetSecurityGroupRunningDefaultRequest.builder()
                        ...
                        SetSecurityGroupRunningDefaultResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/config/running_security_groups/9aa7ab9c-997f-4f87-be50-87105521881a")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/config/staging_security_groups/test-security-group-default-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/config/PUT_{id}_staging_security_groups_response.json")
                                        .build())
                        .build());
                        ...
                        SetSecurityGroupStagingDefaultResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/config/staging_security_groups/50165fce-6c41-4c35-a4d8-3858ee217d36")
                        ...
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path(
                                                "/security_groups/1452e164-0c3e-4a6c-b3c3-c40ad9fd0159")
                                        .payload(
                                                "fixtures/client/v2/security_groups/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/security_groups/PUT_{id}_response.json")
                                        .build())
                        .build());
