...
public final class ReactorPrivateDomainsTest extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/client/v2/private_domains/POST_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/private_domains/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreatePrivateDomainResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/private_domains/4af3234e-813d-453f-b3ae-fcdecfd87a47")
                                ...
                                .entity(
                                        PrivateDomainEntity.builder()
                                                ...
                                                .owningOrganizationId(
                                                        "22bb8ae1-6324-40eb-b077-bd1bfad773f8")
                                                .owningOrganizationUrl(
                                                        "/v2/organizations/22bb8ae1-6324-40eb-b077-bd1bfad773f8")
                                                .sharedOrganizationsUrl(
                                                        "/v2/private_domains/4af3234e-813d-453f-b3ae-fcdecfd87a47/shared_organizations")
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/private_domains/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/private_domains/GET_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        GetPrivateDomainResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/private_domains/3de9db5f-8e3b-4d10-a8c9-8137caafe43d")
                                ...
                                .entity(
                                        PrivateDomainEntity.builder()
                                                .name("my-domain.com")
                                                .owningOrganizationId(
                                                        "2f70efed-abb2-4b7a-9f31-d4fe4d849932")
                                                .owningOrganizationUrl(
                                                        "/v2/organizations/2f70efed-abb2-4b7a-9f31-d4fe4d849932")
                                                .sharedOrganizationsUrl(
                                                        "/v2/private_domains/3de9db5f-8e3b-4d10-a8c9-8137caafe43d/shared_organizations")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/private_domains?q=name%3Atest-name.com&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/private_domains/GET_response.json")
                                        .build())
                        .build());

        this.privateDomains
                .list(ListPrivateDomainsRequest.builder().name("test-name.com").page(-1).build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .resource(
                                        PrivateDomainResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "3de9db5f-8e3b-4d10-a8c9-8137caafe43d")
                                                                .url(
                                                                        "/v2/private_domains/3de9db5f-8e3b-4d10-a8c9-8137caafe43d")
                                                                .createdAt("2016-02-19T02:04:00Z")
                                                                .build())
    ...
    public void listSharedOrganizations() {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/private_domains/b2a35f0c-d5ad-4a59-bea7-461711d96b0d/shared_organizations")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/private_domains/GET_{id}_shared_organizations_response.json")
                                        .build())
                        .build());
        ...
        this.privateDomains
                ...
                .as(StepVerifier::create)
                .expectNext(
                        ListPrivateDomainSharedOrganizationsResponse.builder()
                                .totalResults(1)
                                .totalPages(1)
                                .resource(
                                        OrganizationResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "420bb3ef-6064-42ed-9131-c1fe980bf9c6")
                                                                .createdAt("2016-06-08T16:41:39Z")
                                                                .updatedAt("2016-06-08T16:41:26Z")
                                                                .url(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6")
                                                                .build())
                                                .entity(
                                                        OrganizationEntity.builder()
                                                                ...
                                                                .status("active")
                                                                .quotaDefinitionUrl(
                                                                        "/v2/quota_definitions/2e863ad3-7bb9-4c5c-928c-cde2caec341b")
                                                                .spacesUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/spaces")
                                                                .domainsUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/domains")
                                                                .privateDomainsUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/private_domains")
                                                                .usersUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/users")
                                                                .managersUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/managers")
                                                                .billingManagersUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/billing_managers")
                                                                .auditorsUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/auditors")
                                                                .applicationEventsUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/app_events")
                                                                .spaceQuotaDefinitionsUrl(
                                                                        "/v2/organizations/420bb3ef-6064-42ed-9131-c1fe980bf9c6/space_quota_definitions")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
