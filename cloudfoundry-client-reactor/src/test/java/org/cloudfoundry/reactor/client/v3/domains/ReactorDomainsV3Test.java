...
public final class ReactorDomainsV3Test extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/domains/GET_{id}_response.json")
                                        .build())
                        .build());
    ...
    public void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/domains").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/domains/test-domain-id/relationships/shared_organizations")
                                        .payload(
                                                "fixtures/client/v3/domains/POST_{id}_relationships_shared_organizations_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/domains/POST_{id}_relationships_shared_organizations_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/domains/test-domain-id/relationships/shared_organizations/test-org-id")
                                        .build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/domains/test-domain-id")
                                        .payload(
                                                "fixtures/client/v3/domains/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/domains/PATCH_{id}_response.json")
                                        .build())
                        .build());
