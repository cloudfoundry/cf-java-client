...
class ReactorStacksV3Test extends AbstractClientApiTest {
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/stacks/11c916c9-c2f9-440e-8e73-102e79c4704d")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
    ...
    void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/stacks").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/stacks/test-stack-id")
                                        .payload(
                                                "fixtures/client/v3/stacks/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/stacks/PATCH_{id}_response.json")
                                        .build())
                        .build());
