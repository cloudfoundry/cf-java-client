...
public final class ReactorApplicationsV3Test extends AbstractClientApiTest {
    ...
    public void assignDroplet() {
        ...
        this.applications
            .assignDroplet(AssignApplicationDropletRequest.builder()
    ...
    public void cancelTask() {
        ...
        this.applications
            .cancelTask(CancelApplicationTaskRequest.builder()
                .applicationId("test-application-id")
                .taskId("test-task-id")
                .build())
            .as(StepVerifier::create)
    ...
    @Test
    public void getApplicationProcessStatistics() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
    ...
    public void getTask() {
        ...
        this.applications
            .getTask(GetApplicationTaskRequest.builder()
                .applicationId("test-application-id")
                .taskId("test-task-id")
                .build())
            .as(StepVerifier::create)
