                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        ...
                                        .header(
                                                "Location",
                                                "https://api.example.org/v3/jobs/test-route-id")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/routes/cbad697f-cac1-48f4-9017-ac08f39dfb31")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path("/routes/test-route-id/destinations")
                                        .payload(
                                                "fixtures/client/v3/routes/POST_{id}_destinations_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/routes/POST_{id}_destinations_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/routes/GET_{id}_destinations_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/routes/test-route-id/destinations/test-destination-id")
                                        .build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/routes/test-route-id/destinations")
                                        .payload(
                                                "fixtures/client/v3/routes/PATCH_{id}_destinations_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/routes/PATCH_{id}_destinations_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/routes/cbad697f-cac1-48f4-9017-ac08f39dfb31")
                                        .payload(
                                                "fixtures/client/v3/routes/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/routes/PATCH_{id}_response.json")
                                        .build())
                        .build());
