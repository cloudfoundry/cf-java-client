...
public final class ReactorServiceBindingsV2Test extends AbstractClientApiTest {
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/service_bindings/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreateServiceBindingRequest.builder()
                                ...
                                .parameters(
                                        Collections.singletonMap(
                                                "the_service_broker", (Object) "wants this object"))
                                .build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/service_bindings/test-service-binding-id?async=true")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/service_bindings/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                        ...
                        DeleteServiceBindingResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/jobs/c4faac01-5bbd-494f-8849-256a3bab06b8")
                                                .build())
                                .entity(
                                        JobEntity.builder()
                                                .id("c4faac01-5bbd-494f-8849-256a3bab06b8")
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_bindings/GET_{id}_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        GetServiceBindingResponse.builder()
                                ...
                                .entity(
                                        ServiceBindingEntity.builder()
                                                .applicationId(
                                                        "784bca1b-c4d9-4d99-9961-9f413620031a")
                                                .applicationUrl(
                                                        "/v2/apps/784bca1b-c4d9-4d99-9961-9f413620031a")
                                                .bindingOptions(Collections.emptyMap())
                                                ...
                                                .lastOperation(
                                                        LastOperation.builder()
                                                                ...
                                                                .build())
                                                .name("prod-db")
                                                .serviceBindingParametersUrl(
                                                        "/v2/service_bindings/ddd7fb26-c42d-4acf-a035-60fdd094a167/parameters")
                                                .serviceInstanceId(
                                                        "ada8700c-dd02-467c-937b-32ce498302f6")
                                                .serviceInstanceUrl(
                                                        "/v2/service_instances/ada8700c-dd02-467c-937b-32ce498302f6")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    ...
    public void getParameters() {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/service_bindings/test-service-binding-id/parameters")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_bindings/GET_{id}_parameters_response.json")
                                        .build())
                        .build());
        ...
        this.serviceBindings
                ...
                .as(StepVerifier::create)
                .expectNext(
                        GetServiceBindingParametersResponse.builder()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/service_bindings?q=app_guid%3Add44fd4f-5e20-4c52-b66d-7af6e201f01e&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_bindings/GET_response.json")
                                        .build())
                        .build());
                                        ...
                                        ServiceBindingResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                ...
                                                                .id(
                                                                        "d6d87c3d-a38f-4b31-9bbe-2432d2faaa1d")
                                                                .url(
                                                                        "/v2/service_bindings/d6d87c3d-a38f-4b31-9bbe-2432d2faaa1d")
                                                                .build())
                                                .entity(
                                                        ServiceBindingEntity.builder()
                                                                .applicationId(
                                                                        "dd44fd4f-5e20-4c52-b66d-7af6e201f01e")
                                                                .serviceInstanceId(
                                                                        "bbd1f170-bb1f-481d-bcf7-def2bbe6a3a2")
                                                                .bindingOptions(
                                                                ...
                                                                .gatewayName("")
                                                                .applicationUrl(
                                                                        "/v2/apps/dd44fd4f-5e20-4c52-b66d-7af6e201f01e")
                                                                .serviceInstanceUrl(
                                                                        "/v2/service_instances/bbd1f170-bb1f-481d-bcf7-def2bbe6a3a2")
                                                                .build())
                                                .build())
                                .resource(
                                        ServiceBindingResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                ...
                                                                .id(
                                                                        "925d8848-4808-47cf-a3e8-049aa0163328")
                                                                .updatedAt("2015-11-04T12:54:50Z")
                                                                .url(
                                                                        "/v2/service_bindings/925d8848-4808-47cf-a3e8-049aa0163328")
                                                                .build())
                                                .entity(
                                                        ServiceBindingEntity.builder()
                                                                .applicationId(
                                                                        "dd44fd4f-5e20-4c52-b66d-7af6e201f01e")
                                                                .serviceInstanceId(
                                                                        "f99b3d23-55f9-48b5-add3-d7ab08b2ff0c")
                                                                .bindingOptions(
                                                                        Collections.emptyMap())
                                                                .credential(
                                                                        "creds-key-108",
                                                                ...
                                                                .applicationUrl(
                                                                        "/v2/apps/dd44fd4f-5e20-4c52-b66d-7af6e201f01e")
                                                                .serviceInstanceUrl(
                                                                        "/v2/service_instances/f99b3d23-55f9-48b5-add3-d7ab08b2ff0c")
                                                                .build())
                                                .build())
                                .resource(
                                        ServiceBindingResource.builder()
