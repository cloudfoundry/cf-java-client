...
public class ReactorAuditEventsV3Test extends AbstractClientApiTest {
    ...
    private final ReactorAuditEventsV3 events =
            new ReactorAuditEventsV3(
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/audit_events/a595fe2f-01ff-4965-a50c-290258ab8582")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/auditevents/GET_{id}_response.json")
                                        .build())
                        .build());
                ...
                .expectNext(
                        GetAuditEventResponse.builder()
                                ...
                                .link(
                                        ...
                                        Link.builder()
                                                .href(
                                                        "https://api.example.org/v3/audit_events/a595fe2f-01ff-4965-a50c-290258ab8582")
                                                .build())
                                .build())
                .expectComplete()
    ...
    public void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(TestRequest.builder().method(GET).path("/audit_events").build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.events
                .list(ListAuditEventsRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .pagination(
                                        Pagination.builder()
                                                ...
                                                .first(
                                                        Link.builder()
                                                                .href(
                                                                        "https://api.example.org/v3/audit_events?page=1&per_page=2")
                                                                .build())
                                                .last(
                                                        Link.builder()
                                                                .href(
                                ...
                                .resource(
                                        AuditEventResource.builder()
                                                ...
                                                .auditEventActor(
                                                        AuditEventActor.builder()
                                                                .id(
                                                                        "d144abe3-3d7b-40d4-b63f-2584798d3ee5")
                                                                .name("admin")
                                                                .type("user")
                                                                .build())
                                                .auditEventTarget(
                                                        AuditEventTarget.builder()
                                                                .id(
                                                                        "2e3151ba-9a63-4345-9c5b-6d8c238f4e55")
                                                                .name("my-app")
                                                                .type("app")
                                                                .build())
                                                .data(
                                                ...
                                                .spaceRelationship(
                                                        Relationship.builder()
                                                                .id(
                                                                        "cb97dd25-d4f7-4185-9e6f-ad6e585c207c")
                                                                .build())
                                                .organizationRelationship(
                                                        Relationship.builder()
                                                                .id(
                                                                        "d9be96f5-ea8f-4549-923f-bec882e32e3c")
                                                                .build())
                                                .link(
                                                        "self",
                                                        Link.builder()
