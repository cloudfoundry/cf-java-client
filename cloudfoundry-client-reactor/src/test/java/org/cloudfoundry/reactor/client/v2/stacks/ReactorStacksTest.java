...
final class ReactorStacksTest extends AbstractClientApiTest {

    private final ReactorStacks stacks =
            new ReactorStacks(
                        ...
                        CreateStackResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/stacks/c7d0b591-2572-4d23-bf7c-9dac95074a9e")
                                                .build())
                                .entity(
                                        StackEntity.builder()
                                                .description("Description for the example stack")
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/stacks/DELETE_{id}_async_response.json")
                                        .build())
                        .build());

        this.stacks
                .delete(DeleteStackRequest.builder().async(true).stackId("test-stack-id").build())
                .as(StepVerifier::create)
                .expectNext(
    ...
    void get() {
        ...
        this.stacks
                .get(GetStackRequest.builder().stackId("test-stack-id").build())
                .as(StepVerifier::create)
                .expectNext(
                        GetStackResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/stacks/fe4999cf-a207-4d40-bb03-f4bbf697edac")
    ...
    void list() {
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/stacks?q=name%3Atest-name&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.stacks
                .list(ListStacksRequest.builder().name("test-name").page(-1).build())
                .as(StepVerifier::create)
                .expectNext(
                                ...
                                .resource(
                                        StackResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "fe4999cf-a207-4d40-bb03-f4bbf697edac")
                                                                .url(
                                                                        "/v2/stacks/fe4999cf-a207-4d40-bb03-f4bbf697edac")
                                                                .createdAt("2015-12-22T18:27:59Z")
                                                                .build())
                                ...
                                .resource(
                                        StackResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "ff0f87c9-9add-477a-8674-c11c012667a6")
                                                                .url(
                                                                        "/v2/stacks/ff0f87c9-9add-477a-8674-c11c012667a6")
                                                                .createdAt("2015-12-22T18:27:59Z")
                                                                .build())
                                                .entity(
                                                        StackEntity.builder()
                                ...
                                .resource(
                                        StackResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "01bd93b4-f252-4517-a4a5-191eb4c7fc7e")
                                                                .url(
                                                                        "/v2/stacks/01bd93b4-f252-4517-a4a5-191eb4c7fc7e")
                                                                .createdAt("2015-12-22T18:27:59Z")
                                                                .build())
                                                .entity(
                                                        StackEntity.builder()
