                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/space_quota_definitions/test-space-quota-definition-id/spaces/test-space-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/PUT_{id}_spaces_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        AssociateSpaceQuotaDefinitionResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/space_quota_definitions/ea82f16c-c21a-4a8a-947a-f7606e7f63fa")
                                ...
                                .entity(
                                        SpaceQuotaDefinitionEntity.builder()
                                                .name("name-1887")
                                                .organizationId(
                                                        "e188543a-cb71-4786-8703-9addbebc5bbf")
                                                ...
                                                .organizationUrl(
                                                        "/v2/organizations/e188543a-cb71-4786-8703-9addbebc5bbf")
                                                .spacesUrl(
                                                        "/v2/space_quota_definitions/ea82f16c-c21a-4a8a-947a-f7606e7f63fa/spaces")
                                                .build())
                                .build())
                .expectComplete()
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path("/space_quota_definitions")
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/POST_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreateSpaceQuotaDefinitionResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/space_quota_definitions/17f055b8-b4c8-47cf-8737-0220d5706b4a")
                                ...
                                .entity(
                                        SpaceQuotaDefinitionEntity.builder()
                                                .name("gold_quota")
                                                .organizationId(
                                                        "c9b4ac17-ab4b-4368-b3e2-5cbf09b17a24")
                                                .nonBasicServicesAllowed(true)
                                                .totalServices(-1)
                                                .totalRoutes(10)
                                                .memoryLimit(5120)
                                                ...
                                                .totalReservedRoutePorts(5)
                                                .organizationUrl(
                                                        "/v2/organizations/c9b4ac17-ab4b-4368-b3e2-5cbf09b17a24")
                                                .spacesUrl(
                                                        "/v2/space_quota_definitions/17f055b8-b4c8-47cf-8737-0220d5706b4a/spaces")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/space_quota_definitions/test-space-quota-definition-id")
                                        .build())
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/space_quota_definitions/test-space-quota-definition-id?async=true")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/DELETE_{id}_async_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/GET_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        GetSpaceQuotaDefinitionResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/space_quota_definitions/4b8e7d14-71bd-4abb-b474-183375c75c84")
                                                .createdAt("2015-11-30T23:38:46Z")
                                                .build())
                                .entity(
                                        SpaceQuotaDefinitionEntity.builder()
                                                .name("name-1892")
                                                .organizationId(
                                                        "0dbbac8c-16ac-4ba5-8f59-3d3a79874f5d")
                                                .nonBasicServicesAllowed(true)
                                                .totalServices(60)
                                                .totalRoutes(1000)
                                                .memoryLimit(20480)
                                                ...
                                                .applicationInstanceLimit(-1)
                                                .organizationUrl(
                                                        "/v2/organizations/0dbbac8c-16ac-4ba5-8f59-3d3a79874f5d")
                                                .spacesUrl(
                                                        "/v2/space_quota_definitions/4b8e7d14-71bd-4abb-b474-183375c75c84/spaces")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/space_quota_definitions?page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/GET_response.json")
                                        .build())
                        .build());
                                ...
                                .resource(
                                        SpaceQuotaDefinitionResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .id(
                                                                        "be2d5c01-3413-43db-bea2-49b0b60ec74d")
                                                                .url(
                                                                        "/v2/space_quota_definitions/be2d5c01-3413-43db-bea2-49b0b60ec74d")
                                                ...
                                                .entity(
                                                        SpaceQuotaDefinitionEntity.builder()
                                                                .name("name-2236")
                                                                .organizationId(
                                                                        "a81d5218-b473-474e-9afb-3223a8b2ae9f")
                                                                .nonBasicServicesAllowed(true)
                                                                .totalServices(60)
                                                                .totalRoutes(1000)
                                                                .memoryLimit(20480)
                                                                .instanceMemoryLimit(-1)
                                                                .organizationUrl(
                                                                        "/v2/organizations/a81d5218-b473-474e-9afb-3223a8b2ae9f")
                                                                .spacesUrl(
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/space_quota_definitions/e37cdd97-af56-4417-a99d-060093057275/spaces")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/GET_{id}_spaces_response.json")
                                        .build())
                        .build());
                                        ...
                                        SpaceResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2016-06-08T16:41:29Z")
                                                                .id(
                                                                        "a1f21571-07a6-42df-b9c0-501b97fac05b")
                                                                .updatedAt("2016-06-08T16:41:29Z")
                                                                .url(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b")
                                                                .build())
                                                .entity(
                                                        SpaceEntity.builder()
                                                                .name("name-1473")
                                                                .organizationId(
                                                                        "e0878e36-e2f3-4290-b7c6-50f825ce6c77")
                                                                .organizationUrl(
                                                                        "/v2/organizations/e0878e36-e2f3-4290-b7c6-50f825ce6c77")
                                                                .spaceQuotaDefinitionId(
                                                                        "e37cdd97-af56-4417-a99d-060093057275")
                                                                .spaceQuotaDefinitionUrl(
                                                                        "/v2/space_quota_definitions/e37cdd97-af56-4417-a99d-060093057275")
                                                                .allowSsh(true)
                                                                .developersUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/developers")
                                                                .managersUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/managers")
                                                                .auditorsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/auditors")
                                                                .applicationsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/apps")
                                                                .routesUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/routes")
                                                                .domainsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/domains")
                                                                .serviceInstancesUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/service_instances")
                                                                .applicationEventsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/app_events")
                                                                .eventsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/events")
                                                                .securityGroupsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/security_groups")
                                                                .stagingSecurityGroupsUrl(
                                                                        "/v2/spaces/a1f21571-07a6-42df-b9c0-501b97fac05b/staging_security_groups")
                                                                .build())
                                                .build())
                                .build())
                .expectComplete()
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/space_quota_definitions/bbd837ac-309d-4f53-9d49-67cb75364904")
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/space_quota_definitions/PUT_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        UpdateSpaceQuotaDefinitionResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .updatedAt("2016-06-08T16:41:29Z")
                                                .url(
                                                        "/v2/space_quota_definitions/bbd837ac-309d-4f53-9d49-67cb75364904")
                                                .build())
                                .entity(
                                        SpaceQuotaDefinitionEntity.builder()
                                                .applicationInstanceLimit(-1)
                                                ...
                                                .nonBasicServicesAllowed(true)
                                                .organizationId(
                                                        "dbd76462-6fec-4add-aaca-35b2ca7493bb")
                                                .organizationUrl(
                                                        "/v2/organizations/dbd76462-6fec-4add-aaca-35b2ca7493bb")
                                                .spacesUrl(
                                                        "/v2/space_quota_definitions/bbd837ac-309d-4f53-9d49-67cb75364904/spaces")
