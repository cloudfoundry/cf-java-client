...
final class ReactorServiceBrokersTest extends AbstractClientApiTest {

    private final ReactorServiceBrokers serviceBrokers =
            new ReactorServiceBrokers(
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/client/v2/service_brokers/POST_response.json")
                                        .build())
                        .build());
                        ...
                        CreateServiceBrokerResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/service_brokers/1e86a649-e4a2-4bed-830d-b12435ed4cd9")
                                                .build())
                                .entity(
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_brokers/GET_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        GetServiceBrokerResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .url(
                                                        "/v2/service_brokers/1311f77f-cfb6-499e-bcba-82c7ef968ae6")
                                                .build())
                                .entity(
                                        ServiceBrokerEntity.builder()
                                                .name("name-974")
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/service_brokers?q=name%3Atest-name&page=-1")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_brokers/GET_response.json")
                                        .build())
                        .build());

        this.serviceBrokers
                .list(ListServiceBrokersRequest.builder().name("test-name").page(-1).build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        ServiceBrokerResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:23Z")
                                                                .id(
                                                                        "b52de6f1-15dd-4069-8b42-f052cc9333fc")
                                                                .updatedAt("2015-07-27T22:43:23Z")
                                                                .url(
                                                                        "/v2/service_brokers/b52de6f1-15dd-4069-8b42-f052cc9333fc")
                                                                .build())
                                                .entity(
                                                        ServiceBrokerEntity.builder()
                                                                .name("name-980")
                                                                ...
                                                                .authenticationUsername(
                                                                        "auth_username-39")
                                                                .spaceId(
                                                                        "4f34c35e-be0d-409e-9279-1ccd7058c5d8")
                                                                .build())
                                                .build())
                                .resource(
                                        ServiceBrokerResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:23Z")
                                                                .id(
                                                                        "812e9e7f-b5b0-4587-ba3c-b4a7c574fb88")
                                                                .url(
                                                                        "/v2/service_brokers/812e9e7f-b5b0-4587-ba3c-b4a7c574fb88")
                                                                .build())
                                                .entity(
                                                        ServiceBrokerEntity.builder()
                                                                .name("name-981")
                                        ...
                                        ServiceBrokerResource.builder()
                                                .metadata(
                                                        Metadata.builder()
                                                                .createdAt("2015-07-27T22:43:23Z")
                                                                .id(
                                                                        "93e760c4-ff3d-447a-9cff-a17f4454eaee")
                                                                .url(
                                                                        "/v2/service_brokers/93e760c4-ff3d-447a-9cff-a17f4454eaee")
                                                                .build())
                                                .entity(
                                                        ServiceBrokerEntity.builder()
                                                                .name("name-982")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/service_brokers/test-service-broker-id")
                                        .payload(
                                                "fixtures/client/v2/service_brokers/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v2/service_brokers/PUT_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        UpdateServiceBrokerResponse.builder()
                                .metadata(
                                        Metadata.builder()
                                                ...
                                                .updatedAt("2015-07-27T22:43:23Z")
                                                .url(
                                                        "/v2/service_brokers/92b935f5-20e2-4377-a7e2-f15faa110eab")
                                                .build())
                                .entity(
                                        ServiceBrokerEntity.builder()
                                                .name("name-998")
