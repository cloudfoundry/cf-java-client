                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PATCH)
                                        .path(
                                                "/spaces/test-space-id/relationships/isolation_segment")
                                        .payload(
                                                "fixtures/client/v3/spaces/PATCH_{id}_relationships_isolation_segment_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/spaces/PATCH_{id}_relationships_isolation_segment_response.json")
                                        .build())
                        .build());
        ...
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path("/spaces/test-space-id/routes?unmapped=true")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(ACCEPTED)
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/spaces/GET_{id}_relationships_isolation_segment_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .path("/spaces/test-space-id")
                                        .payload(
                                                "fixtures/client/v3/spaces/PATCH_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/client/v3/spaces/PATCH_{id}_response.json")
                                        .build())
                        .build());
