...
final class ReactorServiceBrokersV3Test extends AbstractClientApiTest {
	...
	mockRequest(InteractionContext.builder()
		.request(TestRequest.builder()
			...
			.payload("fixtures/client/v3/service_brokers/POST_request.json")
			.build())
	...
	mockRequest(InteractionContext.builder()
		...
		.response(TestResponse.builder()
			...
			.payload("fixtures/client/v3/service_brokers/GET_{id}_response.json")
			.build())
		.build());
	...
	this.serviceBrokersV3
	    ...
	    .expectNext(GetServiceBrokerResponse.builder()
		    ...
		    .link("self", Link.builder()
			    ...
			    .build())
		    .link("service_offerings", Link.builder()
	...
	mockRequest(InteractionContext.builder()
		...
		.response(TestResponse.builder()
			.status(HttpResponseStatus.OK)
			.payload("fixtures/client/v3/service_brokers/GET_response.json")
			.build())
		.build());
	...
	mockRequest(InteractionContext.builder()
		.request(TestRequest.builder()
			...
			.payload("fixtures/client/v3/service_brokers/PATCH_{id}_request.json")
			.build())
		.response(TestResponse.builder()
			.status(HttpResponseStatus.ACCEPTED)
			.header("Location", "https://api.example.org/v3/jobs/af5c57f6-8769-41fa-a499-2c84ed896788")
	...
	this.serviceBrokersV3
	    ...
	    .as(StepVerifier::create)
	    .expectNext(UpdateServiceBrokerResponse.builder().jobId("af5c57f6-8769-41fa-a499-2c84ed896788").build())
	    .expectComplete()
	    .verify(Duration.ofSeconds(5));
    }
	...
	mockRequest(InteractionContext.builder()
		.request(TestRequest.builder()
			.method(HttpMethod.PATCH).path("/service_brokers/test-service-broker-id")
			.payload("fixtures/client/v3/service_brokers/PATCH_{id}_metadata_request.json")
			.build())
		.response(TestResponse.builder()
			.status(HttpResponseStatus.OK)
			.payload("fixtures/client/v3/service_brokers/PATCH_{id}_metadata_response.json")
			.build())
		.build());
	...
	this.serviceBrokersV3
	    ...
	    .expectNext(UpdateServiceBrokerResponse.builder()
		    .serviceBroker(ServiceBrokerResource.builder()
			    .id("dde5ad2a-d8f4-44dc-a56f-0452d744f1c3")
                            .name("my_service_broker")
                            .url("https://example.service-broker.com")
                            .createdAt("2015-11-13T17:02:56Z")
