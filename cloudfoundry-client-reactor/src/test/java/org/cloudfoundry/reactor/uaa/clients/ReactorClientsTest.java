...
public final class ReactorClientsTest extends AbstractUaaApiTest {
    ...
    public void batchChangeSecret() {
        ...
        this.clients.batchChangeSecret(BatchChangeSecretRequest.builder()
            ...
            .expectNext(BatchChangeSecretResponse.builder()
                .client(Client.builder()
                    ...
                    .name("My Client Name")
                    .redirectUriPatterns("http*://ant.path.wildcard/**/passback/*",
                        "http://test1.com")
    ...
    public void batchCreate() {
        ...
        this.clients.batchCreate(BatchCreateClientsRequest.builder()
            .client(CreateClient.builder()
                ...
                .clientSecret("secret")
                .name("My Client Name")
                .redirectUriPatterns("http://test1.com",
    ...
    public void batchDelete() {
        ...
        this.clients.batchDelete(BatchDeleteClientsRequest.builder()
    ...
    public void batchUpdate() {
        ...
        this.clients.batchUpdate(BatchUpdateClientsRequest.builder()
    ...
    public void changeSecrets() {
        ...
        this.clients.changeSecret(ChangeSecretRequest.builder()
            .clientId("BMGkqk")
            .secret("new_secret")
            .build())
            .as(StepVerifier::create)
    ...
    public void create() {
        ...
        this.clients.create(CreateClientRequest.builder()
            .allowedProviders("uaa", "ldap", "my-saml-provider")
            .authorities("clients.read", "clients.write")
            .authorizedGrantType(CLIENT_CREDENTIALS)
            .autoApprove("true")
    ...
    public void delete() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(DELETE)
                .path("/oauth/clients/test-client-id")
                .build())
            .response(TestResponse.builder()
                .status(OK)
        ...
        this.clients.delete(DeleteClientRequest.builder()
    ...
    public void get() {
        ...
        this.clients.get(GetClientRequest.builder()
            .clientId("test-client-id")
            .build())
            .as(StepVerifier::create)
    ...
    public void getMetadata() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(GET)
                .path("/oauth/clients/P4vuAaSe/meta")
                .build())
            .response(TestResponse.builder()
                .status(OK)
        ...
        this.clients.getMetadata(GetMetadataRequest.builder()
            .clientId("P4vuAaSe")
            .build())
            .as(StepVerifier::create)
    ...
    public void list() {
        mockRequest(InteractionContext.builder()
            .request(TestRequest.builder()
                .method(GET)
                .path("/oauth/clients?count=10&filter=client_id+eq+%22EGgNW3%22&sortBy=client_id&sortOrder=descending&startIndex=1")
                .build())
            .response(TestResponse.builder()
                .status(OK)
    ...
    public void mixedActions() {
        ...
        this.clients.mixedActions(MixedActionsRequest.builder()
    ...
    public void update() {
        ...
        this.clients.update(UpdateClientRequest.builder()
            .authorizedGrantType(CLIENT_CREDENTIALS)
    ...
    public void updateMetadata() {
        ...
        this.clients.updateMetadata(UpdateMetadataRequest.builder()
            .appLaunchUrl("http://changed.app.launch/url")
            .clientId("RpFRZpY3")
            .showOnHomePage(false)
            .build())
