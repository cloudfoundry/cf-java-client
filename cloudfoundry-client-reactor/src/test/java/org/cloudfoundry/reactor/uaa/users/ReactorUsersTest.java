                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(PUT)
                                        .path(
                                                "/Users/9140c37c-c5d9-4c4d-a265-b6fe2f9dd02d/password")
                        ...
                        CreateUserRequest.builder()
                                ...
                                .email(
                                        Email.builder()
                                                ...
                                                .primary(true)
                                                .build())
                                .phoneNumber(PhoneNumber.builder().value("5555555555").build())
                                .active(true)
                                .verified(true)
                                .origin("")
                                .password("secret")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/uaa/users/PATCH_{id}_status_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/users/PATCH_{id}_status_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path(
                                                "/Users/1faa46a0-0c6f-4e13-8334-d1f6e5f2e1dd/verify-link?redirect_uri=http%3A%2F%2Fredirect.to%2Fapp")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/users/GET_{id}_verify_link_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/invite_users?client_id=u7ptqw&redirect_uri=example.com")
                                        .payload(
                                                "fixtures/uaa/users/POST_invite_users_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/users//POST_invite_users_response.json")
                                        .build())
                        .build());
                        ...
                        InviteUsersResponse.builder()
                                .newInvite(
                                        Invite.builder()
                                                ...
                                                .success(true)
                                                .inviteLink(
                                                        "http://localhost/invitations/accept?code=WEqtpOh73k")
                                                .build())
                                .newInvite(
                                        Invite.builder()
                                                ...
                                                .success(true)
                                                .inviteLink(
                                                        "http://localhost/invitations/accept?code=n5X0hCsD3N")
                                                .build())
                                .build())
                .expectComplete()
                .verify(Duration.ofSeconds(5));
        ...
        this.users
                .list(
                        ListUsersRequest.builder()
                                .filter(
                                        "id+eq+\"a94534d5-de08-41eb-8712-a51314e6a484\"+or+email+eq+\"Da63pG@test.org\"")
                                .count(50)
                                .startIndex(1)
                                .sortBy("email")
                                .sortOrder(ASCENDING)
                                ...
                                .resource(
                                        User.builder()
                                                ...
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "4622c5e1-ddfd-4e17-9e81-2ae3c03972be")
                                                                .display("password.write")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "62f67643-05d8-43c6-b193-4cd6ab9960cb")
                                                                .display("cloud_controller.write")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "c47bf470-f9c4-4eea-97e4-490ce7b8f6f7")
                                                                .display("uaa.user")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "8a6add1f-d3ee-400c-a263-c4197351b78e")
                                                                .display("approvals.me")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "e10424ed-ed80-45ac-848b-7f7e79b00c42")
                                                                .display("cloud_controller.read")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "ede11441-6ffe-4510-81f8-bb40626155f0")
                                                                .display("openid")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "7e3d4b06-0d6b-43a1-ac3a-5f1b2642262c")
                                                                .display("scim.me")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "3b481f3c-d9a7-4920-a687-72cb0381b671")
                                                                .display(
                                                                        "cloud_controller_service_permissions.read")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "4480c647-4047-4c6a-877f-70f5f96e8c11")
                                                                .display("oauth.approvals")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "542bb178-1c04-4bb5-813a-5a038319ac1d")
                                                                .display("user_attributes")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "c4ac4653-2fdd-4901-a028-9c9866cb4e9c")
                                                                .display("scim.userids")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "74fde138-daf3-4e4d-bb52-93a6cb727030")
                                                                .display("profile")
                                                                .type(DIRECT)
                                                                .build())
                                                .group(
                                                        Group.builder()
                                                                .value(
                                                                        "1b18551f-eead-4076-90dd-b464998f6ddd")
                                                                .display("roles")
                                                                .type(DIRECT)
                                                                .build())
                                                .approval(
                                                        Approval.builder()
                                                                .userId(
                                                                        "a94534d5-de08-41eb-8712-a51314e6a484")
                                                                .clientId("client id")
                                                                .scope("scim.read")
                                                                .status(APPROVED)
                                                                .lastUpdatedAt(
                                                                        "2016-05-18T18:25:24.047Z")
                                                                .expiresAt(
                                                                        "2016-05-18T18:25:34.047Z")
                                                                .build())
                                                .active(true)
                                                .verified(true)
                                                .origin("uaa")
        ...
        this.users
                .lookup(
                        LookupUserIdsRequest.builder()
                                .filter(
                                        "userName+eq+\"bobOu38vE@test.org\"+or+id+eq+\"c1476587-5ec9-4b7e-9ed2-381e3133f07a\"")
                                .count(10)
                                .startIndex(1)
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/users/GET_{id}_verify_user_response.json")
                                        .build())
                        .build());
