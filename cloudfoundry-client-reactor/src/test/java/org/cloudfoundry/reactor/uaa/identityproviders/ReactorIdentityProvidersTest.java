                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_request_ldap.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_response_ldap.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .header("X-Identity-Zone-Id", "test-identity-zone-id")
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_request_oauth.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_response_oauth.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .header("X-Identity-Zone-Id", "test-identity-zone-id")
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_request_saml.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/uaa/identity-providers/POST_response_saml.json")
                                        .build())
                        .build());
                        ...
                        CreateIdentityProviderRequest.builder()
                                ...
                                .configuration(
                                        SamlConfiguration.builder()
                                                ...
                                                .linkText(
                                                        "IDPEndpointsMockTests Saml Provider:SAML")
                                                .metaDataLocation(
                                                        "<?xml version=\"1.0\""
                                                            + " encoding=\"UTF-8\"?><md:EntityDescriptor"
                                                            + " xmlns:md=\"urn:oasis:names:tc:SAML:2.0:metadata\""
                                                            + " entityID=\"http://www.okta.com/SAML\"><md:IDPSSODescriptor"
                                                            + " WantAuthnRequestsSigned=\"true\""
                                                            + " protocolSupportEnumeration=\"urn:oasis:names:tc:SAML:2.0:protocol\"><md:KeyDescriptor"
                                                            + " use=\"signing\"><ds:KeyInfo"
                                                            + " xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:X509Data><ds:X509Certificate>MIICmTCCAgKgAwIBAgIGAUPATqmEMA0GCSqGSIb3DQEBBQUAMIGPMQswCQYDVQQGEwJVUzETMBEG\n"
                                                            ...
                                                            + "GFHNkZ6DmoT"
                                                            + "/PFagngecHu+EwmuDtaG0rEkFrARwe+d8Ru0BN558abFb</ds:X509Certificate></ds:X509Data></ds:KeyInfo></md:KeyDescriptor><md:NameIDFormat>urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress</md:NameIDFormat><md:NameIDFormat>urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified</md:NameIDFormat><md:SingleSignOnService"
                                                            + " Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\""
                                                            + " Location=\"https://pivotal.oktapreview.com/app/pivotal_pivotalcfstaging_1/k2lw4l5bPODCMIIDBRYZ/sso/saml\"/><md:SingleSignOnService"
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(DELETE)
                                        .path(
                                                "/identity-providers/test-identity-provider-id?rawConfig=true")
                                        .header("X-Identity-Zone-Id", "test-identity-zone-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-providers/DELETE_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        DeleteIdentityProviderResponse.builder()
                                ...
                                .configuration(
                                        SamlConfiguration.builder()
                                                ...
                                                .linkText(
                                                        "IDPEndpointsMockTests Saml"
                                                                + " Provider:saml-for-delete")
                                                .metaDataLocation(
                                                        "<?xml version=\"1.0\""
                                                            + " encoding=\"UTF-8\"?><md:EntityDescriptor"
                                                            + " xmlns:md=\"urn:oasis:names:tc:SAML:2.0:metadata\""
                                                            + " entityID=\"http://www.okta.com/saml-for-delete\"><md:IDPSSODescriptor"
                                                            + " WantAuthnRequestsSigned=\"true\""
                                                            + " protocolSupportEnumeration=\"urn:oasis:names:tc:SAML:2.0:protocol\"><md:KeyDescriptor"
                                                            + " use=\"signing\"><ds:KeyInfo"
                                                            + " xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:X509Data><ds:X509Certificate>MIICmTCCAgKgAwIBAgIGAUPATqmEMA0GCSqGSIb3DQEBBQUAMIGPMQswCQYDVQQGEwJVUzETMBEG\n"
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(CREATED)
                                        .payload(
                                                "fixtures/uaa/identity-providers/GET_{id}_response.json")
                                        .build())
                        .build());
                        ...
                        GetIdentityProviderResponse.builder()
                                ...
                                .configuration(
                                        SamlConfiguration.builder()
                                                ...
                                                .linkText(
                                                        "IDPEndpointsMockTests Saml"
                                                                + " Provider:saml-for-get")
                                                .metaDataLocation(
                                                        "<?xml version=\"1.0\""
                                                            + " encoding=\"UTF-8\"?><md:EntityDescriptor"
                                                            + " xmlns:md=\"urn:oasis:names:tc:SAML:2.0:metadata\""
                                                            + " entityID=\"http://www.okta.com/saml-for-get\"><md:IDPSSODescriptor"
                                                            + " WantAuthnRequestsSigned=\"true\""
                                                            + " protocolSupportEnumeration=\"urn:oasis:names:tc:SAML:2.0:protocol\"><md:KeyDescriptor"
                                                            + " use=\"signing\"><ds:KeyInfo"
                                                            + " xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:X509Data><ds:X509Certificate>MIICmTCCAgKgAwIBAgIGAUPATqmEMA0GCSqGSIb3DQEBBQUAMIGPMQswCQYDVQQGEwJVUzETMBEG\n"
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-providers/GET_response.json")
                                        .build())
                        .build());
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .header("X-Identity-Zone-Id", "test-identity-zone-id")
                                        .payload(
                                                "fixtures/uaa/identity-providers/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-providers/PUT_{id}_response.json")
                                        .build())
                        .build());
