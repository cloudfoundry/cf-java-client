...
final class ReactorTokensTest extends AbstractUaaApiTest {
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/check_token?scopes=password.write%2Cscim.userids&token=f9f2f98d88e04ff7bb1f69041d3c0346")
                                        .header(
                                                "Authorization",
                                                "Basic YXBwOmFwcGNsaWVudHNlY3JldA==")
                                        .build())
                        .response(
    ...
    void getKey() {
        ...
        this.tokens
                .getKey(GetTokenKeyRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(
                        GetTokenKeyResponse.builder()
                                ...
                                .use("sig")
                                .n(
                                        "ANJufZdrvYg5zG61x36pDq59nVUN73wSanA7hVCtN3ftT2Rm1ZTQqp5KSCfLMhaaVvJY51sHj"
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?code=zI6Z1X&client_id=login&client_secret=loginsecret&redirect_uri=https%3A%2F%2Fuaa.cloudfoundry.com%2Fredirect%2Fcf"
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?client_id=login&client_secret=loginsecret&token_format=opaque&grant_type=client_credentials&response_type=token")
                                        .header("Authorization", null)
                                        .header("Content-Type", "application/x-www-form-urlencoded")
                                        .build())
                        .response(
        ...
        this.tokens
                ...
                .expectNext(
                        GetTokenByClientCredentialsResponse.builder()
                                ...
                                .expiresInSeconds(43199)
                                .scopes(
                                        "clients.read emails.write scim.userids password.write"
                                                + " idps.write notifications.write oauth.login"
                                                + " scim.write critical_notifications.write")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?client_id=app&client_secret=appclientsecret&passcode=qcZNkd&token_format=opaque&grant_type=password&response_type=token")
                                        .header("Authorization", null)
                                        .header("Content-Type", "application/x-www-form-urlencoded")
                                        .build())
                        .response(
        ...
        this.tokens
                ...
                .expectNext(
                        GetTokenByOneTimePasscodeResponse.builder()
                                ...
                                .expiresInSeconds(43199)
                                .scopes(
                                        "scim.userids openid cloud_controller.read password.write"
                                                + " cloud_controller.write")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?code=NAlA1d&client_id=app&client_secret=appclientsecret&redirect_uri=https%3A%2F%2Fuaa.cloudfoundry.com%2Fredirect%2Fcf&token_format=opaque"
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?client_id=app&client_secret=appclientsecret&password=secr3T&token_format=opaque&"
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(POST)
                                        .path(
                                                "/oauth/token?client_id=app&client_secret=appclientsecret&refresh_token=6af5fc07a8b74c2eafb0079ff477bb11-r&token_format=opaque&grant_type=refresh_token")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.tokens
                ...
                .expectNext(
                        RefreshTokenResponse.builder()
                                ...
                                .expiresInSeconds(43199)
                                .scopes(
                                        "scim.userids cloud_controller.read password.write"
