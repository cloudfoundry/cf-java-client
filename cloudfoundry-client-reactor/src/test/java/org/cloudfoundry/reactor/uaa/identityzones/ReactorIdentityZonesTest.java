        ...
        IdentityZoneConfiguration testConfiguration = IdentityZoneConfiguration.builder()
            ...
            .corsPolicy(CorsPolicy.builder()
                .xhrConfiguration(CorsConfiguration.builder()
                    .allowedOrigin(".*")
                    .allowedUri(".*")
                    .allowedHeader("Accept", "Authorization", "Content-Type")
                    .allowedMethod("GET")
            ...
            .userConfig(UserConfig.builder()
                .defaultGroup("openid", "password.write", "uaa.user", "approvals.me", "profile", "roles", "user_attributes", "uaa.offline_token")
                .build())
