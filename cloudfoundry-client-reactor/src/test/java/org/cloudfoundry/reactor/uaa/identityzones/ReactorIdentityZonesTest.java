                        ...
                        .userConfig(
                                UserConfig.builder()
                                        .defaultGroups(
                                                ...
                                                "uaa.offline_token")
                                        .build())
                        .mfaConfig(MfaConfig.builder().enabled(false).build())
                        .build();
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-zones/DELETE_{id}_response.json")
                                        .build())
                        .build());
                                        ...
                                        IdentityZoneConfiguration.builder()
                                                ...
                                                .samlConfiguration(
                                                        SamlConfiguration.builder()
                                                                ...
                                                                .requestSigned(true)
                                                                .wantAssertionSigned(true)
                                                                .wantPartnerAuthenticationRequestSigned(
                                                                        false)
                                                                .assertionTimeToLive(600)
                                                                .build())
                                                .corsPolicy(
                ...
                InteractionContext.builder()
                        ...
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-zones/GET_{id}_response.json")
                                        .build())
                        .build());

        this.identityZones
                .get(GetIdentityZoneRequest.builder().identityZoneId("twiglet-get").build())
                .as(StepVerifier::create)
                .expectNext(
                                                                ...
                                                                .banner(
                                                                        Banner.builder()
                                                                                .backgroundColor(
                                                                                        "#89cff0")
                                                                                .link(
                                                                                        "http://announce.example.com")
                                                                                .logo(
                                                                                        "VGVzdFByb2R1Y3RMb2dv")
                                                                                .text(
                                                                                        "Announcement")
                                                                                .textColor(
                                                                                        "#000000")
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/uaa/identity-zones/PUT_{id}_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
                                        .payload(
                                                "fixtures/uaa/identity-zones/PUT_{id}_response.json")
                                        .build())
                        .build());
