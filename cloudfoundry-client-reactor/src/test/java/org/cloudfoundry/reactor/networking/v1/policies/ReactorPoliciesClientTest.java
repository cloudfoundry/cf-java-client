                                ...
                                .policy(
                                        Policy.builder()
                                                .destination(
                                                        Destination.builder()
                                                                .id(
                                                                        "38f08df0-19df-4439-b4e9-61096d4301ea")
                                                                .protocol("tcp")
                                                                .ports(
                                                                        Ports.builder()
                                                                                .end(1235)
                                                ...
                                                .source(
                                                        Source.builder()
                                                                .id(
                                                                        "1081ceac-f5c4-47a8-95e8-88e1e302efb5")
                                                                .build())
                                                .build())
                                .policy(
                                        Policy.builder()
                                                .destination(
                                                        Destination.builder()
                                                                .id(
                                                                        "308e7ef1-63f1-4a6c-978c-2e527cbb1c36")
                                                                .protocol("tcp")
                                                                .ports(
                                                                        Ports.builder()
                                                                                .end(1235)
                ...
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        ...
                                        .payload(
                                                "fixtures/networking/policies/POST_delete_request.json")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .payload(
