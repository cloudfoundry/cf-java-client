...
class ReactorLogCacheClientTest extends AbstractLogCacheApiTest {
    ...
    void info() {
        ...
        this.logCacheEndpoints
                .info(InfoRequest.builder().build())
                .as(StepVerifier::create)
                .expectNext(InfoResponse.builder().version("2.6.1").vmUptime(7166438L).build())
                .expectComplete()
    ...
    void read() {
        mockRequest(
                InteractionContext.builder()
                        .request(
                                TestRequest.builder()
                                        .method(GET)
                                        .path("/api/v1/read/test-source-id")
                                        .build())
                        .response(
                                TestResponse.builder()
                                        .status(OK)
        ...
        this.logCacheEndpoints
                .read(ReadRequest.builder().sourceId("test-source-id").build())
                .as(StepVerifier::create)
                .expectNext(
                                        ...
                                        EnvelopeBatch.builder()
                                                .batch(
                                                        Envelope.builder()
                                                                ...
                                                                .sourceId(
                                                                        "1a69c137-90f5-4b0a-8526-2ebca84c83a8")
                                                                .instanceId("0")
                                                                .tag(
                                                                        "app_id",
                                                                        "1a69c137-90f5-4b0a-8526-2ebca84c83a8")
                                                                ...
                                                                .tag(
                                                                        "deployment",
                                                                        "cf-6a000373a858bcb78f1c")
                                                                .tag(
                                                                        "index",
                                                                        "f237deb0-471f-459a-a18b-de084a8113e7")
                                                                .tag("instance_id", "0")
                                                                .tag("ip", "10.194.34.36")
                                                                .tag("job", "diego_cell")
                                                                .tag(
                                                                        "organization_id",
                                                                        "825ec316-5590-416a-9247-1dd0a5750801")
                                                                ...
                                                                .tag(
                                                                        "space_id",
                                                                        "547d902c-0554-4e7c-b886-3926a2e73bdf")
                                                                .tag("space_name", "test")
                                                                .tag(
                                                                        "system_domain",
                                                                        "cf.red.springapps.io")
                                                                .gauge(
                                                                        Gauge.builder()
                                                                                .metric(
                                                                                        "cpu",
                                                        ...
                                                        Envelope.builder()
                                                                ...
                                                                .log(
                                                                        Log.builder()
                                                                                .payload(
                                                                                        "")
                                                                                .type(LogType.OUT)
                                                                                .build())
                                                                .build())
                                                .build())
