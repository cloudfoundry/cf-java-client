 ...
 * @author Phillip Webb
 */
public class ZipApplicationArchiveTest extends AbstractApplicationArchiveTest {
    ...
    @Override
    protected ApplicationArchive newApplicationArchive(ZipFile zipFile) {
        return new ZipApplicationArchive(zipFile);
    }
}
