...
public class CloudControllerClientFactory {
	...
	private static Map<URL, Map<String, Object>> infoCache = new HashMap<URL, Map<String, Object>>();
	...
	public static CloudControllerClient newCloudController(URL cloudControllerUrl, String email, String password) {
	...
	public static CloudControllerClient newCloudController(URL cloudControllerUrl, String email, String password, String token) {
		CloudAuthenticationConfiguration authenticationConfiguration =
				new CloudAuthenticationConfiguration(email, password,
						getAuthorizationEndpoint(getInfoMap(cloudControllerUrl)));
	...
	private static CloudControllerClient createCloudControllerClient(URL cloudControllerUrl,
			CloudAuthenticationConfiguration authenticationConfiguration,
			String token) {
	...
	private static boolean isV2(Map<String,Object> infoMap) {
	...
	private static URL getAuthorizationEndpoint(Map<String,Object> infoMap) {
