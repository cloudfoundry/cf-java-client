...
public class CloudEntityResourceMapper {
	...
	private CloudSpace mapSpaceResource(Map<String, Object> resource) {
		CloudSpace space = new CloudSpace(getMeta(resource), getEntityAttribute(resource, "name", String.class));
		Map<String, Object> organization = getEmbeddedResource(resource, "organization");
		if (organization != null) {
			space.setOrganization(mapOrganizationResource(organization));
		}
		return space;
	}
