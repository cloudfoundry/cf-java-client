 ...
 *
 */
public class JavaWebArchivePackage implements ApplicationPackage {

    private final ZipFile archive;

    public JavaWebArchivePackage(String archive) throws IOException {
        this.archive = new ZipFile(archive);
    }

    public List<Map<String, Object>> generateFingerprint()
    throws IOException {
