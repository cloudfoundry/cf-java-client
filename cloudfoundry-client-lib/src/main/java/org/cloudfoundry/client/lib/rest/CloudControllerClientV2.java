...
public class CloudControllerClientV2 extends AbstractCloudControllerClient {
	...
	public List<CloudService> getServices() {
		...
		String urlPath = "v2/service_instances?inline-relations-depth={depth}";
	...
	public CloudService getService(String serviceName) {
		...
		for (Map<String, Object> resource : resourceList) {
			if (serviceName.equals(resourceMapper.getNameOfJsonResource(resource))) {
				service = resourceMapper.mapJsonResource(resource, CloudService.class);
			    break;
			}
		}
		return service;
