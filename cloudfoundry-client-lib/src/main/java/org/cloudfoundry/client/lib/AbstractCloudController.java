 ...
 */
public abstract class AbstractCloudController implements CloudController {
	...
	public AbstractCloudController(URL cloudControllerUrl) {
		this(null, null, cloudControllerUrl, new SimpleClientHttpRequestFactory());
	}

	public AbstractCloudController(String email, String password, URL cloudControllerUrl) {
		this(email, password, cloudControllerUrl, new SimpleClientHttpRequestFactory());
	}

	public AbstractCloudController(String email, String password, URL cloudControllerUrl, ClientHttpRequestFactory requestFactory) {
		this.email = email;
