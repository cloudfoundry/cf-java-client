...
public interface CloudFoundryOperations {
	...
	/**
	 * Get Cloud Controller generation (V1, V2) for the current cloud.
	 *
	 * @return CloudInfo.CC_GENERATION generation enum
	 */
	CloudInfo.CC_GENERATION getCloudControllerGeneration();
