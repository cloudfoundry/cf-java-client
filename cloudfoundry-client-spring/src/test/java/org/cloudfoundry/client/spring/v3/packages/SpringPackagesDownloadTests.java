 ...
 */
public final class SpringPackagesDownloadTests extends AbstractRestTest {

    private final int testByteArrayBufferLength = 64;

    private final SpringPackages packages = new SpringPackages(testByteArrayBufferLength, this.restTemplate, this.root);
