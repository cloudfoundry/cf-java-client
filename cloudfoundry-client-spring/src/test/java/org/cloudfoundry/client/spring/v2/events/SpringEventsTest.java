...
public final class SpringEventsTest extends AbstractRestTest {
    ...
    public void get() {
        ...
        Streams.wrap(this.events.get(request)).consume(response -> {
    ...
    public void getError() {
        ...
        this.events.get(request).subscribe(new ExpectedExceptionSubscriber());
    }

    @Test
    public void getInvalidRequest() {
        this.events.get(new GetEventRequest()).subscribe(new ExpectedExceptionSubscriber());
    }
