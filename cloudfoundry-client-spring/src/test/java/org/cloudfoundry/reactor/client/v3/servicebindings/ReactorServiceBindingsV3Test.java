...
public final class ReactorServiceBindingsV3Test {
    ...
    public static final class Delete extends AbstractClientApiTest<DeleteServiceBindingRequest, Void> {
        ...
        private final ReactorServiceBindingsV3 serviceBindings = new ReactorServiceBindingsV3(this.authorizationProvider, this.httpClient, this.objectMapper, this.root);
