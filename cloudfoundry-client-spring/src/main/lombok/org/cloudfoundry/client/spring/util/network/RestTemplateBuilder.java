...
public final class RestTemplateBuilder {
    ...
    public RestTemplateBuilder messageConverter(HttpMessageConverter<?> messageConverter) {
        this.messageConverters.add(messageConverter);
        return this;
    }

    public RestTemplateBuilder problemHandler(DeserializationProblemHandler problemHandler) {
