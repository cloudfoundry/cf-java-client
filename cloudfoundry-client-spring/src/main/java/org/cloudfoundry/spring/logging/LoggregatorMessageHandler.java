...
final class LoggregatorMessageHandler implements MessageHandler.Whole<byte[]> {
    ...
    public void onMessage(byte[] message) {
        try {
            org.cloudfoundry.logging.LoggregatorProtocolBuffers.LogMessage logMessage = org.cloudfoundry.logging.LoggregatorProtocolBuffers.LogMessage.parseFrom(message);
