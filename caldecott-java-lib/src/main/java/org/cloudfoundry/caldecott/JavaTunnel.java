...
/**
 * A class used for testing tunnels. Starts a tunnel erver based on provided connection parameters.
 *
...
public class JavaTunnel {
	...
	public static void main(String[] args) {
		...
		while (vcap_service == null) {
			...
			if (i ==0) {
				System.out.println("It looks like you don't have any services defined. Please create one first!");
				return;
			}
			...
			try {
				...
				System.out.println(svc + " is not a valid choice!");
				continue;
			}
