...
public final class IdentityProvidersTest extends AbstractIntegrationTest {
                ...
                .flatMap(
                        userId ->
                                requestCreateIdentityZone(
                                        this.uaaClient, identityZoneName, subdomainName))
                .then(
                        this.uaaClient
                                .identityProviders()
                                .create(
                                        CreateIdentityProviderRequest.builder()
                                                ...
                                                .configuration(
                                                        LdapConfiguration.builder()
                                                                ...
                                                                .ldapGroupFile(
                                                                        LdapGroupFile.NO_GROUP)
                                                                .ldapProfileFile(
                                                                        LdapProfileFile.SIMPLE_BIND)
    ...
    private static Mono<CreateIdentityProviderResponse> requestCreateIdentityProvider(
            UaaClient uaaClient, String identityZoneName, String name) {
        return uaaClient
                .identityProviders()
                .create(
                        CreateIdentityProviderRequest.builder()
    ...
    private static Mono<ListIdentityProvidersResponse> requestListIdentityProviders(
            UaaClient uaaClient, String identityZoneName) {
        return uaaClient
                .identityProviders()
                .list(
                        ListIdentityProvidersRequest.builder()
