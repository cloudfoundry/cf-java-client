        ...
        this.userId
            ...
            .then(this.uaaClient.identityProviders()
                .create(CreateIdentityProviderRequest.builder()
                    .active(true)
                    .configuration(String.format("{\"addShadowUserOnLogin\": true,\"ldapProfileFile\": \"ldap/ldap-simple-bind.xml\",\"baseUrl\": \"ldap://%s.url\",\"skipSSLVerification\": false," +
                        "\"userDNPattern\": \"cn={0},ou=Users,dc=test,dc=com\",\"userDNPatternDelimiter\": \";\",\"mailAttributeName\": \"mail\",\"mailSubstituteOverridesLdap\": false," +
                        "\"ldapGroupFile\": \"ldap/ldap-groups-null.xml\",\"autoAddGroups\": true,\"groupSearchSubTree\": true,\"maxGroupSearchDepth\": 10,\"tlsConfiguration\": \"none\"}", name))
    ...
    public void createOAuth() {
        ...
        this.userId
            ...
            .then(ignore -> this.uaaClient.identityProviders()
                .create(CreateIdentityProviderRequest.builder()
                    .active(true)
                    .configuration("{\"addShadowUserOnLogin\" : true,\"authUrl\" : \"http://auth.url\",\"tokenUrl\" : \"http://token.url\",\"tokenKey\" : \"token-key\",\"showLinkText\" : false," +
                        "\"skipSslValidation\" : false,\"relyingPartyId\" : \"uaa\",\"relyingPartySecret\" : \"secret\"}")
                    .identityZoneId(identityZoneName)
                    .name(name)
                    .originKey("oauth2.0")
                    .type(OAUTH2)
    ...
    public void createSaml() {
        ...
        this.userId
            ...
            .then(this.uaaClient.identityProviders()
                .create(CreateIdentityProviderRequest.builder()
                    .active(true)
                    .configuration("{\"addShadowUserOnLogin\" : true,\"metaDataLocation\" : \"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?><md:EntityDescriptor " +
                        ...
                        ": " +
                        "\"urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress\",\"assertionConsumerIndex\" : 0,\"metadataTrustCheck\" : false,\"showSamlLink\" : false,\"socketFactoryClassName\"" +
                        " : " +
                        "\"org.apache.commons.httpclient.protocol.DefaultProtocolSocketFactory\",\"linkText\" : \"IDPEndpointsMockTests Saml Provider:SAML\",\"groupMappingMode\" : " +
                        "\"EXPLICITLY_MAPPED\"}")
                    .identityZoneId(identityZoneName)
                    .name(name)
                    .originKey("SAML")
