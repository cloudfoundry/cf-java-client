...
public final class ServicePlanVisibilitiesTest extends AbstractIntegrationTest {
                        ...
                        function(
                                (organizationId, servicePlanId) ->
                                        requestListServicePlanVisibilities(
                                                        this.cloudFoundryClient, servicePlanId)
                                                .single()
                                                .flatMap(
                                                        response ->
                                                                Mono.just(
                        ...
                        function(
                                (organizationId, servicePlanId) ->
                                        Mono.zip(
                                                ...
                                                createServicePlanVisibilityId(
                                                        this.cloudFoundryClient,
                                                        organizationId,
                                                        servicePlanId))))
                .flatMap(
                        function(
                                (servicePlanId, servicePlanIdVisibilityId) ->
                                        this.cloudFoundryClient
                                                .servicePlanVisibilities()
                                                .delete(
    ...
    public void get() {
        ...
        Mono.zip(
                ...
                .flatMap(
                        function(
                                (organizationId, servicePlanVisibilityId) ->
                                        Mono.zip(
                                                Mono.just(organizationId),
                                                this.cloudFoundryClient
                                                        .servicePlanVisibilities()
    ...
    public void listFilterByServicePlanId() {
        ...
        Mono.zip(
                ...
                .flatMapMany(
                        function(
                                (servicePlanId, servicePlanVisibilityId) ->
                                        Mono.zip(
                                                Mono.just(servicePlanId),
                                                PaginationUtils.requestClientV2Resources(
                                                                page ->
    ...
    public void update() {
        ...
        Mono.zip(
                ...
                .flatMap(
                        function(
                                (newOrganizationId, servicePlanId, servicePlanIdVisibilityId) ->
                                        this.cloudFoundryClient
                                                .servicePlanVisibilities()
                                                .update(
                                                ...
                                                .thenReturn(
                                                        Tuples.of(
                                                                newOrganizationId, servicePlanId))))
                .flatMapMany(
                        function(
                                (newOrganizationId, servicePlanId) ->
                                        Mono.zip(
    ...
    private static Mono<String> createServicePlanVisibilityId(
                ...
                .filter(
                        resource ->
                                "test-plan-description"
                                        .equals(ResourceUtils.getEntity(resource).getDescription()))
                .map(ResourceUtils::getId)
                .single();
    }
