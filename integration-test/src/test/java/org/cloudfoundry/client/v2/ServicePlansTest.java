...
public final class ServicePlansTest extends AbstractIntegrationTest {
    ...
    public void list() {
        PaginationUtils.requestClientV2Resources(
                        page ->
                                this.cloudFoundryClient
                                        .servicePlans()
                                        .list(ListServicePlansRequest.builder().page(page).build()))
                .map(response -> ResourceUtils.getEntity(response).getName())
    ...
    public void listServiceInstancesFilterByServiceBindingId() {
        ...
        this.serviceBrokerId
                ...
                .flatMap(
                        function(
                                (applicationId, serviceInstanceId, servicePlanId) ->
                                        Mono.zip(
                ...
                .flatMapMany(
                        function(
                                (serviceBindingId, servicePlanId) ->
                                        PaginationUtils.requestClientV2Resources(
                                                page ->
                                                        this.cloudFoundryClient
                                                                .servicePlans()
    ...
    public void listServiceInstancesFilterByServiceKeyId() {
        ...
        this.serviceBrokerId
                ...
                .flatMap(
                        function(
                                (serviceInstanceId, servicePlanId) ->
                                        Mono.zip(
                                                createServiceKeyId(
                                                        this.cloudFoundryClient,
                                                        serviceInstanceId,
    ...
    private static Mono<String> createServiceInstanceId(
        ...
        return requestCreateServiceInstance(
                        cloudFoundryClient, serviceInstanceName, servicePlanId, spaceId)
                .then(
                        requestListServiceInstances(cloudFoundryClient, serviceInstanceName)
                                .single()
                                .map(ResourceUtils::getId));
    }
