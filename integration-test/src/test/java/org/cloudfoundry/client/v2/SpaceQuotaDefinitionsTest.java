...
public final class SpaceQuotaDefinitionsTest extends AbstractIntegrationTest {
    ...
    public void delete() {
        ...
        this.organizationId
                .flatMap(
                        organizationId ->
                                createSpaceQuotaDefinitionId(
                                        this.cloudFoundryClient, organizationId, quotaName))
                .flatMap(
                        quotaId ->
                                this.cloudFoundryClient
                                        .spaceQuotaDefinitions()
                        ...
                        function(
                                (spaceId, quotaId) ->
                                        requestAssociateSpace(
                                                        this.cloudFoundryClient, quotaId, spaceId)
                                                .thenReturn(quotaId)))
                .flatMapMany(
                        quotaId ->
                                PaginationUtils.requestClientV2Resources(
    ...
    public void listSpacesFilterByOrganizationId() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (organizationId, spaceId, quotaId) ->
                                        requestAssociateSpace(
                                                        this.cloudFoundryClient, quotaId, spaceId)
                                                .thenReturn(Tuples.of(organizationId, quotaId))))
                .flatMapMany(
                        function(
                                (organizationId, quotaId) ->
                                        PaginationUtils.requestClientV2Resources(
                                                page ->
                                                        this.cloudFoundryClient
                                                                .spaceQuotaDefinitions()
                                        ...
                                        requestAssociateSpace(
                                                ...
                                                .then(
                                                        this.cloudFoundryClient
                                                                .spaceQuotaDefinitions()
                                                                .removeSpace(
                                                                        RemoveSpaceQuotaDefinitionRequest
                                                                                .builder()
                                                                                .spaceId(spaceId)
                                                                                .spaceQuotaDefinitionId(
                                                                                        quotaId)
    ...
    public void update() {
        ...
        this.organizationId
                .flatMap(
                        organizationId ->
                                createSpaceQuotaDefinitionId(
                                        this.cloudFoundryClient, organizationId, quotaName1))
                .flatMap(
                        quotaId ->
                                this.cloudFoundryClient
                                        .spaceQuotaDefinitions()
                                        .update(
                                                UpdateSpaceQuotaDefinitionRequest.builder()
                                                        ...
                                                        .spaceQuotaDefinitionId(quotaId)
                                                        .build()))
                .thenMany(requestList(this.cloudFoundryClient).map(ResourceUtils::getEntity))
    ...
    private static Mono<String> createSpaceQuotaDefinitionId(
    ...
    private static Mono<AssociateSpaceQuotaDefinitionResponse> requestAssociateSpace(
            CloudFoundryClient cloudFoundryClient, String quotaId, String spaceId) {
        return cloudFoundryClient
                .spaceQuotaDefinitions()
                .associateSpace(
    ...
    private static Mono<CreateSpaceQuotaDefinitionResponse> requestCreateSpaceQuotaDefinition(
            CloudFoundryClient cloudFoundryClient, String organizationId, String quotaName) {
        return cloudFoundryClient
                .spaceQuotaDefinitions()
                .create(
    ...
    private static Flux<SpaceQuotaDefinitionResource> requestList(
