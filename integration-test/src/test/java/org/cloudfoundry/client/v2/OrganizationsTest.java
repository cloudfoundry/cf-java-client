...
public final class OrganizationsTest extends AbstractIntegrationTest {
    ...
    public void associateAuditor() {
        ...
        Mono.zip(createOrganizationId(this.cloudFoundryClient, organizationName), this.userId)
                .flatMap(
                        function(
    ...
    public void associatePrivateDomain() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                ...
                .flatMap(
                        function(
                                (privateDomainId, organizationId) ->
                                        Mono.zip(
                                                Mono.just(organizationId),
                                                this.cloudFoundryClient
                                                        .organizations()
                                                        .associatePrivateDomain(
                                                                AssociateOrganizationPrivateDomainRequest
                                                                        .builder()
                                                                        .organizationId(
                                                                                organizationId)
                                                                        .privateDomainId(
                                ...
                                (organizationId, userId) ->
                                        Mono.zip(
                                                ...
                                                this.cloudFoundryClient
                                                        .organizations()
                                                        .associateUser(
                                                                AssociateOrganizationUserRequest
                                                                        .builder()
                                                                        .userId(userId)
                                                                        .organizationId(
                                                                                organizationId)
                                ...
                                Mono.zip(
                                        ...
                                        this.cloudFoundryClient
                                                ...
                                                .associateUserByUsername(
                                                        AssociateOrganizationUserByUsernameRequest
                                                                .builder()
                                                                .organizationId(organizationId)
                                                                .username(this.username)
                                                                .build())
    ...
    public void delete() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                ...
                .flatMap(
                        organizationId ->
                                requestGetOrganization(this.cloudFoundryClient, organizationId))
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-OrganizationNotFound\\([0-9]+\\): The"
    ...
    public void list() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                .flatMapMany(
                        organizationId ->
                                requestListOrganizations(this.cloudFoundryClient)
                                        .map(ResourceUtils::getId)
    ...
    public void listAuditorsFilterByAuditedOrganizationId() {
        ...
        Mono.zip(
                ...
                .delayUntil(
                        function(
                                (organizationId1, organizationId2, userId) ->
                                        Mono.zip(
                                                requestAssociateAuditor(
                                                        this.cloudFoundryClient,
                                                        organizationId1,
                                ...
                                (organizationId, spaceId, userId) ->
                                        Mono.zip(
                                                ...
                                                requestListOrganizationAuditors(
                                                                this.cloudFoundryClient,
                                                                organizationId,
                                                                builder -> builder.spaceId(spaceId))
                                                        .single()
                                                        .map(ResourceUtils::getId))))
                .as(StepVerifier::create)
                .consumeNextWith(tupleEquality())
    ...
    public void listDomains() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                .delayUntil(
                        organizationId ->
                                createPrivateDomainId(
                                        this.cloudFoundryClient, organizationId, privateDomainName))
                .flatMapMany(
                        organizationId ->
                                PaginationUtils.requestClientV2Resources(
                                                page ->
                        ...
                        function(
                                (organizationId, auditorId) ->
                                        requestListOrganizations(
                                                        this.cloudFoundryClient,
                                                        builder -> builder.auditorId(auditorId))
                                                .map(ResourceUtils::getId)
                                                .filter(organizationId::equals)))
                .as(StepVerifier::create)
                .expectNextCount(1)
                ...
                .flatMapMany(
                        function(
                                (organizationId, userId) ->
                                        requestListOrganizations(
                                                        this.cloudFoundryClient,
                                                        builder -> builder.billingManagerId(userId))
                                                .map(ResourceUtils::getId)
                                                .filter(organizationId::equals)))
                .as(StepVerifier::create)
                .expectNextCount(1)
                ...
                .flatMapMany(
                        function(
                                (organizationId, userId) ->
                                        requestListOrganizations(
                                                        this.cloudFoundryClient,
                                                        builder -> builder.managerId(userId))
                                                .map(ResourceUtils::getId)
                                                .filter(organizationId::equals)))
                .as(StepVerifier::create)
                .expectNextCount(1)
    ...
    public void listFilterByName() {
        ...
        requestCreateOrganization(this.cloudFoundryClient, organizationName)
                .thenMany(
                        requestListOrganizations(
                                this.cloudFoundryClient, builder -> builder.name(organizationName)))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listFilterByStatus() {
        ...
        requestCreateOrganization(
                        this.cloudFoundryClient,
                        organizationName,
                        builder -> builder.status(organizationStatus))
                .map(ResourceUtils::getId)
                .flatMapMany(
                        organizationId ->
                                requestListOrganizations(
    ...
    public void listPrivateDomains() {
        ...
        Mono.zip(
                ...
                .delayUntil(
                        function(
                                (organizationId, privateDomainId) ->
                                        requestAssociatePrivateDomain(
                                                this.cloudFoundryClient,
                                                organizationId,
                                                privateDomainId)))
                .flatMap(
    ...
    public void listServices() {
        Mono.zip(this.organizationId, this.serviceBrokerId)
                .flatMapMany(
                        function(
                                (organizationId, serviceBrokerId) ->
                                        requestListOrganizationServices(
    ...
    public void listSpacesFilterByApplicationId() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                ...
                .flatMapMany(
                        (function(
                                (organizationId, spaceId, applicationId) ->
                                        Mono.zip(
                                                Mono.just(spaceId),
                                                requestListOrganizationSpaces(
                                                                this.cloudFoundryClient,
                                ...
                                (organizationId, userId) ->
                                        this.cloudFoundryClient
                                                ...
                                                .removeBillingManager(
                                                        RemoveOrganizationBillingManagerRequest
                                                                .builder()
                                                                .billingManagerId(userId)
                                                                .organizationId(organizationId)
                                                                .build())))
                        ...
                        function(
                                (organizationId, privateDomainId) ->
                                        this.cloudFoundryClient
                                                .organizations()
                                                .removePrivateDomain(
                                                        RemoveOrganizationPrivateDomainRequest
                                                                .builder()
    ...
    private static Mono<String> getUserDefaultSpaceId(
    ...
    private static Mono<AssociateOrganizationAuditorResponse> requestAssociateAuditor(
    ...
    private static Mono<AssociateOrganizationBillingManagerResponse> requestAssociateBillingManager(
            CloudFoundryClient cloudFoundryClient, String organizationId, String userId) {
        return cloudFoundryClient
                .organizations()
                .associateBillingManager(
    ...
    private static Mono<AssociateOrganizationManagerResponse> requestAssociateManager(
            CloudFoundryClient cloudFoundryClient, String organizationId, String userId) {
        return cloudFoundryClient
                .organizations()
                .associateManager(
    ...
    private static Mono<AssociateOrganizationPrivateDomainResponse> requestAssociatePrivateDomain(
            CloudFoundryClient cloudFoundryClient, String organizationId, String privateDomainId) {
        return cloudFoundryClient
                .organizations()
                .associatePrivateDomain(
    ...
    private static Mono<AssociateOrganizationUserResponse> requestAssociateUser(
            CloudFoundryClient cloudFoundryClient, String organizationId, String userId) {
        return cloudFoundryClient
                .organizations()
                .associateUser(
    ...
    private static Mono<CreateOrganizationResponse> requestCreateOrganization(
            CloudFoundryClient cloudFoundryClient, String organizationName) {
        return requestCreateOrganization(
                cloudFoundryClient, organizationName, UnaryOperator.identity());
    }
    ...
    private static Mono<CreateOrganizationResponse> requestCreateOrganization(
        ...
        return cloudFoundryClient
                ...
                .create(
                        transformer
                                .apply(CreateOrganizationRequest.builder())
    ...
    private static Mono<GetOrganizationResponse> requestGetOrganization(
    ...
    private static Flux<UserResource> requestListOrganizationAuditors(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationAuditors(
        ...
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                ...
                                .listAuditors(
                                        transformer
                                                .apply(ListOrganizationAuditorsRequest.builder())
                                                .page(page)
                                                .organizationId(organizationId)
                                                .build()));
    }

    private static Flux<UserResource> requestListOrganizationBillingManagers(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationBillingManagers(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
    ...
    private static Flux<UserResource> requestListOrganizationManagers(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationManagers(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
        ...
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                ...
                                .listManagers(
                                        transformer
                                                .apply(ListOrganizationManagersRequest.builder())
                                                .page(page)
                                                .organizationId(organizationId)
                                                .build()));
    }

    private static Flux<PrivateDomainResource> requestListOrganizationPrivateDomains(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationPrivateDomains(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
    ...
    private static Flux<ServiceResource> requestListOrganizationServices(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationServices(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
        ...
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                ...
                                .listServices(
                                        transformer
                                                .apply(ListOrganizationServicesRequest.builder())
                                                .organizationId(organizationId)
                                                .page(page)
                                                .build()));
    }

    private static Flux<SpaceResource> requestListOrganizationSpaces(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationSpaces(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
    ...
    private static Flux<SpaceResource> requestListOrganizationSpaces(
            CloudFoundryClient cloudFoundryClient,
            String organizationId,
            UnaryOperator<ListOrganizationSpacesRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .organizations()
                                .listSpaces(
                                        transformer
                                                .apply(ListOrganizationSpacesRequest.builder())
                                                .organizationId(organizationId)
                                                .page(page)
                                                .build()));
    }

    private static Flux<UserResource> requestListOrganizationUsers(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListOrganizationUsers(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
    ...
    private static Flux<UserResource> requestListOrganizationUsers(
            CloudFoundryClient cloudFoundryClient,
            String organizationId,
            UnaryOperator<ListOrganizationUsersRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .organizations()
                                .listUsers(
                                        transformer
                                                .apply(ListOrganizationUsersRequest.builder())
                                                .page(page)
                                                .organizationId(organizationId)
                                                .build()));
    }

    private static Flux<OrganizationResource> requestListOrganizations(
            CloudFoundryClient cloudFoundryClient) {
    ...
    private static Flux<OrganizationResource> requestListOrganizations(
            CloudFoundryClient cloudFoundryClient,
            UnaryOperator<ListOrganizationsRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .organizations()
                                .list(
                                        transformer
                                                .apply(ListOrganizationsRequest.builder())
                                                .page(page)
                                                .build()));
    }
    ...
    private static Flux<ServiceResource> requestListServices(
            CloudFoundryClient cloudFoundryClient) {
        return PaginationUtils.requestClientV2Resources(
                page -> cloudFoundryClient.services().list(ListServicesRequest.builder().build()));
    }
