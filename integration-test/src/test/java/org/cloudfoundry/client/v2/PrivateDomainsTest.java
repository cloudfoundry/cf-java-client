...
public final class PrivateDomainsTest extends AbstractIntegrationTest {
    ...
    public void delete() {
        ...
        this.organizationId
                .flatMap(
                        organizationId ->
                                requestCreatePrivateDomain(
                                        this.cloudFoundryClient, privateDomainName, organizationId))
                .delayUntil(
                        privateDomainResource ->
                                requestDeletePrivateDomain(
                                                this.cloudFoundryClient,
                                                ResourceUtils.getId(privateDomainResource))
                                        .flatMap(
                                                jobResource ->
    ...
    public void get() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (organizationId, privateDomainResource) ->
                                        Mono.zip(
                                                requestGetPrivateDomain(
                                                        this.cloudFoundryClient,
                                                        ResourceUtils.getId(privateDomainResource)),
                        ...
                        organizationId ->
                                Mono.zip(
                                        ...
                                        createOrganizationId(
                                                this.cloudFoundryClient, sharedOrganizationName)))
                .flatMap(
                        function(
    ...
    public void listSharedOrganizationsFilterByAuditorId() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (domainId, organizationId, userId) ->
                                        Mono.zip(
                                                requestAssociateOrganizationPrivateDomain(
                                                                this.cloudFoundryClient,
                                                                domainId,
    ...
    private static <R extends AbstractPrivateDomainResource>
            Consumer<Tuple2<R, String>> domainNameAndOrganizationIdEquality(String domainName) {
        return consumer(
                (resource, organizationId) -> {
                    assertThat(ResourceUtils.getEntity(resource).getName()).isEqualTo(domainName);
                    assertThat(ResourceUtils.getEntity(resource).getOwningOrganizationId())
                            .isEqualTo(organizationId);
                });
    }

    private static Flux<PrivateDomainResource> listPrivateDomains(
    ...
    private static Flux<PrivateDomainResource> listPrivateDomains(
            CloudFoundryClient cloudFoundryClient, String privateDomainName) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .privateDomains()
    ...
    private static Mono<DeletePrivateDomainResponse> requestDeletePrivateDomain(
            CloudFoundryClient cloudFoundryClient, String privateDomainId) {
        return cloudFoundryClient
                .privateDomains()
                .delete(
    ...
    private static Mono<GetPrivateDomainResponse> requestGetPrivateDomain(
            CloudFoundryClient cloudFoundryClient, String privateDomainId) {
        return cloudFoundryClient
                .privateDomains()
                .get(GetPrivateDomainRequest.builder().privateDomainId(privateDomainId).build());
    }
}
