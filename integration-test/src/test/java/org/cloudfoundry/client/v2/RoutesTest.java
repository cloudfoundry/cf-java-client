...
public final class RoutesTest extends AbstractIntegrationTest {
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-RouteNotFound\\([0-9]+\\): The route could not"
                                                        + " be found: .*"))
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void listApplicationsFilterByOrganizationId() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (domainId, spaceId, organizationId) ->
                                        Mono.zip(
                                                createApplicationId(
                                                        this.cloudFoundryClient,
                                                        spaceId,
                ...
                .delayUntil(
                        function(
                                (applicationId, routeId, organizationId) ->
                                        associateApplicationWithRoute(
                                                this.cloudFoundryClient, applicationId, routeId)))
                .flatMapMany(
                        function(
        ...
        Mono.zip(
                ...
                .flatMap(
                        function(
                                (domainId, spaceId) ->
                                        requestCreateRoute(
                                                this.cloudFoundryClient, domainId, host, spaceId)))
                .flatMapMany(
                        response ->
                                PaginationUtils.requestClientV2Resources(
                                        page ->
    ...
    private static Mono<AssociateRouteApplicationResponse> associateApplicationWithRoute(
    ...
    private static Mono<CreateRouteResponse> requestCreateRoute(
            CloudFoundryClient cloudFoundryClient, String domainId, String host, String spaceId) {
        return cloudFoundryClient
                .routes()
                .create(
                        CreateRouteRequest.builder()
    ...
    private static Mono<CreateRouteMappingResponse> requestCreateRouteMapping(
            CloudFoundryClient cloudFoundryClient, String applicationId, String routeId) {
        return cloudFoundryClient
                .routeMappings()
                .create(
    ...
    private static Mono<GetRouteResponse> requestGetRoute(
