...
public final class SpacesTest extends AbstractIntegrationTest {
    ...
    public void associateAuditorByUsername() {
        ...
        createSpaceIdAndUserId(
                ...
                .flatMapMany(
                        function(
                                (spaceId, userId) ->
                                        requestListSpaceAuditors(this.cloudFoundryClient, spaceId)
    ...
    public void associateDeveloperByUsername() {
        ...
        createSpaceIdAndUserId(
                ...
                .flatMapMany(
                        function(
                                (spaceId, userId) ->
                                        requestListSpaceDevelopers(this.cloudFoundryClient, spaceId)
                                                .map(
                                                        response ->
    ...
    public void associateManagerByUsername() {
        ...
        createSpaceIdAndUserId(
                                ...
                                (spaceId, userId) ->
                                        this.cloudFoundryClient
                                                ...
                                                .associateManagerByUsername(
                                                        AssociateSpaceManagerByUsernameRequest
                                                                .builder()
                                                                .spaceId(spaceId)
                                                                .username(userName)
                                                                .build())))
                .flatMapMany(
                        function(
                                (spaceId, userId) ->
                                        requestListSpaceManagers(this.cloudFoundryClient, spaceId)
                                                .map(
                                                        response ->
                                                                ResourceUtils.getEntity(response)
                                                                        .getUsername())))
                        ...
                        organizationId ->
                                Mono.zip(
                                        createSecurityGroupId(
                                                this.cloudFoundryClient, securityGroupName),
                                        createSpaceId(
                                                this.cloudFoundryClient,
                                                organizationId,
                                                spaceName)))
    ...
    public void listApplications() {
        ...
        this.organizationId
                ...
                .delayUntil(
                        spaceId ->
                                createApplicationId(
                                        this.cloudFoundryClient, spaceId, applicationName))
                .flatMap(
                        spaceId ->
                                requestListSpaceApplications(this.cloudFoundryClient, spaceId)
                                        .single())
                .map(response -> ResourceUtils.getEntity(response).getName())
                .as(StepVerifier::create)
    ...
    public void listApplicationsFilterByDiego() {
        ...
        this.organizationId
                ...
                .flatMap(
                        spaceId ->
                                requestListSpaceApplications(
                                                this.cloudFoundryClient,
                                                spaceId,
                                                builder -> builder.diego(true))
                                        .single())
                .map(response -> ResourceUtils.getEntity(response).getName())
                .as(StepVerifier::create)
                .expectNext(applicationName)
                        ...
                        function(
                                (organizationId, spaceId) ->
                                        requestListSpaceApplications(
                                                this.cloudFoundryClient,
                                                spaceId,
                                                builder -> builder.organizationId(organizationId))))
                .map(response -> ResourceUtils.getEntity(response).getName())
                .as(StepVerifier::create)
                .expectNext(applicationName)
                .expectComplete()
                        ...
                        function(
                                (spaceId, stackId) ->
                                        requestListSpaceApplications(
                                                this.cloudFoundryClient,
                                                spaceId,
                                                builder -> builder.stackId(stackId))))
                .map(response -> ResourceUtils.getEntity(response).getName())
                .as(StepVerifier::create)
                .expectNext(applicationName)
                .expectComplete()
    ...
    public void listDomains() {
        ...
        this.organizationId
                ...
                .filter(
                        domainResource ->
                                domainName.equals(
                                        ResourceUtils.getEntity(domainResource).getName()))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listDomainsFilterByName() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        spaceId ->
                                requestListSpaceDomains(
                                        this.cloudFoundryClient,
                                        spaceId,
                                        builder -> builder.name(domainName)))
                .map(response -> ResourceUtils.getEntity(response).getName())
                .as(StepVerifier::create)
    ...
    public void listEventsFilterByActee() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        spaceId ->
                                requestListSpaceEvents(
                                        this.cloudFoundryClient,
                                        spaceId,
                                        builder -> builder.actee(spaceId)))
                .map(response -> ResourceUtils.getEntity(response).getType())
                .as(StepVerifier::create)
                .expectNext("audit.space.create")
                .expectComplete()
                        ...
                        spaceId ->
                                Mono.zip(
                                        ...
                                        requestListSpaceEvents(
                                                        ...
                                                        spaceId,
                                                        builder ->
                                                                builder.type("audit.space.create"))
                                                .single()
                                                .map(
                                                        response ->
                                                                ResourceUtils.getEntity(response)
    ...
    public void listFilterByDeveloperId() {
        ...
        createSpaceIdAndUserId(
                ...
                .delayUntil(
                        function(
                                (spaceId, userId) ->
                                        requestAssociateSpaceDeveloper(
                                                this.cloudFoundryClient, userId, spaceId)))
                .flatMap(
                        function(
                                (spaceId, userId) ->
                                        Mono.zip(
                ...
                .flatMap(
                        spaceId ->
                                Mono.zip(
                                        ...
                                        requestListSpaces(
                                                        this.cloudFoundryClient,
                                                        builder -> builder.name(spaceName))
                                                .single()
                                                .map(ResourceUtils::getId)))
                .as(StepVerifier::create)
                .consumeNextWith(tupleEquality())
                                ...
                                (userId, spaceId, organizationId) ->
                                        Mono.zip(
                                                ...
                                                this.cloudFoundryClient
                                                        .organizations()
                                                        .associateAuditor(
                                                                AssociateOrganizationAuditorRequest
                                                                        .builder()
                                                                        .organizationId(
                                                                                organizationId)
                                                                        .auditorId(userId)
                        ...
                        function(
                                (spaceId, userId) ->
                                        requestListSpaceManagers(
                                                        this.cloudFoundryClient,
                                                        spaceId,
                                                        builder -> builder.auditedSpaceId(spaceId))
                                                .map(
                                                        response ->
                                                                ResourceUtils.getEntity(response)
                                                                        .getUsername())))
                                        ...
                                        Mono.zip(
                                                ...
                                                this.cloudFoundryClient
                                                        ...
                                                        .associateBillingManager(
                                                                AssociateOrganizationBillingManagerRequest
                                                                        .builder()
                                                                        .organizationId(
                                                                                organizationId)
                        ...
                        function(
                                (spaceId, userId) ->
                                        requestListSpaceManagers(
                                                        this.cloudFoundryClient,
                                                        spaceId,
                                                        builder -> builder.managedSpaceId(spaceId))
                                                .map(
                                                        response ->
                                                                ResourceUtils.getEntity(response)
                                                                        .getUsername())))
                                ...
                                (spaceId, routeId) ->
                                        Mono.zip(
                                                ...
                                                requestListSpaceRoutes(
                                                                this.cloudFoundryClient, spaceId)
                                                        .single()
                                                        .map(ResourceUtils::getId))))
                .as(StepVerifier::create)
                .consumeNextWith(tupleEquality())
    ...
    public void listSecurityGroups() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (securityGroupId, spaceId) ->
                                        requestAssociateSpaceSecurityGroup(
                                                        this.cloudFoundryClient,
                                                        spaceId,
                                                        securityGroupId)
                                                .thenReturn(spaceId)))
                                ...
                                PaginationUtils.requestClientV2Resources(
                                        page ->
                                                this.cloudFoundryClient
                                                        .spaces()
                                                        .listSecurityGroups(
                                                                ListSpaceSecurityGroupsRequest
                                                                        .builder()
                                                                        .page(page)
                                                                        .spaceId(spaceId)
                                                                        .build())))
                        ...
                        function(
                                (serviceBrokerId, spaceId) ->
                                        createServiceInstanceId(
                                                ...
                                                .thenReturn(spaceId)))
                .flatMapMany(
                        spaceId -> requestListServiceInstances(this.cloudFoundryClient, spaceId))
                .filter(
                        resource ->
                                serviceInstanceName.equals(
                ...
                .flatMapMany(
                        spaceId ->
                                requestListServiceInstances(
                                        this.cloudFoundryClient,
                                        spaceId,
                                        builder -> builder.gatewayName("test-gateway-name")))
                .as(StepVerifier::create)
                .expectNextCount(0)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
                ...
                .flatMapMany(
                        spaceId ->
                                requestListServiceInstances(
                                        this.cloudFoundryClient,
                                        spaceId,
                                        builder -> builder.name(serviceInstanceName)))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listServiceInstancesFilterByServiceBindingId() {
        ...
        this.organizationId
                ...
                .flatMap(
                        function(
                                (applicationId, serviceInstanceId, spaceId) ->
                                        Mono.zip(
                                                createServiceBindingId(
                                                        this.cloudFoundryClient,
                                                        applicationId,
                                                        serviceInstanceId),
                                                Mono.just(spaceId))))
    ...
    public void listServiceInstancesFilterByServiceKeyId() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        function(
                                (serviceKeyId, spaceId) ->
                                        requestListServiceInstances(
                                                this.cloudFoundryClient,
                                                spaceId,
                                                builder -> builder.serviceKeyId(serviceKeyId))))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listServiceInstancesFilterByServicePlanId() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        function(
                                (ignore, servicePlanId, spaceId) ->
                                        requestListServiceInstances(
                                                this.cloudFoundryClient,
                                                spaceId,
                                                builder -> builder.servicePlanId(servicePlanId))))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listServices() {
        this.spaceId
                .flatMapMany(
                        spaceId ->
                                requestListSpaceServices(this.cloudFoundryClient, spaceId)
                                        .filter(
                                                resource ->
                                                        this.serviceName.equals(
    ...
    public void listServicesFilterByLabel() {
        Mono.zip(this.serviceBrokerId, this.spaceId)
                .flatMapMany(
                        function(
                                (serviceBrokerId, spaceId) ->
                                        requestListSpaceServices(
                                                        this.cloudFoundryClient,
                                                        spaceId,
                                                        builder -> builder.label(this.serviceName))
                                                .filter(
                                                        resource ->
                                                                serviceBrokerId.equals(
                                                                        ResourceUtils.getEntity(
                                                                                        resource)
                                                                                .getServiceBrokerId()))))
                .map(response -> response.getEntity().getLabel())
                                ...
                                (spaceId, userId) ->
                                        this.cloudFoundryClient
                                                ...
                                                .removeAuditorByUsername(
                                                        RemoveSpaceAuditorByUsernameRequest
                                                                .builder()
                                                                .spaceId(spaceId)
                                                                .username(userName)
                                                                .build())))
                                ...
                                (spaceId, userId) ->
                                        this.cloudFoundryClient
                                                ...
                                                .removeDeveloperByUsername(
                                                        RemoveSpaceDeveloperByUsernameRequest
                                                                .builder()
                                                                .spaceId(spaceId)
                                                                .username(userName)
                                                                .build())))
        ...
        this.organizationId
                ...
                .delayUntil(
                        function(
                                (securityGroupId, spaceId) ->
                                        requestAssociateSpaceSecurityGroup(
                                                this.cloudFoundryClient, spaceId, securityGroupId)))
                .flatMap(
                        function(
                                (securityGroupId, spaceId) ->
                                        this.cloudFoundryClient
    ...
    private static Mono<Tuple2<String, String>> createOrganizationIdAndSpaceId(
            CloudFoundryClient cloudFoundryClient, String organizationName, String spaceName) {
                ...
                .flatMap(
                        organizationId ->
                                Mono.zip(
                                        Mono.just(organizationId),
                                        createSpaceId(
                                                cloudFoundryClient, organizationId, spaceName)));
    }
    ...
    private static Mono<String> createRouteId(
        ...
        return getSharedDomainId(cloudFoundryClient, domainName)
                .flatMap(
                        domainId ->
                                requestCreateRoute(
                                        cloudFoundryClient, spaceId, domainId, path, host))
                .map(ResourceUtils::getId);
    }

    private static Mono<String> createSecurityGroupId(
    ...
    private static Mono<String> createServiceBindingId(
    ...
    private static Mono<Tuple2<String, String>> createSpaceIdAndUserId(
            CloudFoundryClient cloudFoundryClient,
            UaaClient uaaClient,
    ...
    private static Mono<String> createSpaceIdWithDomain(
            CloudFoundryClient cloudFoundryClient,
    ...
    private static Mono<String> createUserId(
            CloudFoundryClient cloudFoundryClient,
            UaaClient uaaClient,
            String organizationId,
            String username) {
        return uaaClient
                .users()
                .create(
                        org.cloudfoundry.uaa.users.CreateUserRequest.builder()
                                .email(
                                        Email.builder()
                                                .primary(true)
                                                .value(
                ...
                .flatMap(
                        uaaId ->
                                cloudFoundryClient
                                        .users()
                                        .create(CreateUserRequest.builder().uaaId(uaaId).build())
                                        .map(ResourceUtils::getId))
                .flatMap(
                        userId ->
                                cloudFoundryClient
    ...
    private static Mono<AssociateSpaceAuditorResponse> requestAssociateSpaceAuditor(
    ...
    private static Mono<AssociateSpaceDeveloperResponse> requestAssociateSpaceDeveloper(
            CloudFoundryClient cloudFoundryClient, String developerId, String spaceId) {
        return cloudFoundryClient
                .spaces()
                .associateDeveloper(
                        AssociateSpaceDeveloperRequest.builder()
    ...
    private static Mono<AssociateSpaceManagerResponse> requestAssociateSpaceManager(
            CloudFoundryClient cloudFoundryClient, String spaceId, String userId) {
        return cloudFoundryClient
                .spaces()
                .associateManager(
    ...
    private static Mono<AssociateSpaceSecurityGroupResponse> requestAssociateSpaceSecurityGroup(
            CloudFoundryClient cloudFoundryClient, String spaceId, String securityGroupId) {
        return cloudFoundryClient
                .spaces()
                .associateSecurityGroup(
                        AssociateSpaceSecurityGroupRequest.builder()
    ...
    private static Mono<CreateOrganizationResponse> requestCreateOrganization(
        ...
        return cloudFoundryClient
                .organizations()
                .create(CreateOrganizationRequest.builder().name(organization).build());
    }
    ...
    private static Mono<CreateSecurityGroupResponse> requestCreateSecurityGroup(
            CloudFoundryClient cloudFoundryClient, String securityGroupName) {
        return cloudFoundryClient
                .securityGroups()
                .create(CreateSecurityGroupRequest.builder().name(securityGroupName).build());
    }
    ...
    private static Flux<SecurityGroupResource> requestListSecurityGroups(
                ...
                page ->
                        cloudFoundryClient
                                ...
                                .listServiceInstances(
                                        transformer
                                                .apply(ListSpaceServiceInstancesRequest.builder())
                                                .page(page)
                                                .spaceId(spaceId)
                                                .build()));
    }
    ...
    private static Flux<ApplicationResource> requestListSpaceApplications(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
    ...
    private static Flux<ApplicationResource> requestListSpaceApplications(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            UnaryOperator<ListSpaceApplicationsRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
                                .listApplications(
                                        transformer
                                                .apply(ListSpaceApplicationsRequest.builder())
                                                .page(page)
                                                .spaceId(spaceId)
                                                .build()));
    }

    private static Flux<UserResource> requestListSpaceAuditors(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Flux<UserResource> requestListSpaceDevelopers(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Flux<DomainResource> requestListSpaceDomains(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
    ...
    private static Flux<DomainResource> requestListSpaceDomains(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            UnaryOperator<ListSpaceDomainsRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
                                .listDomains(
                                        transformer
                                                .apply(ListSpaceDomainsRequest.builder())
                                                .page(page)
                                                .spaceId(spaceId)
                                                .build()));
    }

    private static Flux<EventResource> requestListSpaceEvents(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
    ...
    private static Flux<EventResource> requestListSpaceEvents(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            UnaryOperator<ListSpaceEventsRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
                                .listEvents(
                                        transformer
                                                .apply(ListSpaceEventsRequest.builder())
                                                .page(page)
                                                .spaceId(spaceId)
                                                .build()));
    }

    private static Flux<UserResource> requestListSpaceManagers(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
    ...
    private static Flux<UserResource> requestListSpaceManagers(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            Function<ListSpaceManagersRequest.Builder, ListSpaceManagersRequest.Builder>
                    transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                ...
                                .listManagers(
                                        transformer
                                                .apply(ListSpaceManagersRequest.builder())
                                                .page(page)
                                                .spaceId(spaceId)
                                                .build()));
    }

    private static Flux<RouteResource> requestListSpaceRoutes(
            CloudFoundryClient cloudFoundryClient, String spaceId) {
    ...
    private static Flux<RouteResource> requestListSpaceRoutes(
            CloudFoundryClient cloudFoundryClient,
            String spaceId,
            UnaryOperator<ListSpaceRoutesRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
                                .listRoutes(
                                        transformer
                                                .apply(ListSpaceRoutesRequest.builder())
                                                .spaceId(spaceId)
                                                .build()));
    }

    private static Flux<ServiceResource> requestListSpaceServices(
            CloudFoundryClient cloudFoundryClient, String organizationId) {
        return requestListSpaceServices(
                cloudFoundryClient, organizationId, UnaryOperator.identity());
    }
        ...
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                ...
                                .listServices(
                                        transformer
                                                .apply(ListSpaceServicesRequest.builder())
                                                .spaceId(spaceId)
                                                .page(page)
                                                .build()));
    }
    ...
    private static Flux<SpaceResource> requestListSpaces(
            CloudFoundryClient cloudFoundryClient,
            UnaryOperator<ListSpacesRequest.Builder> transformer) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .spaces()
                                .list(
                                        transformer
                                                .apply(ListSpacesRequest.builder())
                                                .page(page)
                                                .build()));
    }
