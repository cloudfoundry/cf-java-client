...
public final class OrganizationQuotaDefinitionsTest extends AbstractIntegrationTest {
    ...
    public void delete() {
        ...
        requestCreateOrganizationQuotaDefinition(this.cloudFoundryClient, quotaDefinitionName)
                ...
                .flatMap(
                        organizationQuotaDefinitionId ->
                                requestGetOrganizationQuotaDefinition(
                                        this.cloudFoundryClient, organizationQuotaDefinitionId))
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-QuotaDefinitionNotFound\\([0-9]+\\): Quota"
                ...
                .flatMap(
                        organizationQuotaDefinitionId ->
                                PaginationUtils.requestClientV2Resources(
                                        ...
                                        .filter(
                                                quotaDefinition ->
                                                        ResourceUtils.getId(quotaDefinition)
                                                                .equals(
                                                                        organizationQuotaDefinitionId))
                                        .single())
                .map(ResourceUtils::getEntity)
    ...
    private static Mono<CreateOrganizationQuotaDefinitionResponse>
            requestCreateOrganizationQuotaDefinition(
    ...
    private static Mono<GetOrganizationQuotaDefinitionResponse>
            requestGetOrganizationQuotaDefinition(
                    CloudFoundryClient cloudFoundryClient, String organizationQuotaDefinitionId) {
        return cloudFoundryClient
                .organizationQuotaDefinitions()
                .get(
                        GetOrganizationQuotaDefinitionRequest.builder()
