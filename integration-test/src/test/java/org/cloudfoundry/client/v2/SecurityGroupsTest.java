...
public final class SecurityGroupsTest extends AbstractIntegrationTest {
    ...
    public void deleteSpace() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        function(
                                (securityGroupId, spaceId) ->
                                        requestListSecurityGroupSpaces(
                                                this.cloudFoundryClient, spaceId, securityGroupId)))
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listRunningDefaults() {
        ...
        createSecurityGroupId(this.cloudFoundryClient, securityGroupName1)
                .flatMap(
                        securityGroupId ->
                                requestSetRunningDefault(this.cloudFoundryClient, securityGroupId))
                .then(
                        createSecurityGroupId(this.cloudFoundryClient, securityGroupName2)
                                .flatMap(
                                        securityGroupId ->
                                                requestSetRunningDefault(
                                                        this.cloudFoundryClient, securityGroupId)))
                .thenMany(requestListRunningDefaults(this.cloudFoundryClient))
                .filter(
                        response ->
                                securityGroupName1.equals(response.getEntity().getName())
                                        || securityGroupName2.equals(
                                                response.getEntity().getName()))
                .as(StepVerifier::create)
                .expectNextCount(2)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listStagingDefaults() {
        ...
        createSecurityGroupId(this.cloudFoundryClient, securityGroupName1)
                .flatMap(
                        securityGroupId ->
                                requestSetStagingDefault(this.cloudFoundryClient, securityGroupId))
                .then(
                        createSecurityGroupId(this.cloudFoundryClient, securityGroupName2)
                                .flatMap(
                                        securityGroupId ->
                                                requestSetStagingDefault(
                                                        this.cloudFoundryClient, securityGroupId)))
                                        ...
                                        .then(
                                                this.cloudFoundryClient
                                                        ...
                                                        .removeRunningDefault(
                                                                RemoveSecurityGroupRunningDefaultRequest
                                                                        .builder()
                                                                        .securityGroupId(
                                                                                securityGroupId)
                                                                        .build())))
                                        ...
                                        .then(
                                                this.cloudFoundryClient
                                                        ...
                                                        .removeStagingDefault(
                                                                RemoveSecurityGroupStagingDefaultRequest
                                                                        .builder()
                                                                        .securityGroupId(
                                                                                securityGroupId)
                                                                        .build())))
                                ...
                                this.cloudFoundryClient
                                        ...
                                        .update(
                                                UpdateSecurityGroupRequest.builder()
                                                        ...
                                                        .build()))
                .then(
                        requestListSecurityGroups(this.cloudFoundryClient, newSecurityGroupName)
                                .single()
                                .map(ResourceUtils::getEntity)
                                .map(SecurityGroupEntity::getName))
                .as(StepVerifier::create)
    ...
    private static Mono<AssociateSecurityGroupSpaceResponse> associateSpace(
    ...
    private static Flux<SecurityGroupResource> requestListRunningDefaults(
        ...
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
                                .securityGroups()
                                .listRunningDefaults(
                                        ListSecurityGroupRunningDefaultsRequest.builder().build()));
    }

    private static Flux<SpaceResource> requestListSecurityGroupSpaces(
            CloudFoundryClient cloudFoundryClient, String spaceId, String securityGroupId) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Flux<SecurityGroupResource> requestListStagingDefaults(
            CloudFoundryClient cloudFoundryClient) {
        return PaginationUtils.requestClientV2Resources(
                page ->
                        cloudFoundryClient
    ...
    private static Mono<SetSecurityGroupRunningDefaultResponse> requestSetRunningDefault(
            CloudFoundryClient cloudFoundryClient, String securityGroupId) {
        return cloudFoundryClient
                .securityGroups()
                .setRunningDefault(
                        SetSecurityGroupRunningDefaultRequest.builder()
    ...
    private static Mono<SetSecurityGroupStagingDefaultResponse> requestSetStagingDefault(
            CloudFoundryClient cloudFoundryClient, String securityGroupId) {
        return cloudFoundryClient
                .securityGroups()
                .setStagingDefault(
