...
public final class ServiceBindingsTest extends AbstractIntegrationTest {
    ...
    public void create() {
        ...
        createServiceInstanceAndApplicationIds(
                        this.spaceId, this.cloudFoundryClient, serviceInstanceName, applicationName)
                .flatMap(
                        function(
    ...
    public void delete() {
        ...
        createServiceInstanceAndApplicationIds(
                ...
                .delayUntil(
                        function(
                                (serviceInstanceId, applicationId, serviceBindingId) ->
                                        deleteServiceBinding(
                                                this.cloudFoundryClient, serviceBindingId)))
                .flatMap(
                        function(
                                (serviceInstanceId, applicationId, serviceBindingId) ->
                                        requestGetServiceBinding(
                                                this.cloudFoundryClient, serviceBindingId)))
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-ServiceBindingNotFound\\([0-9]+\\): The service"
                        ...
                        function(
                                (serviceInstanceId, applicationId, serviceBindingId) ->
                                        Mono.zip(
                                                Mono.just(serviceInstanceId),
                                                Mono.just(applicationId),
                                                requestListServiceBindings(
                                                                this.cloudFoundryClient, null, null)
                                                        .filter(
                                                                resource ->
                                                                        serviceBindingId.equals(
                                                                                ResourceUtils.getId(
                                                                                        resource)))
                                                        .single())))
                .as(StepVerifier::create)
    ...
    private static Mono<String> createApplicationId(
        ...
        return requestCreateApplication(
                        cloudFoundryClient, spaceId, applicationName, null, null, null, null)
    ...
    private static Mono<Tuple2<String, String>> createServiceInstanceAndApplicationIds(
            Mono<String> spaceId,
                ...
                spaceId1 ->
                        Mono.zip(
                                createUserServiceInstanceId(
                                        cloudFoundryClient, spaceId1, serviceInstance),
    ...
    private static Mono<GetServiceBindingResponse> requestGetServiceBinding(
            CloudFoundryClient cloudFoundryClient, String serviceBindingId) {
        return cloudFoundryClient
                .serviceBindingsV2()
                .get(GetServiceBindingRequest.builder().serviceBindingId(serviceBindingId).build());
    }
    ...
    private static Flux<ServiceBindingResource> requestListServiceBindings(
        ...
        return PaginationUtils.requestClientV2Resources(
                page -> cloudFoundryClient.serviceBindingsV2().list(builder.page(page).build()));
    }

    private static <T extends AbstractServiceBindingResource>
            Consumer<Tuple3<String, String, T>> serviceBindingEquality() {
        return consumer(
                (serviceInstanceId, applicationId, resource) -> {
                    assertThat(ResourceUtils.getEntity(resource).getServiceInstanceId())
                            .isEqualTo(serviceInstanceId);
                    assertThat(ResourceUtils.getEntity(resource).getApplicationId())
