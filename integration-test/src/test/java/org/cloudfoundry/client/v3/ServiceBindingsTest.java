...
public class ServiceBindingsTest extends AbstractIntegrationTest {
    ...
    public void createServiceKeyFromManagedServiceInstance() {
        ...
        this.spaceId
            ...
            .flatMap(serviceInstanceId -> this.cloudFoundryClient.serviceBindingsV3()
    ...
    public void createAppBindingFromUserProvidedServiceInstance() {
        ...
        this.spaceId
            .flatMap(spaceId -> Mono.zip(
                createUserProvidedServiceInstanceId(this.cloudFoundryClient, serviceInstanceName, Collections.emptyMap(), spaceId),
                createApplicationId(this.cloudFoundryClient, applicationName, spaceId)
            ))
            .flatMap(function((serviceInstanceId, appId) -> this.cloudFoundryClient.serviceBindingsV3()
                .create(CreateServiceBindingRequest.builder()
                    ...
                    .relationships(ServiceBindingRelationships.builder()
                        ...
                        .build())
                    .build())
                .map(response -> response.getServiceBinding()
                    .get())))
    ...
    public void deleteForManagedService() {
        ...
        this.spaceId
            .flatMap(spaceId -> createManagedServiceInstanceId(this.cloudFoundryClient, this.serviceBrokerId, serviceInstanceName, this.serviceName, spaceId))
            .flatMap(serviceInstanceId -> createServiceKey(this.cloudFoundryClient, serviceKeyName, serviceInstanceName, serviceInstanceId))
            .map(ServiceBinding::getId)
            .flatMap(bindingId -> this.cloudFoundryClient.serviceBindingsV3()
    ...
    public void deleteForUserProvidedService() {
        ...
        this.spaceId
            ...
            .flatMap(function((serviceInstanceId, appId) -> createServiceBindingForUserProvidedService(this.cloudFoundryClient, appId, serviceInstanceId)))
            .map(ServiceBinding::getId)
            .flatMap(bindingId -> this.cloudFoundryClient.serviceBindingsV3()
                .delete(DeleteServiceBindingRequest.builder()
                    .serviceBindingId(bindingId)
    ...
    public void listForApplication() {
        ...
        this.spaceId
            ...
            .flatMap(function((serviceInstanceId, appId) -> createServiceBindingForUserProvidedService(this.cloudFoundryClient, appId, serviceInstanceId)))
            .thenMany(this.cloudFoundryClient.serviceBindingsV3()
    ...
    public void getDetails() {
        ...
        this.spaceId
            .flatMap(spaceId -> Mono.zip(
                createUserProvidedServiceInstanceId(this.cloudFoundryClient, serviceInstanceName, Collections.singletonMap("foo", "bar"), spaceId),
                createApplicationId(this.cloudFoundryClient, applicationName, spaceId)
            ))
            .flatMap(function((serviceInstanceId, appId) -> createServiceBindingForUserProvidedService(this.cloudFoundryClient, appId, serviceInstanceId)))
            .map(ServiceBinding::getId)
    ...
    private static Mono<String> createManagedServiceInstanceId(CloudFoundryClient cloudFoundryClient, Mono<String> serviceBrokerId, String serviceInstanceName, String serviceName, String spaceId) {
        return serviceBrokerId
            ...
            .flatMap(planId -> requestCreateManagedServiceInstance(cloudFoundryClient, planId, serviceInstanceName, spaceId))
            .map(response -> response.getJobId()
                .get())
    ...
    private static Flux<? extends ServicePlan> requestListServicePlans(CloudFoundryClient cloudFoundryClient, String serviceName, String serviceBrokerId) {
        return PaginationUtils.requestClientV3Resources(page -> cloudFoundryClient.servicePlansV3()
    ...
    private static Mono<CreateServiceInstanceResponse> requestCreateManagedServiceInstance(CloudFoundryClient cloudFoundryClient, String planId, String serviceInstanceName, String spaceId) {
    ...
    private static Mono<String> createUserProvidedServiceInstanceId(CloudFoundryClient cloudFoundryClient, String serviceInstanceName, Map<String, Object> credentials, String spaceId) {
        return requestCreateUserProvidedServiceInstance(cloudFoundryClient, serviceInstanceName, credentials, spaceId)
            .map(response -> response.getServiceInstance()
                .get())
            .map(ServiceInstance::getId);
    }

    private static Mono<CreateServiceInstanceResponse> requestCreateUserProvidedServiceInstance(CloudFoundryClient cloudFoundryClient, String serviceInstanceName, Map<String, Object> credentials,
                                                                                                String spaceId) {
        return cloudFoundryClient.serviceInstancesV3()
            .create(CreateServiceInstanceRequest.builder()
    ...
    private static Flux<? extends ServiceInstance> requestListServiceInstances(CloudFoundryClient cloudFoundryClient, String serviceInstanceName) {
        return PaginationUtils.requestClientV3Resources(page -> cloudFoundryClient.serviceInstancesV3()
    ...
    private static Flux<? extends ServiceBinding> requestListServiceBindings(CloudFoundryClient cloudFoundryClient, String serviceInstanceName) {
        return PaginationUtils.requestClientV3Resources(page -> cloudFoundryClient.serviceBindingsV3()
            .list(ListServiceBindingsRequest.builder()
                .page(page)
                .serviceInstanceName(serviceInstanceName)
                .build()));
    ...
    private static Mono<? extends ServiceBinding> createServiceKey(CloudFoundryClient cloudFoundryClient, String serviceKeyName, String serviceInstanceName, String serviceInstanceId) {
        return cloudFoundryClient.serviceBindingsV3()
            .create(CreateServiceBindingRequest.builder()
                .type(ServiceBindingType.KEY)
                .name(serviceKeyName)
                .relationships(ServiceBindingRelationships.builder()
    ...
    private static Mono<ServiceBinding> createServiceBindingForUserProvidedService(CloudFoundryClient cloudFoundryClient, String appId, String serviceInstanceId) {
        return cloudFoundryClient.serviceBindingsV3()
            .create(CreateServiceBindingRequest.builder()
                .type(ServiceBindingType.APPLICATION)
                .metadata(Metadata.builder()
