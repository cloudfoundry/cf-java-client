...
public final class DomainsTest extends AbstractIntegrationTest {
    ...
    public void checkReservedRoutes() {
        ...
        this.organizationId
                ...
                .expectNext(CheckReservedRoutesResponse.builder().matchingRoute(false).build())
                .expectComplete()
                                ...
                                this.cloudFoundryClient
                                        ...
                                        .checkReservedRoutes(
                                                CheckReservedRoutesRequest.builder()
                                                        ...
                                                        .build()))
                .as(StepVerifier::create)
                .expectNext(CheckReservedRoutesResponse.builder().matchingRoute(true).build())
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void create() {
        ...
        this.cloudFoundryClient
                .domainsV3()
                .create(CreateDomainRequest.builder().internal(false).name(domainName).build())
                .as(StepVerifier::create)
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-ResourceNotFound\\([0-9]+\\): Domain not"
                                                        + " found.*"))
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void share() {
        ...
        this.organizationId
                        ...
                        organizationId ->
                                Mono.zip(
                                        ...
                                        createOrganizationId(
                                                this.cloudFoundryClient, organizationName)))
                .delayUntil(
                        function(
                                (organizationId, domainId, newOrganizationId) ->
                                        this.cloudFoundryClient
                                                .domainsV3()
                                                .share(
                ...
                .consumeNextWith(
                        consumer(
                                (response, organizationId, newOrganizationId) -> {
                                    assertThat(response.getName()).isEqualTo(domainName);
                                    assertThat(
                                                    response.getRelationships()
                                                            .getOrganization()
    ...
    public void unshare() {
        ...
        this.organizationId
                ...
                .flatMapMany(
                        function(
                                (organizationId, domainId, newOrganizationId) ->
                                        requestListDomainsForOrganization(
                                                        this.cloudFoundryClient, newOrganizationId)
                                                .filter(
                                                        resource ->
                                                                domainId.equals(resource.getId()))))
                .as(StepVerifier::create)
                .expectNextCount(0)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    private static Mono<String> createDomainId(
        ...
        return requestCreateDomain(cloudFoundryClient, domainName).map(CreateDomainResponse::getId);
    }
    ...
    private static Flux<DomainResource> requestListDomainsForOrganization(
    ...
    private static Mono<ShareDomainResponse> requestShareDomain(
