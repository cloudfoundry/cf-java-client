...
public final class ServiceInstancesTest extends AbstractIntegrationTest {
        ...
        this.spaceId
                ...
                .map(
                        getServiceInstanceResponse ->
                                getServiceInstanceResponse.getServiceInstance().get().getId())
                .flatMap(
                        serviceInstanceId ->
                                this.cloudFoundryClient
                                        .serviceInstancesV3()
    ...
    public void delete() {
        ...
        this.spaceId
                .flatMap(
                        spaceId ->
                                deleteServiceInstanceByName(
                                        this.cloudFoundryClient, serviceInstanceName, spaceId))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listSharedSpaces() {
        ...
        Mono.zip(this.organizationId, this.spaceId)
                ...
                .flatMap(
                        function(
                                (serviceInstanceId, newSpaceId) ->
                                        requestShareServiceInstance(
                                                        this.cloudFoundryClient,
                                                        newSpaceId,
                                                        serviceInstanceId)
                                ...
                                this.cloudFoundryClient
                                        ...
                                        .listSharedSpacesRelationship(
                                                ListSharedSpacesRelationshipRequest.builder()
                                                        ...
                                                        .build())
                                        .flatMapIterable(
                                                ListSharedSpacesRelationshipResponse::getData))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void unshare() {
        ...
        Mono.zip(this.organizationId, this.spaceId)
                ...
                .flatMapMany(
                        function(
                                (serviceInstanceId, newSpaceId) ->
                                        requestListSharedSpacesRelationship(
                                                        this.cloudFoundryClient, serviceInstanceId)
                                                .flatMapIterable(
                                                        ListSharedSpacesRelationshipResponse
                                                                ::getData)
    ...
    private static Mono<String> deleteServiceInstanceByName(
        ...
        return cloudFoundryClient
                ...
                .flatMap(
                        serviceInstance ->
                                deleteServiceInstanceById(
                                        cloudFoundryClient, serviceInstance.getId()));
    }

    private static Mono<String> deleteServiceInstanceById(
    ...
    private static Mono<String> updateServiceInstanceByName(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceName, String spaceId) {
        return cloudFoundryClient
                .serviceInstancesV3()
                .list(
    ...
    private static Mono<UpdateServiceInstanceResponse> updateServiceInstanceById(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        return cloudFoundryClient
                .serviceInstancesV3()
                .update(
    ...
    private static Mono<String> getServiceInstanceIdByName(
        ...
        return cloudFoundryClient
                ...
                .list(
                        ListServiceInstancesRequest.builder()
                                .serviceInstanceName(serviceInstanceName)
                                .build())
                .map(serviceInstances -> serviceInstances.getResources().get(0).getId());
    }

    private static Mono<CreateServiceInstanceResponse> createUserProvidedServiceInstance(
            CloudFoundryClient cloudFoundryClient,
            String serviceInstanceName,
        ...
        return requestListServiceOfferings(cloudFoundryClient, serviceBrokerId)
                .filter(
                        serviceOfferingResource ->
                                serviceName.equals(serviceOfferingResource.getName()))
                .single()
    ...
    private static Flux<ServiceOfferingResource> requestListServiceOfferings(
    ...
    private static Mono<ListSharedSpacesRelationshipResponse> requestListSharedSpacesRelationship(
            CloudFoundryClient cloudFoundryClient, String serviceInstanceId) {
        return cloudFoundryClient
                .serviceInstancesV3()
                .listSharedSpacesRelationship(
    ...
    private static Mono<ShareServiceInstanceResponse> requestShareServiceInstance(
            CloudFoundryClient cloudFoundryClient, String newSpaceId, String serviceInstanceId) {
        return cloudFoundryClient
                .serviceInstancesV3()
                .share(
                        ShareServiceInstanceRequest.builder()
                                .data(Relationship.builder().id(newSpaceId).build())
                                .serviceInstanceId(serviceInstanceId)
                                .build());
    }
}
