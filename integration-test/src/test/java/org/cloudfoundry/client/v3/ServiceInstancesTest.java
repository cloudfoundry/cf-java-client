...
public final class ServiceInstancesTest extends AbstractIntegrationTest {
    ...
    public void listSharedSpaces() {
        ...
        Mono.when(this.organizationId, this.spaceId)
            ...
            .then(function((serviceInstanceId, newSpaceId) -> requestShareServiceInstance(this.cloudFoundryClient, newSpaceId, serviceInstanceId)
    ...
    public void share() {
        ...
        Mono.when(this.organizationId, this.spaceId)
            ...
            .flatMapMany(function((serviceInstanceId, newSpaceId) -> Mono.when(
    ...
    public void unshare() {
        ...
        Mono.when(this.organizationId, this.spaceId)
            ...
            .then(function((serviceInstanceId, newSpaceId) -> requestShareServiceInstance(this.cloudFoundryClient, newSpaceId, serviceInstanceId)
                .then(Mono.just(Tuples.of(serviceInstanceId, newSpaceId)))))
            .then(function((serviceInstanceId, newSpaceId) -> this.cloudFoundryClient.serviceInstancesV3()
