                                        ...
                                        .update(
                                                UpdateServicePlanRequest.builder()
                                                        .metadata(
                                                                Metadata.builder()
                                                                        .label(
                                                                                "test-label-selector-key1",
                                                                                "test-label-selector-value1")
                                                                        .label(
                                                                                "test-label-selector-key2",
                                                                                "test-label-selector-value2")
                                                                        .build())
                                                        .servicePlanId(servicePlanId)
                                                        .build()))
                .thenMany(
                                        ...
                                        page ->
                                                this.cloudFoundryClient
                                                        ...
                                                        .list(
                                                                ListServicePlansRequest.builder()
                                                                        .labelSelector(
                                                                                "test-label-selector-key1,test-label-selector-key1")
                                                                        .page(page)
                                                                        .serviceBrokerId(
                                        ...
                                        page ->
                                                this.cloudFoundryClient
                                                        ...
                                                        .list(
                                                                ListServicePlansRequest.builder()
                                                                        .labelSelector(
                                                                                "test-label-selector-key1,key-that-causes-no-results-because-this-is-an-AND-query")
                                                                        .page(page)
                                                                        .serviceBrokerId(
                                                                                serviceBrokerMetadata
                                                                                        .serviceBrokerId)
