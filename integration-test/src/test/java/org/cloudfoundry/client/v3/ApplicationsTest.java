...
public final class ApplicationsTest extends AbstractIntegrationTest {
                                ...
                                this.cloudFoundryClient
                                        ...
                                        .create(
                                                CreateApplicationRequest.builder()
                                                        .environmentVariable(
                                                                "test-create-env-key",
                                                                "test-create-env-value")
                                                        .metadata(
                                                                Metadata.builder()
                                                                        .label(
                                                                                "test-create-label-key",
                                                                                "test-create-label-value")
                                                                        .build())
    ...
    public void delete() {
        ...
        this.spaceId
                ...
                .flatMap(
                        applicationId ->
                                requestGetApplications(this.cloudFoundryClient, applicationId))
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessageMatching(
                                                "CF-ResourceNotFound\\([0-9]+\\): App not found.*"))
                .verify(Duration.ofMinutes(5));
    }
                ...
                .flatMap(
                        applicationId ->
                                Mono.zip(
                                        ...
                                        uploadPackageAndCreateDropletId(
                                                this.cloudFoundryClient, applicationId)))
                .delayUntil(
                        function(
    ...
    public void getEnvironment() {
        ...
        this.spaceId
                ...
                .map(
                        env ->
                                ((Map<String, Object>)
                                                env.getApplicationEnvironmentVariables()
    ...
    public void getSshEnabled() {
        ...
        this.spaceId
                ...
                .as(StepVerifier::create)
                .expectNext(
                        GetApplicationSshEnabledResponse.builder().enabled(true).reason("").build())
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
        ...
        this.organizationId
                ...
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutes-key",
                                "test-listApplicationRoutes-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void listApplicationRoutesByDomain() {
        ...
        this.organizationId
                                ...
                                (domainId, spaceId) ->
                                        Mono.zip(
                                                ...
                                                createRouteId(
                                                        this.cloudFoundryClient,
                                                        domainId,
                                                        "listApplicationRoutesByDomain",
                                                        spaceId))))
                .delayUntil(
                        function(
                                (applicationId, domainId, routeId) ->
                                        requestReplaceDestinations(
                                                this.cloudFoundryClient, applicationId, routeId)))
                .flatMapMany(
                        function(
                                (applicationId, domainId, ignore) ->
                                        PaginationUtils.requestClientV3Resources(
                                                page ->
                                                        this.cloudFoundryClient
                                                                .applicationsV3()
                ...
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesByDomain-key",
                                "test-listApplicationRoutesByDomain-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
        ...
        this.organizationId
                ...
                .filter(
                        route ->
                                route.getMetadata()
                                        .getLabels()
                                        .containsKey("test-listApplicationRoutesByHost-key"))
                .map(RouteResource::getMetadata)
                .map(Metadata::getLabels)
                .as(StepVerifier::create)
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesByHost-key",
                                "test-listApplicationRoutesByHost-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void listApplicationRoutesByLabelSelector() {
        ...
        this.organizationId
                                ...
                                (domainId, spaceId) ->
                                        Mono.zip(
                                                ...
                                                createRouteId(
                                                        this.cloudFoundryClient,
                                                        domainId,
                                                        "listApplicationRoutesByLabelSelector",
                                                        spaceId))))
                .flatMapMany(
                        function(
                                (applicationId, routeId) ->
                                                        ...
                                                        .listRoutes(
                                                                ListApplicationRoutesRequest
                                                                        ...
                                                                        .applicationId(
                                                                                applicationId)
                                                                        .labelSelector(
                                                                                "test-listApplicationRoutesByLabelSelector-key=test-listApplicationRoutesByLabelSelector-value")
                                                                        .page(page)
                                                                        .build())))
                .map(RouteResource::getMetadata)
                .map(Metadata::getLabels)
                ...
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesByLabelSelector-key",
                                "test-listApplicationRoutesByLabelSelector-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void listApplicationRoutesByOrganizationId() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                                ...
                                (domainId, organizationId, spaceId) ->
                                        Mono.zip(
                                                ...
                                                createRouteId(
                                                        this.cloudFoundryClient,
                                                        domainId,
                                                        "listApplicationRoutesByOrganizationId",
                                                        spaceId))))
                .delayUntil(
                        function(
                                (applicationId, organizationId, routeId) ->
                                        requestReplaceDestinations(
                                                this.cloudFoundryClient, applicationId, routeId)))
                .flatMapMany(
                        function(
                                (applicationId, organizationId, ignore) ->
                                        PaginationUtils.requestClientV3Resources(
                                                page ->
                                                        this.cloudFoundryClient
                                                                .applicationsV3()
                ...
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesByOrganizationId-key",
                                "test-listApplicationRoutesByOrganizationId-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
        ...
        this.organizationId
                ...
                .filter(
                        route ->
                                route.getMetadata()
                                        .getLabels()
                                        .containsKey("test-listApplicationRoutesByPath-key"))
                .map(RouteResource::getMetadata)
                .map(Metadata::getLabels)
                .as(StepVerifier::create)
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesByPath-key",
                                "test-listApplicationRoutesByPath-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
        ...
        this.organizationId
                                ...
                                (domainId, spaceId) ->
                                        Mono.zip(
                                                ...
                                                createRouteId(
                                                        this.cloudFoundryClient,
                                                        domainId,
                                                        "listApplicationRoutesBySpaceId",
                                                        spaceId),
                                                Mono.just(spaceId))))
                .delayUntil(
                        function(
                                (applicationId, routeId, spaceId) ->
                                        requestReplaceDestinations(
                                                        this.cloudFoundryClient,
                                                        applicationId,
                                                        routeId)
                ...
                .filter(
                        route ->
                                route.getMetadata()
                                        .getLabels()
                                        .containsKey("test-listApplicationRoutesBySpaceId-key"))
                .map(RouteResource::getMetadata)
                .map(Metadata::getLabels)
                .as(StepVerifier::create)
                .expectNext(
                        Collections.singletonMap(
                                "test-listApplicationRoutesBySpaceId-key",
                                "test-listApplicationRoutesBySpaceId-value"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
                ...
                .consumeNextWith(
                        description ->
                                assertThat(description)
                                        .startsWith("Enable versioning of an application"))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void scale() {
        ...
        this.spaceId
                ...
                .flatMap(
                        applicationId ->
                                requestApplicationProcess(this.cloudFoundryClient, applicationId))
                                ...
                                (applicationId, dropletId) ->
                                        Mono.zip(
                                                ...
                                                this.cloudFoundryClient
                                                        .applicationsV3()
                                                        .getCurrentDroplet(
                                                                GetApplicationCurrentDropletRequest
                                                                        .builder()
                                                                        .applicationId(
                                                                                applicationId)
                                                                        .build())
    ...
    public void start() {
        ...
        this.spaceId
                ...
                .delayUntil(
                        applicationId ->
                                prepareApplicationToStart(this.cloudFoundryClient, applicationId))
                .delayUntil(
                        (applicationId ->
                                this.cloudFoundryClient
                                        .applicationsV3()
    ...
    public void restart() {
        ...
        this.spaceId
                ...
                .delayUntil(
                        applicationId ->
                                requestStartApplication(this.cloudFoundryClient, applicationId))
                .flatMap(
                        applicationId ->
                                requestApplicationProcess(this.cloudFoundryClient, applicationId)
                ...
                .flatMap(
                        applicationId ->
                                Mono.zip(
                                        Mono.just(applicationId),
                                        getFeatureEnabled(
                                                this.cloudFoundryClient, applicationId, "ssh")))
                .delayUntil(
                        function(
    ...
    static Mono<String> createApplicationId(
    ...
    private static Mono<String> createBuildId(
            CloudFoundryClient cloudFoundryClient, String packageId) {
        return requestCreateBuild(cloudFoundryClient, packageId).map(CreateBuildResponse::getId);
    }
    ...
    private static Mono<String> createPackageId(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
        return requestCreatePackage(cloudFoundryClient, applicationId)
    ...
    private static Mono<Boolean> getFeatureEnabled(
            CloudFoundryClient cloudFoundryClient, String applicationId, String featureName) {
        return requestGetFeature(cloudFoundryClient, applicationId, featureName)
                .map(GetApplicationFeatureResponse::getEnabled);
    }

    private static Mono<GetApplicationProcessResponse> requestApplicationProcess(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
    ...
    private static Mono<CreateBuildResponse> requestCreateBuild(
            CloudFoundryClient cloudFoundryClient, String packageId) {
        return cloudFoundryClient
                .builds()
                .create(
    ...
    private static Mono<CreatePackageResponse> requestCreatePackage(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
        return cloudFoundryClient
                .packages()
                .create(
    ...
    private static Mono<GetApplicationResponse> requestGetApplications(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
        return cloudFoundryClient
                .applicationsV3()
                .get(GetApplicationRequest.builder().applicationId(applicationId).build());
    ...
    private static Mono<GetBuildResponse> requestGetBuild(
            CloudFoundryClient cloudFoundryClient, String buildId) {
        return cloudFoundryClient.builds().get(GetBuildRequest.builder().buildId(buildId).build());
    }

    private static Mono<GetApplicationFeatureResponse> requestGetFeature(
            CloudFoundryClient cloudFoundryClient, String applicationId, String featureName) {
        return cloudFoundryClient
                .applicationsV3()
                .getFeature(
    ...
    private static Mono<GetPackageResponse> requestGetPackage(
            CloudFoundryClient cloudFoundryClient, String packageId) {
        return cloudFoundryClient
                .packages()
    ...
    private static Mono<SetApplicationCurrentDropletResponse> requestSetDroplet(
    ...
    private static Mono<StartApplicationResponse> requestStartApplication(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
        return cloudFoundryClient
                .applicationsV3()
                .start(StartApplicationRequest.builder().applicationId(applicationId).build());
    }

    private static Mono<UploadPackageResponse> requestUploadPackage(
            CloudFoundryClient cloudFoundryClient, String packageId) {
        try {
            return cloudFoundryClient
                    .packages()
    ...
    private static Mono<String> uploadPackageAndCreateDropletId(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
    ...
    private static Mono<GetBuildResponse> waitForBuild(
            CloudFoundryClient cloudFoundryClient, String buildId) {
    ...
    private static Mono<GetPackageResponse> waitForPackageUpload(
            CloudFoundryClient cloudFoundryClient, String packageId) {
    ...
    private Mono<SetApplicationCurrentDropletResponse> prepareApplicationToStart(
            CloudFoundryClient cloudFoundryClient, String applicationId) {
        return uploadPackageAndCreateDropletId(cloudFoundryClient, applicationId)
                .flatMap(
                        dropletId ->
                                requestSetDroplet(cloudFoundryClient, applicationId, dropletId));
    }
}
