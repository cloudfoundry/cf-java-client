...
public final class ServiceOfferingsTest extends AbstractIntegrationTest {
    ...
    public void delete() {
        ...
        getServiceOfferingId(
                        this.cloudFoundryClient, serviceName, serviceBrokerMetadata.serviceBrokerId)
                .flatMap(
                        serviceOfferingId ->
                                this.cloudFoundryClient
                                        .serviceOfferingsV3()
    ...
    public void get() {
        this.serviceBrokerId
                .flatMap(
                        serviceBrokerId ->
                                getServiceOfferingId(
                                        this.cloudFoundryClient, this.serviceName, serviceBrokerId))
                .flatMap(
                        serviceOfferingId ->
                                this.cloudFoundryClient
                                        .serviceOfferingsV3()
                                        ...
                                        .update(
                                                UpdateServiceOfferingRequest.builder()
                                                        .metadata(
                                                                Metadata.builder()
                                                                        .label(
                                                                                "test-service-offering-update-key",
                                                                                "test-service-offering-update-value")
                                                                        .build())
                                                        .serviceOfferingId(serviceOfferingId)
                                                        .build()))
                .thenMany(
    ...
    private static Mono<String> getServiceOfferingId(
