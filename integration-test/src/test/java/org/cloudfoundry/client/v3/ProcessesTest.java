...
public final class ProcessesTest extends AbstractIntegrationTest {
    ...
    public void get() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(applicationId -> getProcessId(this.cloudFoundryClient, applicationId))
            .then(processId -> this.cloudFoundryClient.processes()
    ...
    public void scale() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(processId -> requestGetProcess(this.cloudFoundryClient, processId))
            .map(GetProcessResponse::getDiskInMb)
            .as(StepVerifier::create)
            .expectNext(259)
            .expectComplete()
