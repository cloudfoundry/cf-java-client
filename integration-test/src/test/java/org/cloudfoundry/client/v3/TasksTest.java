...
public final class TasksTest extends AbstractIntegrationTest {
    ...
    public void cancel() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(function((applicationId, dropletId) -> createTaskId(this.cloudFoundryClient, applicationId)))
            .then(taskId -> this.cloudFoundryClient.tasks()
    ...
    public void create() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            .then(getApplicationId(this.cloudFoundryClient, applicationName))
            .then(applicationId -> getDropletId(this.cloudFoundryClient, applicationId)
                .then(Mono.just(applicationId)))
            .then(applicationId -> this.cloudFoundryClient.tasks()
    ...
    public void list() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(applicationId -> Mono.when(
                Mono.just(applicationId),
                getDropletId(this.cloudFoundryClient, applicationId)))
            .then(function((applicationId, dropletId) -> requestCreateTask(this.cloudFoundryClient, applicationId)
    ...
    public void listFilterByApplication() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(applicationId -> Mono.when(
                ...
                getDropletId(this.cloudFoundryClient, applicationId)))
            .then(function((applicationId, dropletId) -> requestCreateTask(this.cloudFoundryClient, applicationId)
                .then(Mono.just(Tuples.of(applicationId, dropletId)))))
    ...
    public void listFilterByName() throws IOException {
        ...
        createApplication(this.cloudFoundryOperations, applicationName)
            ...
            .then(applicationId -> Mono.when(
                ...
                getDropletId(this.cloudFoundryClient, applicationId)))
            .then(function((applicationId, dropletId) -> createTaskId(this.cloudFoundryClient, applicationId)))
            .then(taskId -> getTaskName(this.cloudFoundryClient, taskId))
