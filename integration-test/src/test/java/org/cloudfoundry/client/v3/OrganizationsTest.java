...
public final class OrganizationsTest extends AbstractIntegrationTest {
                                        ...
                                        Mono.zip(
                                                ...
                                                this.cloudFoundryClient
                                                        ...
                                                        .assignDefaultIsolationSegment(
                                                                AssignOrganizationDefaultIsolationSegmentRequest
                                                                        .builder()
                                                                        .organizationId(
                                                                                organizationId)
                                                                        .data(
    ...
    public void listDomains() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                .delayUntil(
                        organizationId ->
                                requestCreateDomain(
                                        this.cloudFoundryClient, domainName, organizationId))
                .flatMapMany(
                        organizationId ->
                                PaginationUtils.requestClientV3Resources(
                                        page ->
    ...
    public void listDomainsFilterByOwningOrganizationIds() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                        ...
                        organizationId ->
                                Mono.when(
                                        requestCreateDomain(
                                                ...
                                                organizationId),
                                        requestCreateDomain(
                                                this.cloudFoundryClient, globalDomainName)))
                .flatMapMany(
                        organizationId ->
                                PaginationUtils.requestClientV3Resources(
                                        page ->
                ...
                .filter(
                        resource ->
                                domainName.equals(resource.getName())
                                        || globalDomainName.equals(resource.getName()))
                .as(StepVerifier::create)
                .consumeNextWith(resource -> assertThat(resource.getName()).isEqualTo(domainName))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    ...
    public void listDomainsReturningGlobalDomains() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
                ...
                .as(StepVerifier::create)
                .consumeNextWith(
                        resource -> assertThat(resource.getName()).isEqualTo(globalDomainName))
                .expectComplete()
                .verify(Duration.ofMinutes(5));
    }
    ...
    public void listDomainsReturningSharedDomains() {
        ...
        Mono.zip(
                ...
                .filter(
                        resource ->
                                domainName1.equals(resource.getName())
                                        || domainName2.equals(resource.getName()))
                .as(StepVerifier::create)
    ...
    private static Mono<AssignOrganizationDefaultIsolationSegmentResponse>
            requestAssignDefaultIsolationSegment(
                    CloudFoundryClient cloudFoundryClient,
                    String isolationSegmentId,
                    String organizationId) {
