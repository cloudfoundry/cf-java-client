...
public final class IsolationSegmentsTest extends AbstractIntegrationTest {
    ...
    public void delete() {
        ...
        createIsolationSegmentId(this.cloudFoundryClient, isolationSegmentName)
            .then(isolationSegmentId -> this.cloudFoundryClient.isolationSegments()
    ...
    public void listEntitledOrganizations() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            ...
            .flatMapMany(function((isolationSegmentId, organizationId) -> Mono.when(
                Mono.just(organizationId),
    ...
    public void listOrganizationsRelationship() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            ...
            .then(function((isolationSegmentId, organizationId, spaceId) -> Mono.when(
    ...
    public void listSpacesRelationship() {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            ...
            .then(function((isolationSegmentId, spaceId) -> Mono.when(
                Mono.just(isolationSegmentId),
                requestAssignIsolationSegment(this.cloudFoundryClient, isolationSegmentId, spaceId)
                    .then(Mono.just(spaceId))
            )))
            .flatMapMany(function((isolationSegmentId, spaceId) -> Mono.when(
                Mono.just(spaceId),
                this.cloudFoundryClient.isolationSegments()
    ...
    public void removeOrganizationEntitlement() {
        ...
        Mono.when(
            ...
            .then(function((isolationSegmentId, organizationId) -> this.cloudFoundryClient.isolationSegments()
