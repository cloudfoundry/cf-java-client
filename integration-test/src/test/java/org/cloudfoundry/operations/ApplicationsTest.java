...
public final class ApplicationsTest extends AbstractIntegrationTest {
        ...
        createApplication(
                ...
                .then(
                        bindServiceToApplication(
                                this.cloudFoundryOperations, applicationName, serviceInstanceName))
                .then(
                        this.cloudFoundryOperations
                                .applications()
                                .delete(
    ...
    public void getMultipleBuildpacks() throws IOException {
        ...
        createApplicationPhp(
                        this.cloudFoundryOperations,
                        new ClassPathResource("test-php.zip").getFile().toPath(),
                        applicationName,
                        true)
                .then(
                        this.cloudFoundryOperations
    ...
    public void list() throws IOException {
        ...
        createApplication(
                        ...
                        applicationName,
                        false)
                .thenMany(this.cloudFoundryOperations.applications().list())
                .filter(response -> applicationName.equals(response.getName()))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                        ...
                        this.cloudFoundryOperations
                                ...
                                .pushManifest(
                                        PushApplicationManifestRequest.builder()
                                                ...
                                                .build()))
                .then(
                        getServiceInstance(this.cloudFoundryOperations, serviceInstanceName)
    ...
    public void pushDirectory() throws IOException {
        ...
        createApplication(
                        this.cloudFoundryOperations,
                        new ClassPathResource("test-application").getFile().toPath(),
                        applicationName,
                        false)
                .as(StepVerifier::create)
                .expectComplete()
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage("Domain %s not found", domainName))
                .verify(Duration.ofMinutes(5));
    }
    ...
    @IfCloudFoundryVersion(
            greaterThanOrEqualTo =
                    CloudFoundryVersion.UNSPECIFIED) // TODO how to select this version?
                ...
                ManifestV3.builder()
                        ...
                        .application(
                                ManifestV3Application.builder()
                                        ...
                                        .path(
                                                new ClassPathResource("test-application")
                                                        .getFile()
                                                        .toPath())
                                        .build())
                        .build();
    ...
    public void terminateTask() throws IOException {
        ...
        createApplication(
                ...
                .flatMapMany(
                        sequenceId ->
                                requestListTasks(this.cloudFoundryOperations, applicationName)
    ...
    private static Mono<Void> bindServiceToApplication(
    ...
    private static Mono<Void> createApplicationPhp(
            CloudFoundryOperations cloudFoundryOperations,
            Path application,
            String name,
            Boolean noStart) {
    ...
    private static Mono<Void> createApplicationTcp(
            CloudFoundryOperations cloudFoundryOperations,
            String applicationName,
            String domainName)
            throws IOException {
                                        ...
                                        ApplicationManifest.builder()
                                                ...
                                                .path(
                                                        new ClassPathResource(
                                                                ...
                                                                .toPath())
                                                .randomRoute(true)
                                                .route(Route.builder().route(domainName).build())
                                                .build())
                                .noStart(true)
                                .build());
    }

    private static Mono<Void> createDockerApplication(
            CloudFoundryOperations cloudFoundryOperations, String name, Boolean noStart) {
        return cloudFoundryOperations
                .applications()
                .push(
                        PushApplicationRequest.builder()
    ...
    private static Mono<Void> createDomain(
            CloudFoundryOperations cloudFoundryOperations,
            String domainName,
    ...
    private static Mono<Void> createServiceInstance(
            CloudFoundryOperations cloudFoundryOperations,
            String planName,
            String serviceInstanceName,
            String serviceName) {
    ...
    private static Mono<Integer> getLongLivedTaskId(
            CloudFoundryOperations cloudFoundryOperations,
            String applicationName,
            String taskName) {
    ...
    private static Mono<ServiceInstance> getServiceInstance(
            CloudFoundryOperations cloudFoundryOperations, String serviceInstanceName) {
        return cloudFoundryOperations
                .services()
    ...
    private static Mono<Task> requestCreateLongLivedTask(
            CloudFoundryOperations cloudFoundryOperations,
            String applicationName,
            String taskName) {
        return cloudFoundryOperations
    ...
    private static Mono<Task> requestCreateTask(
            CloudFoundryOperations cloudFoundryOperations,
            String applicationName,
            String taskName) {
        return cloudFoundryOperations
    ...
    private static Mono<Void> requestCreateTcpDomain(
    ...
    private static Mono<ApplicationHealthCheck> requestGetHealthCheck(
            CloudFoundryOperations cloudFoundryOperations, String applicationName) {
        return cloudFoundryOperations
                .applications()
                .getHealthCheck(
                        GetApplicationHealthCheckRequest.builder().name(applicationName).build());
    }

    private static Mono<ApplicationManifest> requestGetManifest(
            CloudFoundryOperations cloudFoundryOperations, String applicationName) {
        return cloudFoundryOperations
                .applications()
                .getApplicationManifest(
                        GetApplicationManifestRequest.builder().name(applicationName).build());
    }

    private static Flux<ApplicationSummary> requestListApplications(
            CloudFoundryOperations cloudFoundryOperations) {
        return cloudFoundryOperations.applications().list();
    }

    private static Flux<org.cloudfoundry.operations.routes.Route> requestListRoutes(
            CloudFoundryOperations cloudFoundryOperations) {
        return cloudFoundryOperations.routes().list(ListRoutesRequest.builder().build());
    }

    private static Flux<Task> requestListTasks(
            CloudFoundryOperations cloudFoundryOperations, String applicationName) {
        return cloudFoundryOperations
                .applications()
                .listTasks(ListApplicationTasksRequest.builder().name(applicationName).build());
    }

    private static Mono<Boolean> requestSshEnabled(
            CloudFoundryOperations cloudFoundryOperations, String applicationName) {
        return cloudFoundryOperations
                .applications()
