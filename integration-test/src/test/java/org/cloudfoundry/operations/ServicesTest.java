...
public final class ServicesTest extends AbstractIntegrationTest {
    ...
    public void bindRoutePrivateDomain() {
        ...
        Mono.when(
                        requestCreatePrivateDomain(
                                this.cloudFoundryOperations, domainName, this.organizationName),
                        requestCreateUserProvidedServiceInstance(
                                this.cloudFoundryOperations, userProvidedServiceInstanceName))
                .then(
                        requestCreateRoute(
    ...
    public void bindService() throws IOException {
        ...
        Mono.when(
                ...
                .flatMapMany(
                        applicationId ->
                                requestListServiceBindings(this.cloudFoundryClient, applicationId))
                .as(StepVerifier::create)
                .expectNextCount(1)
                .expectComplete()
                .verify(Duration.ofMinutes(5));
        ...
        this.cloudFoundryOperations
                ...
                .createInstance(
                        CreateServiceInstanceRequest.builder()
                                ...
                                .build())
                .thenMany(
                        requestListServiceInstances(this.cloudFoundryOperations)
        ...
        requestCreateServiceInstance(
                ...
                .then(
                        requestCreateServiceKey(
                                this.cloudFoundryOperations, serviceKeyName, serviceInstanceName))
                .then(
                        this.cloudFoundryOperations
                                .services()
                                .deleteServiceKey(
                ...
                .thenMany(
                        requestGetServiceKey(
                                this.cloudFoundryOperations, serviceInstanceName, serviceKeyName))
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "Service key %s does not exist", serviceKeyName))
                .verify(Duration.ofMinutes(5));
    }
                        ...
                        this.cloudFoundryOperations
                                ...
                                .updateInstance(
                                        UpdateServiceInstanceRequest.builder()
                                                ...
                                                .build()))
                .then(
                        requestGetInstance(this.cloudFoundryOperations, serviceInstanceName)
        ...
        this.serviceBrokerId
                ...
                .thenMany(
                        requestListUserProvidedServiceInstances(
                                        this.cloudFoundryClient, serviceInstanceName)
    ...
    private static Mono<Void> requestBindRoute(
            CloudFoundryOperations cloudFoundryOperations,
            String domainName,
            String hostName,
            String path,
            String userProvidedServiceInstanceName) {
    ...
    private static Mono<Void> requestBindService(
            CloudFoundryOperations cloudFoundryOperations,
    ...
    private static Mono<Void> requestCreateApplication(
            CloudFoundryOperations cloudFoundryOperations, Path application, String name) {
        return cloudFoundryOperations
                .applications()
                .push(
    ...
    private static Mono<Void> requestCreatePrivateDomain(
            CloudFoundryOperations cloudFoundryOperations,
            String domainName,
    ...
    private static Mono<Void> requestCreateServiceInstance(
            CloudFoundryOperations cloudFoundryOperations,
            String planName,
            String serviceInstanceName,
            String serviceName) {
    ...
    private static Mono<Void> requestCreateServiceKey(
            CloudFoundryOperations cloudFoundryOperations,
    ...
    private static Mono<Void> requestCreateUserProvidedServiceInstance(
            CloudFoundryOperations cloudFoundryOperations, String userProvidedServiceInstanceName) {
        return cloudFoundryOperations
                .services()
                .createUserProvidedInstance(
                        CreateUserProvidedServiceInstanceRequest.builder()
    ...
    private static Mono<ServiceInstance> requestGetInstance(
            CloudFoundryOperations cloudFoundryOperations, String userProvidedServiceInstanceName) {
        return cloudFoundryOperations
                .services()
                .getInstance(
    ...
    private static Mono<ServiceKey> requestGetServiceKey(
            CloudFoundryOperations cloudFoundryOperations,
            String serviceInstanceName,
            String serviceKeyName) {
        return cloudFoundryOperations
    ...
    private static Flux<ServiceInstanceSummary> requestListServiceInstances(
            CloudFoundryOperations cloudFoundryOperations) {
