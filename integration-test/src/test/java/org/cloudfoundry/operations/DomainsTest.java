...
public final class DomainsTest extends AbstractIntegrationTest {
    ...
    public void createShared() {
        ...
        this.cloudFoundryOperations
                .domains()
                .createShared(CreateSharedDomainRequest.builder().domain(domainName).build())
                .thenMany(requestListDomains(this.cloudFoundryOperations))
                .filter(domain -> domainName.equals(domain.getName()))
                .map(Domain::getStatus)
                .as(StepVerifier::create)
    ...
    public void unshare() {
        ...
        requestCreateOrganization(this.cloudFoundryOperations, targetOrganizationName)
                ...
                .then(
                        requestShareDomain(
                                this.cloudFoundryOperations, targetOrganizationName, domainName))
                .then(
                        this.cloudFoundryOperations
                                .domains()
                                .unshare(
    ...
    private static Mono<Void> requestCreateOrganization(
        ...
        return cloudFoundryOperations
                .organizations()
                .create(CreateOrganizationRequest.builder().organizationName(name).build());
    }

    private static Mono<Void> requestCreateTcpDomain(
            CloudFoundryOperations cloudFoundryOperations, String domainName) {
        return cloudFoundryOperations
                .domains()
                .createShared(
                        CreateSharedDomainRequest.builder()
    ...
    private static Mono<Void> requestShareDomain(
            CloudFoundryOperations cloudFoundryOperations,
            String organizationName,
            String domainName) {
        return cloudFoundryOperations
